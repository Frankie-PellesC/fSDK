/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Nov 13 13:28:43 2016
 \date		Modified on Sun Nov 13 13:28:43 2016
 \author	
\*//*-@@file@@----------------------------------------------------------------*/
 ...
 *
 *****************************************************************************/
VOID Error(HWND hWnd, int nErrDesc, MMRESULT mmrc)
{
 ...
 *
 *****************************************************************************/
VOID NEAR PASCAL MessagePump(VOID)
{
	MSG msg;
 ...
 *
 *****************************************************************************/
VOID NEAR PASCAL EmbossedTextOut(HDC hDC, int x, int y, LPSTR lpsz, UINT cb, COLORREF crText, COLORREF crShadow, int cx, int cy)
{
	COLORREF crOld;
	UINT uMode;
	SIZE sizeText;
 ...
 *
 *****************************************************************************/
HFONT NEAR PASCAL CreateScaledFont(HDC hDC, LPRECT lpRect, LPSTR lpszFormat, int anPosX[], int *nPosY)
{
	LOGFONT lf;
	HFONT hFont;
	HFONT h;
	...
	{
		ScaledClientHeight = (ScaledClientWidth * AspectD) / AspectN;
		SelectObject(hDC, h);
		DeleteObject(hFont);
