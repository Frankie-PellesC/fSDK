/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Nov 13 13:27:40 2016
 \date		Modified on Sun Nov 13 13:27:40 2016
 \author	
\*//*-@@file@@----------------------------------------------------------------*/
...
PUBLIC char gszMWndClass[] = "MIDIPlyrMWnd";
PUBLIC char gszTWndClass[] = "MIDIPlyrTWnd";
...
PRIVATE BOOL InitApp(HINSTANCE hInst);
PRIVATE BOOL InitInstance(HINSTANCE hInst, int nCmdShow);
PRIVATE VOID TerminateInstance(VOID);
 ...
 *
 *****************************************************************************/
int PASCAL WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR lpstrCmdLine, int nCmdShow)
{
	MSG msg;
...
BOOL InitInstance(HINSTANCE hInst, int nCmdShow)
{
	...
	for (idx = 0; idx < N_TIME_FORMATS; idx++)
	{
		*grgszTimeFormats[idx] = '\0';
		LoadString(hInst, IDS_TF_FIRST + idx, grgszTimeFormats[idx], sizeof(grgszTimeFormats[idx]));
	}
	...
	hWnd = CreateWindow(gszMWndClass, NULL, WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, HWND_DESKTOP, NULL, hInst, NULL);
