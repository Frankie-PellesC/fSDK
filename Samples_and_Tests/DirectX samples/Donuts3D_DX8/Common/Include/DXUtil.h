/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \par  Status: 
 \par Project: 
 \date		Created  on Sun Dec  4 19:32:21 2016
 \date		Modified on Sun Dec  4 19:32:21 2016
 \author	
\*//*-@@file@@----------------------------------------------------------------*/
#ifndef DXUTIL_H
#define DXUTIL_H
...
//-----------------------------------------------------------------------------
typedef enum TIMER_COMMAND { TIMER_RESET, TIMER_START, TIMER_STOP, TIMER_ADVANCE,
                     TIMER_GETABSOLUTETIME, TIMER_GETAPPTIME, TIMER_GETELAPSEDTIME } TIMER_COMMAND;
...
//-----------------------------------------------------------------------------
VOID    __cdecl DXUtil_Trace( TCHAR* strMsg, ... );
