/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \par  Status: 
 \par Project: 
 \date		Created  on Sun Dec  4 19:26:31 2016
 \date		Modified on Sun Dec  4 19:26:31 2016
 \author	
\*//*-@@file@@----------------------------------------------------------------*/
#ifndef D3DUTIL_H
#define D3DUTIL_H
...
LRESULT CD3DArcBallHandleMouseMessages(CD3DArcBall *this, HWND, UINT, WPARAM, LPARAM);
VOID CD3DArcBallSetRadius(CD3DArcBall *this, FLOAT fRadius);
VOID CD3DArcBallSetWindow(CD3DArcBall *this, INT w, INT h, FLOAT r /*=0.9 */ );
D3DXMATRIX __forceinline *CD3DArcBallGetRotationMatrix(CD3DArcBall *this)
{
	return &this->m_matRotation;
}
D3DXMATRIX __forceinline *CD3DArcBallGetRotationDeltaMatrix(CD3DArcBall *this)
{
	return &this->m_matRotationDelta;
}
D3DXMATRIX __forceinline *CD3DArcBallGetTranslationMatrix(CD3DArcBall *this)
{
	return &this->m_matTranslation;
}
D3DXMATRIX __forceinline *CD3DArcBallGetTranslationDeltaMatrix(CD3DArcBall *this)
{
	return &this->m_matTranslationDelta;
}
BOOL __forceinline CD3DArcBallIsBeingDragged(CD3DArcBall *this)
{
	return this->m_bDrag;
}
VOID __forceinline CD3DArcBallSetRightHanded(CD3DArcBall *this, BOOL bRightHanded)
{
	this->m_bRightHanded = bRightHanded;
}
...
// Access functions
D3DXVECTOR3 __forceinline *CD3DCameraGetEyePt(CD3DCamera *this)
{
	return &this->m_vEyePt;
}
D3DXVECTOR3 __forceinline *CD3DCameraGetLookatPt(CD3DCamera *this)
{
	return &this->m_vLookatPt;
}
D3DXVECTOR3 __forceinline *CD3DCameraGetUpVec(CD3DCamera *this)
{
	return &this->m_vUpVec;
}
D3DXVECTOR3 __forceinline *CD3DCameraGetViewDir(CD3DCamera *this)
{
	return &this->m_vView;
}
D3DXVECTOR3 __forceinline *CD3DCameraGetCross(CD3DCamera *this)
{
	return &this->m_vCross;
}
D3DXMATRIX __forceinline *CD3DCameraGetViewMatrix(CD3DCamera *this)
{
	return &this->m_matView;
}
D3DXMATRIX __forceinline *CD3DCameraGetBillboardMatrix(CD3DCamera *this)
{
	return &this->m_matBillboard;
}
D3DXMATRIX __forceinline *CD3DCameraGetProjMatrix(CD3DCamera *this)
{
