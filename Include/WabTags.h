/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Sep 18 23:49:44 2016
 \date		Modified on Sun Sep 18 23:49:44 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#define WABTAGS_H
#define FIsTransmittable(ulPropTag)		((PROP_ID (ulPropTag) <  (ULONG)0x0E00) || (PROP_ID (ulPropTag)  >= (ULONG)0x8000) || \
