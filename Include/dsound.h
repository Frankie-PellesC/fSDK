/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Mon Jun 20 01:17:44 2016
 \date		Modified on Mon Jun 20 01:17:44 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
DECLARE_INTERFACE_(IReferenceClock, IUnknown)
{
	...
	STDMETHOD(AdviseTime) (THIS_ REFERENCE_TIME rtBaseTime, REFERENCE_TIME rtStreamTime, HANDLE hEvent, LPDWORD pdwAdviseCookie);
	STDMETHOD(AdvisePeriodic) (THIS_ REFERENCE_TIME rtStartTime, REFERENCE_TIME rtPeriodTime, HANDLE hSemaphore, LPDWORD pdwAdviseCookie);
...
DECLARE_INTERFACE_(IKsPropertySet, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(Get) (THIS_ REFGUID rguidPropSet, ULONG ulId, LPVOID pInstanceData, ULONG ulInstanceLength, LPVOID pPropertyData, ULONG ulDataLength, PULONG pulBytesReturned);
	STDMETHOD(Set) (THIS_ REFGUID rguidPropSet, ULONG ulId, LPVOID pInstanceData, ULONG ulInstanceLength, LPVOID pPropertyData, ULONG ulDataLength);
	STDMETHOD(QuerySupport) (THIS_ REFGUID rguidPropSet, ULONG ulId, PULONG pulTypeSupport);
};
...
DECLARE_INTERFACE_(IDirectSoundFXGargle, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetAllParameters) (THIS_ LPCDSFXGargle pcDsFxGargle);
	STDMETHOD(GetAllParameters) (THIS_ LPDSFXGargle pDsFxGargle);
};
...
DECLARE_INTERFACE_(IDirectSoundFXChorus, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetAllParameters) (THIS_ LPCDSFXChorus pcDsFxChorus);
	STDMETHOD(GetAllParameters) (THIS_ LPDSFXChorus pDsFxChorus);
};
...
DECLARE_INTERFACE_(IDirectSoundFXFlanger, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetAllParameters) (THIS_ LPCDSFXFlanger pcDsFxFlanger);
	STDMETHOD(GetAllParameters) (THIS_ LPDSFXFlanger pDsFxFlanger);
};
...
DECLARE_INTERFACE_(IDirectSoundFXEcho, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetAllParameters) (THIS_ LPCDSFXEcho pcDsFxEcho);
	STDMETHOD(GetAllParameters) (THIS_ LPDSFXEcho pDsFxEcho);
};
...
DECLARE_INTERFACE_(IDirectSoundFXDistortion, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetAllParameters) (THIS_ LPCDSFXDistortion pcDsFxDistortion);
	STDMETHOD(GetAllParameters) (THIS_ LPDSFXDistortion pDsFxDistortion);
};
...
DECLARE_INTERFACE_(IDirectSoundFXCompressor, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetAllParameters) (THIS_ LPCDSFXCompressor pcDsFxCompressor);
	STDMETHOD(GetAllParameters) (THIS_ LPDSFXCompressor pDsFxCompressor);
};
...
DECLARE_INTERFACE_(IDirectSoundFXParamEq, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetAllParameters) (THIS_ LPCDSFXParamEq pcDsFxParamEq);
	STDMETHOD(GetAllParameters) (THIS_ LPDSFXParamEq pDsFxParamEq);
};
...
DECLARE_INTERFACE_(IDirectSoundFXWavesReverb, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetAllParameters) (THIS_ LPCDSFXWavesReverb pcDsFxWavesReverb);
	STDMETHOD(GetAllParameters) (THIS_ LPDSFXWavesReverb pDsFxWavesReverb);
};
...
DECLARE_INTERFACE_(IDirectSoundCaptureFXAec, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetAllParameters) (THIS_ LPCDSCFXAec pDscFxAec);
	STDMETHOD(GetAllParameters) (THIS_ LPDSCFXAec pDscFxAec);
	STDMETHOD(GetStatus) (THIS_ LPDWORD pdwStatus);
...
DECLARE_INTERFACE_(IDirectSoundCaptureFXNoiseSuppress, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetAllParameters) (THIS_ LPCDSCFXNoiseSuppress pcDscFxNoiseSuppress);
	STDMETHOD(GetAllParameters) (THIS_ LPDSCFXNoiseSuppress pDscFxNoiseSuppress);
	STDMETHOD(Reset) (THIS);
};
...
DECLARE_INTERFACE_(IDirectSoundFullDuplex, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(Initialize) (THIS_ LPCGUID pCaptureGuid, LPCGUID pRenderGuid, LPCDSCBUFFERDESC lpDscBufferDesc, LPCDSBUFFERDESC lpDsBufferDesc, HWND hWnd, DWORD dwLevel, LPLPDIRECTSOUNDCAPTUREBUFFER8 lplpDirectSoundCaptureBuffer8, LPLPDIRECTSOUNDBUFFER8 lplpDirectSoundBuffer8);
};
