/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Wed Jul  6 16:48:40 2016
 \date		Modified on Wed Jul  6 16:48:40 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/

#ifndef __KnownFolders_h__
#define __KnownFolders_h__
#if __POCC__ >= 500
#pragma once
#endif
...
#endif
#ifdef INITGUID
#define DEFINE_KNOWN_FOLDER(name, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8) extern const GUID DECLSPEC_SELECTANY name = { l, w1, w2, { b1, b2,  b3,  b4,  b5,  b6,  b7,  b8 } }
#else
#define DEFINE_KNOWN_FOLDER(name, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8) extern const GUID name
#endif
