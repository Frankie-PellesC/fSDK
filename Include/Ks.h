/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jun 19 23:09:17 2016
 \date		Modified on Sun Jun 19 23:09:17 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#define STATIC_KSMFT_CATEGORY_VIDEO_DECODER	0xd6c02d4b, 0x6833, 0x45b4, 0x97, 0x1a, 0x05, 0xa4, 0xb0, 0x4b, 0xab, 0x91
...
#define STATIC_KSMFT_CATEGORY_VIDEO_ENCODER	0xf79eac7d, 0xe545, 0x4387, 0xbd, 0xee, 0xd6, 0x47, 0xd7, 0xbd, 0xe4, 0x2a
...
#define STATIC_KSMFT_CATEGORY_VIDEO_EFFECT	0x12e17c21, 0x532c, 0x4a6e, 0x8a, 0x1c, 0x40, 0x82, 0x5a, 0x73, 0x63, 0x97
...
#define STATIC_KSMFT_CATEGORY_MULTIPLEXER	0x059c561e, 0x05ae, 0x4b61, 0xb6, 0x9d, 0x55, 0xb6, 0x1e, 0xe5, 0x4a, 0x7b
...
#define STATIC_KSMFT_CATEGORY_DEMULTIPLEXER	0xa8700a7a, 0x939b, 0x44c5, 0x99, 0xd7, 0x76, 0x22, 0x6b, 0x23, 0xb3, 0xf1
...
#define STATIC_KSMFT_CATEGORY_AUDIO_DECODER	0x9ea73fb4, 0xef7a, 0x4559, 0x8d, 0x5d, 0x71, 0x9d, 0x8f, 0x04, 0x26, 0xc7
...
#define STATIC_KSMFT_CATEGORY_AUDIO_ENCODER	0x91c64bd0, 0xf91e, 0x4d8c, 0x92, 0x76, 0xdb, 0x24, 0x82, 0x79, 0xd9, 0x75
...
#define STATIC_KSMFT_CATEGORY_AUDIO_EFFECT	0x11064c48, 0x3648, 0x4ed0, 0x93, 0x2e, 0x05, 0xce, 0x8a, 0xc8, 0x11, 0xb7
...
#define STATIC_KSMFT_CATEGORY_VIDEO_PROCESSOR	0x302ea3fc, 0xaa5f, 0x47f9, 0x9f, 0x7a, 0xc2, 0x18, 0x8b, 0xb1, 0x63, 0x2
...
#define STATIC_KSMFT_CATEGORY_OTHER	0x90175d57, 0xb7ea, 0x4901, 0xae, 0xb3, 0x93, 0x3a, 0x87, 0x47, 0x75, 0x6f
...
#define STATIC_KSEVENTSETID_PinCapsChange	 0xDD4F192E, 0x3B78, 0x49AD, 0xA5, 0x34, 0x2C, 0x31, 0x5b, 0x82, 0x20, 0x00
...
#define DEFINE_KSPIN_DESCRIPTOR_ITEM( InterfacesCount, Interfaces, MediumsCount, Mediums, DataRangesCount, DataRanges, DataFlow, Communication) { InterfacesCount, Interfaces, MediumsCount, Mediums, DataRangesCount, DataRanges, DataFlow, Communication, NULL, NULL, 0 }
#define DEFINE_KSPIN_DESCRIPTOR_ITEMEX( InterfacesCount, Interfaces, MediumsCount, Mediums, DataRangesCount, DataRanges, DataFlow, Communication, Category, Name) { InterfacesCount, Interfaces, MediumsCount, Mediums, DataRangesCount, DataRanges, DataFlow, Communication, Category, Name, 0 }
#endif
...
#define DEFINE_KSPROPERTY_ITEM_MEMORY_TRANSPORT(SetHandler) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_MEMORY_TRANSPORT, NULL, sizeof(KSPROPERTY), sizeof(BOOL), (SetHandler), NULL, 0, NULL, NULL, 0)
...
#define STATIC_KS_TYPE_DONT_CARE	STATIC_GUID_NULL#define STATIC_KSMEMORY_TYPE_SYSTEM    0x091bb638L, 0x603f, 0x11d1, 0xb0, 0x67, 0x00, 0xa0, 0xc9, 0x06, 0x28, 0x02
...
#define DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_FUNCTIONTABLE(Handler) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_STREAMALLOCATOR_FUNCTIONTABLE, (Handler), sizeof(KSPROPERTY), sizeof(KSSTREAMALLOCATOR_FUNCTIONTABLE), NULL, NULL, 0, NULL, NULL, 0)#define DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_STATUS(Handler) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_STREAMALLOCATOR_STATUS, (Handler), sizeof(KSPROPERTY), sizeof(KSSTREAMALLOCATOR_STATUS), NULL, NULL, 0, NULL, NULL, 0)
#define DEFINE_KSPROPERTY_ALLOCATORSET(AllocatorSet, PropFunctionTable, PropStatus) DEFINE_KSPROPERTY_TABLE(AllocatorSet) { DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_STATUS(PropStatus), DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_FUNCTIONTABLE(PropFunctionTable) }
typedef
NTSTATUS
...
#define DEFINE_KSPROPERTY_ITEM_STREAMINTERFACE_HEADERSIZE( GetHandler ) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_STREAMINTERFACE_HEADERSIZE, (GetHandler), sizeof(KSPROPERTY), sizeof(ULONG), NULL, NULL, 0, NULL, NULL, 0)#define DEFINE_KSPROPERTY_STREAMINTERFACESET(StreamInterfaceSet, HeaderSizeHandler) DEFINE_KSPROPERTY_TABLE(StreamInterfaceSet) { DEFINE_KSPROPERTY_ITEM_STREAMINTERFACE_HEADERSIZE( HeaderSizeHandler ) }
...
typedef LONGLONG(FASTCALL * PFNKSCLOCK_CORRELATEDTIME) (PFILE_OBJECT FileObject, PLONGLONG SystemTime);
typedef struct {
...
#if (NTDDI_VERSION >= NTDDI_WINXP)typedef
BOOLEAN
(*PFNKSSETTIMER)(
	 PVOID Context,
	 PKTIMER Timer,
...
#define DEFINE_KSPROPERTY_ITEM_CLOCK_TIME(Handler) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_CLOCK_TIME, (Handler), sizeof(KSPROPERTY), sizeof(LONGLONG), NULL, NULL, 0, NULL, NULL, 0)
#define DEFINE_KSPROPERTY_ITEM_CLOCK_PHYSICALTIME(Handler) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_CLOCK_PHYSICALTIME, (Handler), sizeof(KSPROPERTY), sizeof(LONGLONG), NULL, NULL, 0, NULL, NULL, 0)
#define DEFINE_KSPROPERTY_ITEM_CLOCK_CORRELATEDTIME(Handler) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_CLOCK_CORRELATEDTIME, (Handler), sizeof(KSPROPERTY), sizeof(KSCORRELATED_TIME), NULL, NULL, 0, NULL, NULL, 0)
#define DEFINE_KSPROPERTY_ITEM_CLOCK_CORRELATEDPHYSICALTIME(Handler) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_CLOCK_CORRELATEDPHYSICALTIME, (Handler), sizeof(KSPROPERTY), sizeof(KSCORRELATED_TIME), NULL, NULL, 0, NULL, NULL, 0)
#define DEFINE_KSPROPERTY_ITEM_CLOCK_RESOLUTION(Handler) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_CLOCK_RESOLUTION, (Handler), sizeof(KSPROPERTY), sizeof(KSRESOLUTION), NULL, NULL, 0, NULL, NULL, 0)
#define DEFINE_KSPROPERTY_ITEM_CLOCK_STATE(Handler) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_CLOCK_STATE, (Handler), sizeof(KSPROPERTY), sizeof(KSSTATE), NULL, NULL, 0, NULL, NULL, 0)
#define DEFINE_KSPROPERTY_ITEM_CLOCK_FUNCTIONTABLE(Handler) DEFINE_KSPROPERTY_ITEM( KSPROPERTY_CLOCK_FUNCTIONTABLE, (Handler), sizeof(KSPROPERTY), sizeof(KSCLOCK_FUNCTIONTABLE), NULL, NULL, 0, NULL, NULL, 0)
...
#define KSSTREAM_FAILUREEXCEPTION 0x00002000typedef
NTSTATUS
...
typedef struct {
	KSIDENTIFIER					PropTypeSet;
	ULONG							MembersListCount;	 const KSPROPERTY_MEMBERSLIST*	 MembersList;
...
typedef struct {
	...
	ULONG					RelationsCount;    const KSPROPERTY*	   Relations;
...
typedef struct {
	const GUID* 				Set;
	ULONG						PropertiesCount;	const KSPROPERTY_ITEM*		PropertyItem;
	ULONG						FastIoCount;
	const KSFASTPROPERTY_ITEM*	FastIoTable;
} KSPROPERTY_SET, *PKSPROPERTY_SET;
#define DEFINE_KSMETHOD_TABLE(tablename) const KSMETHOD_ITEM tablename[] =
#define DEFINE_KSMETHOD_ITEM(MethodId, Flags, MethodHandler, MinMethod, MinData, SupportHandler) { MethodId, (PFNKSHANDLER)MethodHandler, MinMethod, MinData, SupportHandler, Flags }
typedef struct {
	ULONG					MethodId;
	union {
...
typedef struct {
	const GUID* 			Set;
	ULONG					MethodsCount;	 const KSMETHOD_ITEM*	 MethodItem;
	ULONG					FastIoCount;
...
#define DEFINE_KSEVENT_ITEM(EventId, DataInput, ExtraEntryData, AddHandler, RemoveHandler, SupportHandler) { EventId, DataInput, ExtraEntryData, AddHandler, RemoveHandler, SupportHandler }
typedef struct {
	ULONG				EventId;
	ULONG				DataInput;
...
#define DEFINE_KSCREATE_ITEM(DispatchCreate, TypeName, Context) { (DispatchCreate), (PVOID)(Context), { sizeof(TypeName) - sizeof(UNICODE_NULL), sizeof(TypeName), (PWCHAR)(TypeName) }, NULL, 0 }
#define DEFINE_KSCREATE_ITEMEX(DispatchCreate, TypeName, Context, Flags) { (DispatchCreate), (PVOID)(Context), { sizeof(TypeName) - sizeof(UNICODE_NULL), sizeof(TypeName), (PWCHAR)(TypeName) }, NULL, (Flags) }
...
#define BUS_INTERFACE_REFERENCE_VERSION    0x100typedef struct {	INTERFACE					Interface;	  PFNREFERENCEDEVICEOBJECT	  ReferenceDeviceObject;
	PFNDEREFERENCEDEVICEOBJECT	DereferenceDeviceObject;
	PFNQUERYREFERENCESTRING 	QueryReferenceString;} BUS_INTERFACE_REFERENCE, *PBUS_INTERFACE_REFERENCE;
...
void __inline KsGateAddOnInputToAnd( PKSGATE AndGate) { UNREFERENCED_PARAMETER (AndGate); }
void __inline KsGateAddOffInputToAnd( PKSGATE AndGate) { KsGateTurnInputOff(AndGate); }
void __inline KsGateRemoveOnInputFromAnd( PKSGATE AndGate) { UNREFERENCED_PARAMETER (AndGate); }
void __inline KsGateRemoveOffInputFromAnd( PKSGATE AndGate) { KsGateTurnInputOn(AndGate); }
void __inline KsGateAddOnInputToOr( PKSGATE OrGate) { KsGateTurnInputOn(OrGate); }
void __inline KsGateAddOffInputToOr( PKSGATE OrGate) { UNREFERENCED_PARAMETER (OrGate); }
void __inline KsGateRemoveOnInputFromOr( PKSGATE OrGate) { KsGateTurnInputOff(OrGate); }
void __inline KsGateRemoveOffInputFromOr( PKSGATE OrGate) { UNREFERENCED_PARAMETER (OrGate); }
void __inline
	KsGateTerminateAnd(PKSGATE AndGate)
	{
		ASSERT(AndGate);
...
typedef void (*PFNKSPINFRAMERETURN) (PKSPIN Pin, __in_bcount_opt(Size)PVOID Data, ULONG Size, PMDL Mdl, PVOID Context, NTSTATUS Status);
...
#define DEFINE_ABSTRACT_UNKNOWN() STDMETHOD_(NTSTATUS, QueryInterface)(THIS_ REFIID InterfaceId, PVOID* Interface ) ; STDMETHOD_(ULONG,AddRef)(THIS) ; STDMETHOD_(ULONG,Release)(THIS) ;
#endif
#undef INTERFACE
#define INTERFACE IKsControl
DECLARE_INTERFACE_(IKsControl,IUnknown)
{
	DEFINE_ABSTRACT_UNKNOWN()STDMETHOD_(NTSTATUS, KsProperty) (THIS_ PKSPROPERTY Property, ULONG PropertyLength, PVOID PropertyData, ULONG DataLength, ULONG * BytesReturned);
	STDMETHOD_(NTSTATUS, KsMethod) (THIS_ PKSMETHOD Method, ULONG MethodLength, PVOID MethodData, ULONG DataLength, ULONG * BytesReturned);
	STDMETHOD_(NTSTATUS, KsEvent) (THIS_ PKSEVENT Event, ULONG EventLength, PVOID EventData, ULONG DataLength, ULONG * BytesReturned);
};
...
{
	DEFINE_ABSTRACT_UNKNOWN()STDMETHOD_(LONGLONG, GetTime) (THIS);
	STDMETHOD_(LONGLONG, GetPhysicalTime) (THIS);
	STDMETHOD_(LONGLONG, GetCorrelatedTime) (THIS_ PLONGLONG SystemTime);
	STDMETHOD_(LONGLONG, GetCorrelatedPhysicalTime) (THIS_ PLONGLONG SystemTime);
	STDMETHOD_(NTSTATUS, GetResolution) (THIS_ PKSRESOLUTION Resolution);
	STDMETHOD_(NTSTATUS, GetState) (THIS_ PKSSTATE State);
};
#undef INTERFACE
...
{
	DEFINE_ABSTRACT_UNKNOWN()STDMETHOD_(NTSTATUS, RegisterAdapterObjectEx) (THIS_ PADAPTER_OBJECT AdapterObject, PDEVICE_DESCRIPTION DeviceDescription, ULONG NumberOfMapRegisters, ULONG MaxMappingsByteCount, ULONG MappingTableStride);
};
#undef INTERFACE
#endif
...
KSDDKAPI BOOLEAN NTAPI KsFastPropertyHandler(PFILE_OBJECT FileObject, PKSPROPERTY Property, ULONG PropertyLength, __in_bcount(DataLength)PVOID Data, ULONG DataLength, PIO_STATUS_BLOCK IoStatus, ULONG PropertySetsCount, const KSPROPERTY_SET * PropertySet);
...
KSDDKAPI BOOLEAN NTAPI KsFastMethodHandler(PFILE_OBJECT FileObject, PKSMETHOD Method, ULONG MethodLength, __inout_bcount(DataLength)PVOID Data, ULONG DataLength, PIO_STATUS_BLOCK IoStatus, ULONG MethodSetsCount, const KSMETHOD_SET * MethodSet);
...
KSDDKAPI NTSTATUS NTAPI KsSynchronousIoControlDevice(PFILE_OBJECT FileObject, KPROCESSOR_MODE RequestorMode, ULONG IoControl,	PVOID InBuffer, ULONG InSize, __out_bcount_part(OutSize, *BytesReturned)PVOID OutBuffer, ULONG OutSize, PULONG BytesReturned);
...
#define KsDeleteFilterFactory(FilterFactory) KsFreeObjectCreateItemsByContext( *(KSDEVICE_HEADER *)( KsFilterFactoryGetParentDevice(FilterFactory)->FunctionalDeviceObject-> DeviceExtension), FilterFactory)
...
KSDDKAPINTSTATUS NTAPI KsPinGetAvailableByteCount(PKSPIN Pin, PLONG InputDataBytes, PLONG OutputBufferBytes);
...
KSDDKAPI NTSTATUS NTAPI KsAddItemToObjectBag(KSOBJECT_BAG ObjectBag, __drv_aliasesMem PVOID Item, PFNKSFREE Free);
KSDDKAPI ULONG NTAPI KsRemoveItemFromObjectBag(KSOBJECT_BAG ObjectBag, PVOID Item, BOOLEAN Free);
#define KsDiscard(Object,Pointer) KsRemoveItemFromObjectBag( (Object)->Bag, (PVOID)(Pointer), TRUE)KSDDKAPI
NTSTATUS NTAPI KsAllocateObjectBag(PKSDEVICE Device, KSOBJECT_BAG *ObjectBag);
...
KSDDKAPI NTSTATUS NTAPI KsRegisterFilterWithNoKSPins(PDEVICE_OBJECT DeviceObject, const GUID *InterfaceClassGUID, ULONG PinCount, BOOL *PinDirection, KSPIN_MEDIUM *MediumList, GUID *CategoryList);
...
#if defined(_UNKNOWN_H_) || defined(__IUnknown_INTERFACE_DEFINED__)KSDDKAPI
PUNKNOWN NTAPI KsRegisterAggregatedClientUnknown(PVOID Object, PUNKNOWN ClientUnknown);
