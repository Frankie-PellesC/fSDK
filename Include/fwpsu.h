/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 10 23:17:16 2016
 \date		Modified on Sun Jul 10 23:17:16 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#if (NTDDI_VERSION >= NTDDI_WIN6SP1)
#define FWPS_FIELD_INBOUND_ICMP_ERROR_V4_LOCAL_INTERFACE_INDEX			FWPS_FIELD_INBOUND_ICMP_ERROR_V4_INTERFACE_INDEX
#define FWPS_FIELD_INBOUND_ICMP_ERROR_V4_ARRIVAL_SUB_INTERFACE_INDEX	FWPS_FIELD_INBOUND_ICMP_ERROR_V4_SUB_INTERFACE_INDEX
#define FWPS_FIELD_INBOUND_ICMP_ERROR_V4_LOCAL_INTERFACE_TYPE			FWPS_FIELD_INBOUND_ICMP_ERROR_V4_INTERFACE_TYPE
#define FWPS_FIELD_INBOUND_ICMP_ERROR_V4_LOCAL_TUNNEL_TYPE				FWPS_FIELD_INBOUND_ICMP_ERROR_V4_TUNNEL_TYPE
#endif
...
#if (NTDDI_VERSION >= NTDDI_WIN6SP1)   
#define FWPS_FIELD_INBOUND_ICMP_ERROR_V6_LOCAL_INTERFACE_INDEX			FWPS_FIELD_INBOUND_ICMP_ERROR_V6_INTERFACE_INDEX
#define FWPS_FIELD_INBOUND_ICMP_ERROR_V6_ARRIVAL_SUB_INTERFACE_INDEX	FWPS_FIELD_INBOUND_ICMP_ERROR_V6_SUB_INTERFACE_INDEX
#define FWPS_FIELD_INBOUND_ICMP_ERROR_V6_LOCAL_INTERFACE_TYPE			FWPS_FIELD_INBOUND_ICMP_ERROR_V6_INTERFACE_TYPE
#define FWPS_FIELD_INBOUND_ICMP_ERROR_V6_LOCAL_TUNNEL_TYPE				FWPS_FIELD_INBOUND_ICMP_ERROR_V6_TUNNEL_TYPE
#endif
...
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_ICMP_TYPE		FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_IP_LOCAL_PORT
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_ICMP_CODE		FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_IP_REMOTE_PORT
        
#if (NTDDI_VERSION >= NTDDI_WIN6SP1)
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_LOCAL_INTERFACE_TYPE	FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_INTERFACE_TYPE
        
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_LOCAL_TUNNEL_TYPE	FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_TUNNEL_TYPE
        
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_LOCAL_INTERFACE_INDEX			FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_INTERFACE_INDEX        
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_ARRIVAL_SUB_INTERFACE_INDEX		FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_SUB_INTERFACE_INDEX        
#if (NTDDI_VERSION >= NTDDI_WIN7)
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_SIO_FIREWALL_SOCKET_PROPERTY		FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_SIO_FIREWALL_SYSTEM_PORT
#endif
#endif
...
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_ICMP_TYPE		FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_IP_LOCAL_PORT
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_ICMP_CODE        FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_IP_REMOTE_PORT
        
#if (NTDDI_VERSION >= NTDDI_WIN6SP1)
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_LOCAL_INTERFACE_TYPE        FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_INTERFACE_TYPE
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_LOCAL_TUNNEL_TYPE		   FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_TUNNEL_TYPE
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_LOCAL_INTERFACE_INDEX       FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_INTERFACE_INDEX
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_ARRIVAL_SUB_INTERFACE_INDEX FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_SUB_INTERFACE_INDEX
        
#if (NTDDI_VERSION >= NTDDI_WIN7)
#define FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_SIO_FIREWALL_SOCKET_PROPERTY   FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_SIO_FIREWALL_SYSTEM_PORT
#endif
#endif
#if (NTDDI_VERSION >= NTDDI_WIN7)
...
#define FWPS_FIELD_ALE_CONNECT_REDIRECT_V4_ICMP_TYPE		FWPS_FIELD_ALE_CONNECT_REDIRECT_V4_IP_LOCAL_PORT
#define FWPS_FIELD_ALE_CONNECT_REDIRECT_V4_ICMP_CODE		FWPS_FIELD_ALE_CONNECT_REDIRECT_V4_IP_REMOTE_PORT
...
#define FWPS_FIELD_ALE_CONNECT_REDIRECT_V6_ICMP_TYPE			FWPS_FIELD_ALE_CONNECT_REDIRECT_V6_IP_LOCAL_PORT
#define FWPS_FIELD_ALE_CONNECT_REDIRECT_V6_ICMP_CODE			FWPS_FIELD_ALE_CONNECT_REDIRECT_V6_IP_REMOTE_PORT
#endif
...
#define FWPS_FIELD_ALE_FLOW_ESTABLISHED_V4_ICMP_TYPE		FWPS_FIELD_ALE_FLOW_ESTABLISHED_V4_IP_LOCAL_PORT
#define FWPS_FIELD_ALE_FLOW_ESTABLISHED_V4_ICMP_CODE		FWPS_FIELD_ALE_FLOW_ESTABLISHED_V4_IP_REMOTE_PORT
...
#define FWPS_FIELD_ALE_FLOW_ESTABLISHED_V6_ICMP_TYPE			FWPS_FIELD_ALE_FLOW_ESTABLISHED_V6_IP_LOCAL_PORT
#define FWPS_FIELD_ALE_FLOW_ESTABLISHED_V6_ICMP_CODE			FWPS_FIELD_ALE_FLOW_ESTABLISHED_V6_IP_REMOTE_PORT
#if (NTDDI_VERSION >= NTDDI_WIN7)
...
#define FWPS_IS_METADATA_FIELD_PRESENT(metadataValues, metadataField)  (((metadataValues)->currentMetadataValues & (metadataField)) == (metadataField))
typedef void (NTAPI * FWPS_CALLOUT_CLASSIFY_FN0) (const FWPS_INCOMING_VALUES0 * inFixedValues, const FWPS_INCOMING_METADATA_VALUES0 * inMetaValues, void *layerData, const FWPS_FILTER0 * filter, UINT64 flowContext, FWPS_CLASSIFY_OUT0 * classifyOut);
#if (NTDDI_VERSION >= NTDDI_WIN7)
typedef void (NTAPI * FWPS_CALLOUT_CLASSIFY_FN1) (const FWPS_INCOMING_VALUES0 * inFixedValues, const FWPS_INCOMING_METADATA_VALUES0 * inMetaValues, void *layerData, const void *classifyContext, const FWPS_FILTER1 * filter, UINT64 flowContext, FWPS_CLASSIFY_OUT0 * classifyOut);
#endif
typedef NTSTATUS(NTAPI *FWPS_CALLOUT_NOTIFY_FN0) (FWPS_CALLOUT_NOTIFY_TYPE notifyType, const GUID *filterKey, FWPS_FILTER0 *filter);
#if (NTDDI_VERSION >= NTDDI_WIN7)
typedef NTSTATUS(NTAPI *FWPS_CALLOUT_NOTIFY_FN1) (FWPS_CALLOUT_NOTIFY_TYPE notifyType, const GUID *filterKey, FWPS_FILTER1 *filter);
#endif
typedef void (NTAPI *FWPS_CALLOUT_FLOW_DELETE_NOTIFY_FN0) (UINT16 layerId, UINT32 calloutId, UINT64 flowContext);
typedef void (NTAPI *FWPS_CALLOUT_BOOTTIME_CALLOUT_DELETE_NOTIFY_FN0) (UINT32 calloutId);
#if (NTDDI_VERSION >= NTDDI_WIN7)
DWORD WINAPI FwpsOpenToken0(HANDLE engineHandle, LUID modifiedId, DWORD desiredAccess, HANDLE *accessToken);
DWORD WINAPI FwpsAleEndpointGetById0(HANDLE engineHandle, UINT64 endpointId, FWPS_ALE_ENDPOINT_PROPERTIES0 **properties);
DWORD WINAPI FwpsAleEndpointCreateEnumHandle0(HANDLE engineHandle, const FWPS_ALE_ENDPOINT_ENUM_TEMPLATE0 *enumTemplate, HANDLE *enumHandle);
DWORD WINAPI FwpsAleEndpointEnum0(HANDLE engineHandle, HANDLE enumHandle, UINT32 numEntriesRequested, FWPS_ALE_ENDPOINT_PROPERTIES0 ***entries, UINT32 *numEntriesReturned);
DWORD WINAPI FwpsAleEndpointDestroyEnumHandle0(HANDLE engineHandle, HANDLE enumHandle);
DWORD WINAPI FwpsAleEndpointGetSecurityInfo0(HANDLE engineHandle, SECURITY_INFORMATION securityInfo, PSID *sidOwner, PSID *sidGroup, PACL *dacl, PACL *sacl, PSECURITY_DESCRIPTOR *securityDescriptor);
DWORD WINAPI FwpsAleEndpointSetSecurityInfo0(HANDLE engineHandle, SECURITY_INFORMATION securityInfo, const SID *sidOwner, const SID *sidGroup, const ACL *dacl, const ACL *sacl);
#endif
#endif
#endif
