/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 17 23:17:53 2016
 \date		Modified on Sun Jul 17 23:17:53 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#include <lmcons.h>
#include <lmuseflg.h>
NET_API_STATUS NET_API_FUNCTION NetWkstaGetInfo(LMSTR servername, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetWkstaSetInfo(LMSTR servername, DWORD level, LPBYTE buffer, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetWkstaUserGetInfo(LMSTR reserved, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetWkstaUserSetInfo(LMSTR reserved, DWORD level, LPBYTE buf, LPDWORD parm_err);
...
NET_API_STATUS NET_API_FUNCTION NetWkstaTransportAdd(LMSTR servername, DWORD level, LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetWkstaTransportDel(LMSTR servername, LMSTR transportname, DWORD ucond);
NET_API_STATUS NET_API_FUNCTION NetWkstaTransportEnum(LMSTR servername, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, LPDWORD resumehandle);
