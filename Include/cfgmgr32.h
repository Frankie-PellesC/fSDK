/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Jul  2 16:19:21 2016
 \date		Modified on Sat Jul  2 16:19:21 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
CMAPI CONFIGRET WINAPI CM_Create_DevNode_ExA(PDEVINST pdnDevInst, DEVINSTID_A pDeviceID, DEVINST dnParent, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Create_DevNode_ExW(PDEVINST pdnDevInst, DEVINSTID_W pDeviceID, DEVINST dnParent, ULONG ulFlags, HMACHINE hMachine);
...
CMAPI CONFIGRET WINAPI CM_Delete_Class_Key_Ex(LPGUID ClassGuid, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Delete_DevNode_Key(DEVNODE dnDevNode, ULONG ulHardwareProfile, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Delete_DevNode_Key_Ex(DEVNODE dnDevNode, ULONG ulHardwareProfile, ULONG ulFlags, HMACHINE hMachine);
...
CMAPI CONFIGRET WINAPI CM_Enumerate_Enumerators_ExA(ULONG ulEnumIndex, PSTR Buffer, PULONG pulLength, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Enumerate_Enumerators_ExW(ULONG ulEnumIndex, PWSTR Buffer, PULONG pulLength, ULONG ulFlags, HMACHINE hMachine);
#ifdef UNICODE
...
CMAPI CONFIGRET WINAPI CM_Get_Class_Name_ExA(LPGUID ClassGuid, PSTR Buffer, PULONG pulLength, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Class_Name_ExW(LPGUID ClassGuid, PWSTR Buffer, PULONG pulLength, ULONG ulFlags, HMACHINE hMachine);
#ifdef UNICODE
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ExA(DEVINST dnDevInst, PSTR Buffer, ULONG BufferLen, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ExW(DEVINST dnDevInst, PWSTR Buffer, ULONG BufferLen, ULONG ulFlags, HMACHINE hMachine);
#ifdef UNICODE
...
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_Flags_ExA(DEVINSTID_A pDeviceID, ULONG ulHardwareProfile, PULONG pulValue, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_Flags_ExW(DEVINSTID_W pDeviceID, ULONG ulHardwareProfile, PULONG pulValue, ULONG ulFlags, HMACHINE hMachine);
#ifdef UNICODE
...
CMAPI CONFIGRET WINAPI CM_Get_Sibling_Ex(PDEVINST pdnDevInst, DEVINST dnDevInst, ULONG ulFlags, HMACHINE hMachine);
CMAPI WORD WINAPI CM_Get_Version(VOID);
CMAPI WORD WINAPI CM_Get_Version_Ex(HMACHINE hMachine);
#if (WINVER >= _WIN32_WINNT_WINXP)
CMAPI BOOL WINAPI CM_Is_Version_Available(WORD wVersion);
CMAPI BOOL WINAPI CM_Is_Version_Available_Ex(WORD wVersion, HMACHINE hMachine);
#endif
...
CMAPI CONFIGRET WINAPI CM_Open_Class_Key_ExA(LPGUID ClassGuid, LPCSTR pszClassName, REGSAM samDesired, REGDISPOSITION Disposition, PHKEY phkClass, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Open_Class_Key_ExW(LPGUID ClassGuid, LPCWSTR pszClassName, REGSAM samDesired, REGDISPOSITION Disposition, PHKEY phkClass, ULONG ulFlags, HMACHINE hMachine);
#ifdef UNICODE
...
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Flags_ExA(DEVINSTID_A pDeviceID, ULONG ulConfig, ULONG ulValue, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Flags_ExW(DEVINSTID_W pDeviceID, ULONG ulConfig, ULONG ulValue, ULONG ulFlags, HMACHINE hMachine);
#ifdef UNICODE
...
CMAPI CONFIGRET WINAPI CM_Uninstall_DevNode_Ex(DEVNODE dnDevInst, ULONG ulFlags, HMACHINE hMachine);
