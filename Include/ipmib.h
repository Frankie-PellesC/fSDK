/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 17 01:48:32 2016
 \date		Modified on Sun Jul 17 01:48:32 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#define ICMP4_ISTYPEERROR(Type) (((Type) == ICMP4_DST_UNREACH) || ((Type) == ICMP4_SOURCE_QUENCH) || ((Type) == ICMP4_REDIRECT) || ((Type) == ICMP4_PARAM_PROB) || ((Type) == ICMP4_TIME_EXCEEDED))
