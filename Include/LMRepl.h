/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 17 22:43:19 2016
 \date		Modified on Sun Jul 17 22:43:19 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
NET_API_STATUS NET_API_FUNCTION NetReplGetInfo(LPCWSTR servername, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetReplSetInfo(LPCWSTR servername, DWORD level, const LPBYTE buf, LPDWORD parm_err);
...
NET_API_STATUS NET_API_FUNCTION NetReplExportDirAdd(LPCWSTR servername, DWORD level, const LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetReplExportDirDel(LPCWSTR servername, LPCWSTR dirname);
NET_API_STATUS NET_API_FUNCTION NetReplExportDirEnum(LPCWSTR servername, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, LPDWORD resumehandle);
NET_API_STATUS NET_API_FUNCTION NetReplExportDirGetInfo(LPCWSTR servername, LPCWSTR dirname, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetReplExportDirSetInfo(LPCWSTR servername, LPCWSTR dirname, DWORD level, const LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetReplExportDirLock(LPCWSTR servername, LPCWSTR dirname);
NET_API_STATUS NET_API_FUNCTION NetReplExportDirUnlock(LPCWSTR servername, LPCWSTR dirname, DWORD unlockforce);
...
NET_API_STATUS NET_API_FUNCTION NetReplImportDirAdd(LPCWSTR servername, DWORD level, const LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetReplImportDirDel(LPCWSTR servername, LPCWSTR dirname);
NET_API_STATUS NET_API_FUNCTION NetReplImportDirEnum(LPCWSTR servername, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, LPDWORD resumehandle);
NET_API_STATUS NET_API_FUNCTION NetReplImportDirGetInfo(LPCWSTR servername, LPCWSTR dirname, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetReplImportDirLock(LPCWSTR servername, LPCWSTR dirname);
NET_API_STATUS NET_API_FUNCTION NetReplImportDirUnlock(LPCWSTR servername, LPCWSTR dirname, DWORD unlockforce);
