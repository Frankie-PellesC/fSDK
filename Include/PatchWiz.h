/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Sep  3 19:25:42 2016
 \date		Modified on Sat Sep  3 19:25:42 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#endif
UINT WINAPI UiCreatePatchPackageExA(LPCSTR szPcpPath, LPCSTR szPatchPath, LPCSTR szLogPath, HWND hwndStatus, LPCSTR szTempFolder, BOOL fRemoveTempFolderIfPresent, DWORD dwFlags, DWORD dwReserved);
UINT WINAPI UiCreatePatchPackageExW(LPCWSTR szPcpPath, LPCWSTR szPatchPath, LPCWSTR szLogPath, HWND hwndStatus, LPCWSTR szTempFolder, BOOL fRemoveTempFolderIfPresent, DWORD dwFlags, DWORD dwReserved);
#ifdef UNICODE
...
#define cchMaxInteger 12
#define LOGNONE 0x00000000
#define LOGINFO 0x00000001
#define LOGWARN 0x00000002
#define LOGERR  0x00000004
#define LOGPERFMESSAGES 0x00000008
#define LOGALL = LOGINFO | LOGWARN | LOGERR | LOGPERFMESSAGES
#define UINONE = 0x00000000
#define UILOGBITS 15
#define UIALL (1 << UILOGBITS)
#define DEFAULT_MINIMUM_REQUIRED_MSI_VERSION 100
#define DEFAULT_FILE_SEQUENCE_START 2
#define DEFAULT_DISK_ID 2
