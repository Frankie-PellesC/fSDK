/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Wed Jul  6 13:21:47 2016
 \date		Modified on Wed Jul  6 13:21:47 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#else
#define WINOLECTLAPI        extern DECLSPEC_IMPORT HRESULT STDAPICALLTYPE
#define WINOLECTLAPI_(type) extern DECLSPEC_IMPORT type STDAPICALLTYPE
#endif
#if !defined(INITGUID)
