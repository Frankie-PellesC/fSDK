/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Sep  3 17:43:06 2016
 \date		Modified on Sat Sep  3 17:43:06 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#endif
NTDSAPI_POSTXP DWORD WINAPI DsBindByInstanceW(LPCWSTR ServerName, LPCWSTR Annotation, GUID *InstanceGuid, LPCWSTR DnsDomainName, RPC_AUTH_IDENTITY_HANDLE AuthIdentity, LPCWSTR ServicePrincipalName, DWORD BindFlags, HANDLE *phDS);
NTDSAPI_POSTXP DWORD WINAPI DsBindByInstanceA(LPCSTR ServerName, LPCSTR Annotation, GUID *InstanceGuid, LPCSTR DnsDomainName, RPC_AUTH_IDENTITY_HANDLE AuthIdentity, LPCSTR ServicePrincipalName, DWORD BindFlags, HANDLE *phDS);
#ifdef UNICODE
...
NTDSAPI DWORD WINAPI DsReplicaSyncAllA(HANDLE hDS, LPCSTR pszNameContext, ULONG ulFlags, BOOL(__stdcall *pFnCallBack) (LPVOID, PDS_REPSYNCALL_UPDATEA), LPVOID pCallbackData, PDS_REPSYNCALL_ERRINFOA **pErrors);
NTDSAPI DWORD WINAPI DsReplicaSyncAllW(HANDLE hDS, LPCWSTR pszNameContext, ULONG ulFlags, BOOL(__stdcall *pFnCallBack) (LPVOID, PDS_REPSYNCALL_UPDATEW), LPVOID pCallbackData, PDS_REPSYNCALL_ERRINFOW **pErrors);
#ifdef UNICODE
#define DsReplicaSyncAll DsReplicaSyncAllW
#else
#define DsReplicaSyncAll DsReplicaSyncAllA
#endif
NTDSAPI DWORD WINAPI DsRemoveDsServerW(HANDLE hDs, LPWSTR ServerDN, LPWSTR DomainDN, BOOL *fLastDcInDomain, BOOL fCommit);
NTDSAPI DWORD WINAPI DsRemoveDsServerA(HANDLE hDs, LPSTR ServerDN, LPSTR DomainDN, BOOL *fLastDcInDomain, BOOL fCommit);
#ifdef UNICODE
...
NTDSAPI_POSTXP DWORD WINAPI DsQuerySitesByCostA(HANDLE hDS, LPSTR pszFromSite, LPSTR *rgszToSites, DWORD cToSites, DWORD dwFlags, PDS_SITE_COST_INFO *prgSiteInfo);
#ifdef UNICODE
#define DsQuerySitesByCost DsQuerySitesByCostW
#else
#define DsQuerySitesByCost DsQuerySitesByCostA
#endif
VOID WINAPI DsQuerySitesFree(PDS_SITE_COST_INFO rgSiteInfo);
...
NTDSAPI BOOL WINAPI DsCrackUnquotedMangledRdnW(LPCWSTR pszRDN, DWORD cchRDN, GUID *pGuid, DS_MANGLE_FOR *peDsMangleFor);
NTDSAPI BOOL WINAPI DsCrackUnquotedMangledRdnA(LPCSTR pszRDN, DWORD cchRDN, GUID *pGuid, DS_MANGLE_FOR *peDsMangleFor);
#ifdef UNICODE
#define DsCrackUnquotedMangledRdn DsCrackUnquotedMangledRdnW
#else
#define DsCrackUnquotedMangledRdn DsCrackUnquotedMangledRdnA
#endif
NTDSAPI BOOL WINAPI DsIsMangledRdnValueW(LPCWSTR pszRdn, DWORD cRdn, DS_MANGLE_FOR eDsMangleForDesired);
NTDSAPI BOOL WINAPI DsIsMangledRdnValueA(LPCSTR pszRdn, DWORD cRdn, DS_MANGLE_FOR eDsMangleForDesired);
#ifdef UNICODE
#define DsIsMangledRdnValue DsIsMangledRdnValueW
#else
#define DsIsMangledRdnValue DsIsMangledRdnValueA
#endif
NTDSAPI BOOL WINAPI DsIsMangledDnA(LPCSTR pszDn, DS_MANGLE_FOR eDsMangleFor);
NTDSAPI BOOL WINAPI DsIsMangledDnW(LPCWSTR pszDn, DS_MANGLE_FOR eDsMangleFor);
#ifdef UNICODE
