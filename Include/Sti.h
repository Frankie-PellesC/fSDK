/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Sep  4 20:22:25 2016
 \date		Modified on Sun Sep  4 20:22:25 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
DECLARE_INTERFACE_(IStillImageW, IUnknown)
{
    ...
    STDMETHOD(GetDeviceList)(THIS_ DWORD dwType,DWORD dwFlags, DWORD *pdwItemsReturned, LPVOID *ppBuffer);
    STDMETHOD(GetDeviceInfo)(THIS_ LPWSTR  pwszDeviceName, LPVOID *ppBuffer);
    ...
    STDMETHOD(RegisterLaunchApplication)(THIS_ LPWSTR pwszAppName, LPWSTR pwszCommandLine);
    STDMETHOD(UnregisterLaunchApplication)(THIS_ LPWSTR  pwszAppName);
    STDMETHOD(EnableHwNotifications)(THIS_ LPCWSTR pwszDeviceName, BOOL bNewState);
    STDMETHOD(GetHwNotificationState)(THIS_ LPCWSTR pwszDeviceName, BOOL *pbCurrentState);
    STDMETHOD(RefreshDeviceBus)(THIS_ LPCWSTR  pwszDeviceName);
    ...
    STDMETHOD(WriteToErrorLog)(THIS_ DWORD dwMessageType, LPCWSTR pszMessage);
        ...
        STIMETHOD(RegisterDeviceNotification(THIS_ LPWSTR pwszAppName, LPSUBSCRIBE lpSubscribe);
        STIMETHOD(UnregisterDeviceNotification(THIS_ );
    #endif
};
...
DECLARE_INTERFACE_(IStiDevice, IUnknown)
{
    ...
    STDMETHOD_(ULONG, AddRef) (THIS);
    STDMETHOD_(ULONG, Release) (THIS);
    STDMETHOD(Initialize) (THIS_ HINSTANCE hinst, LPCWSTR pwszDeviceName, DWORD dwVersion, DWORD  dwMode);
    STDMETHOD(GetCapabilities) (THIS_ PSTI_DEV_CAPS pDevCaps);
    STDMETHOD(GetStatus) (THIS_ PSTI_DEVICE_STATUS pDevStatus);
    STDMETHOD(DeviceReset)(THIS);
    STDMETHOD(Diagnostic)(THIS_ LPSTI_DIAG pBuffer);
    ...
    STDMETHOD(LockDevice) (THIS_ DWORD dwTimeOut);
    ...
    STDMETHOD(Subscribe)(THIS_ LPSTISUBSCRIBE lpSubsribe);
    STDMETHOD(GetLastNotificationData)(THIS_ LPSTINOTIFY lpNotify);
    STDMETHOD(UnSubscribe)(THIS);
