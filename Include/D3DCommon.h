/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Nov 20 15:57:48 2016
 \date		Modified on Sun Nov 20 15:57:48 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
extern const IID IID_ID3D10Blob;
typedef struct ID3D10BlobVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ID3D10Blob * This, REFIID riid, void **ppvObject);
