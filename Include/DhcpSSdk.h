/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Tue Jul  5 18:32:37 2016
 \date		Modified on Tue Jul  5 18:32:37 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef DWORD(APIENTRY *LPDHCP_CONTROL) (DWORD dwControlCode, LPVOID lpReserved);
typedef DWORD(APIENTRY *LPDHCP_NEWPKT) (LPBYTE *Packet, DWORD *PacketSize, DWORD IpAddress, LPVOID Reserved, LPVOID *PktContext, LPBOOL ProcessIt);
typedef DWORD(APIENTRY *LPDHCP_DROP_SEND) (LPBYTE *Packet, DWORD *PacketSize, DWORD ControlCode, DWORD IpAddress, LPVOID Reserved, LPVOID PktContext);
typedef DWORD(APIENTRY *LPDHCP_PROB) (LPBYTE Packet, DWORD PacketSize, DWORD ControlCode, DWORD IpAddress, DWORD AltAddress, LPVOID Reserved, LPVOID PktContext);
typedef DWORD(APIENTRY *LPDHCP_GIVE_ADDRESS) (LPBYTE Packet, DWORD PacketSize, DWORD ControlCode, DWORD IpAddress, DWORD AltAddress, DWORD AddrType, DWORD LeaseTime, LPVOID Reserved, LPVOID PktContext);
typedef DWORD(APIENTRY *LPDHCP_HANDLE_OPTIONS) (LPBYTE Packet, DWORD PacketSize, LPVOID Reserved, LPVOID PktContext, LPDHCP_SERVER_OPTIONS ServerOptions);
typedef DWORD(APIENTRY *LPDHCP_DELETE_CLIENT) (DWORD IpAddress, LPBYTE HwAddress, ULONG HwAddressLength, DWORD Reserved, DWORD ClientType);
...
typedef DWORD(APIENTRY *LPDHCP_ENTRY_POINT_FUNC) (LPWSTR ChainDlls, DWORD CalloutVersion, LPDHCP_CALLOUT_TABLE CalloutTbl);
#endif
