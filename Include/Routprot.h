/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Sep  3 23:04:29 2016
 \date		Modified on Sat Sep  3 23:04:29 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef struct _SUPPORT_FUNCTIONS
{
	...
	DWORD(WINAPI * SetInterfaceReceiveType) (DWORD ProtocolId, DWORD InterfaceIndex, DWORD InterfaceReceiveType, BOOL bActivate);
	...
	BOOL(WINAPI * HasMulticastBoundary) (DWORD dwIfIndex, DWORD dwGroupAddress);
...
#define MS_IPV6_DHCP                PROTOCOL_ID(PROTO_TYPE_UCAST, PROTO_VENDOR_MS0, PROTO_IPV6_DHCP)
...
#define SIZEOF_IPV6_BINDING(X)	(FIELD_OFFSET(IPV6_ADAPTER_BINDING_INFO,Address[0]) + ((X) * sizeof(IPV6_LOCAL_BINDING)))
...
typedef DWORD(WINAPI *PINTERFACE_STATUS) (ULONG InterfaceIndex, BOOL InterfaceActive, DWORD StatusType, PVOID StatusInfo);
