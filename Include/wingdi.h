/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Mon Jun 27 00:48:12 2016
 \date		Modified on Mon Jun 27 00:48:12 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#endif
#if (_WIN32_WINNT >= _WIN32_WINNT_WIN2K)
WINGDIAPI BOOL WINAPI GdiAlphaBlend(HDC hdcDest, int xoriginDest, int yoriginDest, int wDest, int hDest, HDC hdcSrc, int xoriginSrc, int yoriginSrc, int wSrc, int hSrc, BLENDFUNCTION ftn);
WINGDIAPI BOOL WINAPI GdiTransparentBlt(HDC hdcDest, int xoriginDest, int yoriginDest, int wDest, int hDest, HDC hdcSrc, int xoriginSrc, int yoriginSrc, int wSrc, int hSrc, UINT crTransparent);
WINGDIAPI BOOL WINAPI GdiGradientFill(HDC hdc, PTRIVERTEX pVertex, ULONG nVertex, PVOID pMesh, ULONG nCount, ULONG ulMode);
#endif
#ifndef NOMETAFILE
...
typedef int (CALLBACK *ENHMFENUMPROC) (HDC hdc, HANDLETABLE FAR *lpht, CONST ENHMETARECORD *lpmr, int nHandles, LPARAM data);
