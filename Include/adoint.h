/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Fri Jul  1 17:11:33 2016
 \date		Modified on Fri Jul  1 17:11:33 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef _ADOConnection _Connection;
#endif
...
typedef _ADORecordset _Recordset;
#endif
...
#endif
#if 0
typedef DECLSPEC_UUID("54D8B4B9-663B-4a9c-95F6-0E749ABD70F1")
__int64 ADO_LONGPTR;
typedef DECLSPEC_UUID("54D8B4B9-663B-4a9c-95F6-0E749ABD70F1")
long ADO_LONGPTR;
#endif
...
#if 0
typedef DECLSPEC_UUID("A56187C5-D690-4037-AE32-A00EDC376AC3")
__int64 PositionEnum_Param;
typedef DECLSPEC_UUID("A56187C5-D690-4037-AE32-A00EDC376AC3")
...
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (_ADOCollection *This, REFIID riid, void **ppvObject);
...
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (_ADODynaCollection *This, REFIID riid, void **ppvObject);
...
extern const IID IID__ADO;
typedef struct _ADOVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (_ADO *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Error;
typedef struct ErrorVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADOError *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Errors;
typedef struct ErrorsVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADOErrors *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Command15;
typedef struct Command15Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Command15 *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Command25;
typedef struct Command25Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Command25 *This, REFIID riid, void **ppvObject);
...
extern const IID IID__Command;
typedef struct _CommandVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (_ADOCommand *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ConnectionEventsVt;
typedef struct ConnectionEventsVtVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ConnectionEventsVt *This, REFIID riid, void **ppvObject);
...
extern const IID IID_RecordsetEventsVt;
typedef struct RecordsetEventsVtVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (RecordsetEventsVt *This, REFIID riid, void **ppvObject);
...
extern const IID DIID_ConnectionEvents;
typedef struct ConnectionEventsVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ConnectionEvents *This, REFIID riid, void **ppvObject);
...
extern const IID DIID_RecordsetEvents;
typedef struct RecordsetEventsVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (RecordsetEvents *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Connection15;
typedef struct Connection15Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Connection15 *This, REFIID riid, void **ppvObject);
...
extern const IID IID__Connection;
typedef struct _ConnectionVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (_ADOConnection *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ADOConnectionConstruction15;
typedef struct ADOConnectionConstruction15Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADOConnectionConstruction15 *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ADOConnectionConstruction;
typedef struct ADOConnectionConstructionVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADOConnectionConstruction *This, REFIID riid, void **ppvObject);
...
#endif
#endif
extern const CLSID CLSID_Connection;
#ifndef ___Record_INTERFACE_DEFINED__
#define ___Record_INTERFACE_DEFINED__
extern const IID IID__Record;
typedef struct _RecordVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (_ADORecord *This, REFIID riid, void **ppvObject);
...
#endif
#endif
extern const CLSID CLSID_Record;
#ifndef ___Stream_INTERFACE_DEFINED__
#define ___Stream_INTERFACE_DEFINED__
extern const IID IID__Stream;
typedef struct _StreamVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (_ADOStream *This, REFIID riid, void **ppvObject);
...
#endif
#endif
extern const CLSID CLSID_Stream;
#ifndef __ADORecordConstruction_INTERFACE_DEFINED__
#define __ADORecordConstruction_INTERFACE_DEFINED__
extern const IID IID_ADORecordConstruction;
typedef struct ADORecordConstructionVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADORecordConstruction *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ADOStreamConstruction;
typedef struct ADOStreamConstructionVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADOStreamConstruction *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ADOCommandConstruction;
typedef struct ADOCommandConstructionVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADOCommandConstruction *This, REFIID riid, void **ppvObject);
...
#endif
#endif
extern const CLSID CLSID_Command;
extern const CLSID CLSID_Recordset;
#ifndef __Recordset15_INTERFACE_DEFINED__
#define __Recordset15_INTERFACE_DEFINED__
extern const IID IID_Recordset15;
typedef struct Recordset15Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Recordset15 *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Recordset20;
typedef struct Recordset20Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Recordset20 *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Recordset21;
typedef struct Recordset21Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Recordset21 *This, REFIID riid, void **ppvObject);
...
extern const IID IID__Recordset;
typedef struct _RecordsetVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (_ADORecordset *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ADORecordsetConstruction;
typedef struct ADORecordsetConstructionVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADORecordsetConstruction *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Field15;
typedef struct Field15Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Field15 *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Field20;
typedef struct Field20Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Field20 *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Field;
typedef struct FieldVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADOField *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Fields15;
typedef struct Fields15Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Fields15 *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Fields20;
typedef struct Fields20Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Fields20 *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Fields;
typedef struct FieldsVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADOFields *This, REFIID riid, void **ppvObject);
...
extern const IID IID__Parameter;
typedef struct _ParameterVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (_ADOParameter *This, REFIID riid, void **ppvObject);
...
#endif
#endif
extern const CLSID CLSID_Parameter;
#ifndef __Parameters_INTERFACE_DEFINED__
#define __Parameters_INTERFACE_DEFINED__
extern const IID IID_Parameters;
typedef struct ParametersVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ADOParameters *This, REFIID riid, void **ppvObject);
