/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Wed Jul  6 17:26:30 2016
 \date		Modified on Wed Jul  6 17:26:30 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#endif
typedef HRESULT(__cdecl *DTC_GET_TRANSACTION_MANAGER) (char *pszHost, char *pszTmName, REFIID rid, DWORD dwReserved1, WORD wcbReserved2, void FAR *pvReserved2, void **ppvObject);
...
DTC_STATUS __cdecl GetDTCStatusW(LPWSTR wszHostName);
DTC_STATUS __cdecl GetDTCStatusA(LPSTR szHostName);
HRESULT __cdecl StartDTCW(LPWSTR wszHostName);
HRESULT __cdecl StartDTCA(LPSTR szHostName);
HRESULT __cdecl StopDTCW(LPWSTR wszHostName);
