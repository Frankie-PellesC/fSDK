/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Fri Sep 16 21:31:10 2016
 \date		Modified on Fri Sep 16 21:31:10 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
extern const IID IID_ISpSREngineSite2;
typedef struct ISpSREngineSite2Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISpSREngineSite2 * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISpSREngineSite2 * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISpSREngineSite2 * This);
	HRESULT(STDMETHODCALLTYPE * Read) (ISpSREngineSite2 * This, void *pv, ULONG cb, ULONG * pcbRead);
	HRESULT(STDMETHODCALLTYPE * DataAvailable) (ISpSREngineSite2 * This, ULONG * pcb);
	HRESULT(STDMETHODCALLTYPE * SetBufferNotifySize) (ISpSREngineSite2 * This, ULONG cbSize);
	HRESULT(STDMETHODCALLTYPE * ParseFromTransitions) (ISpSREngineSite2 * This, const SPPARSEINFO * pParseInfo, ISpPhraseBuilder ** ppNewPhrase);
	HRESULT(STDMETHODCALLTYPE * Recognition) (ISpSREngineSite2 * This, const SPRECORESULTINFO * pResultInfo);
	HRESULT(STDMETHODCALLTYPE * AddEvent) (ISpSREngineSite2 * This, const SPEVENT * pEvent, SPRECOCONTEXTHANDLE hSAPIRecoContext);
	HRESULT(STDMETHODCALLTYPE * Synchronize) (ISpSREngineSite2 * This, ULONGLONG ullProcessedThruPos);
	HRESULT(STDMETHODCALLTYPE * GetWordInfo) (ISpSREngineSite2 * This, SPWORDENTRY * pWordEntry, SPWORDINFOOPT Options);
	HRESULT(STDMETHODCALLTYPE * SetWordClientContext) (ISpSREngineSite2 * This, SPWORDHANDLE hWord, void *pvClientContext);
	HRESULT(STDMETHODCALLTYPE * GetRuleInfo) (ISpSREngineSite2 * This, SPRULEENTRY * pRuleEntry, SPRULEINFOOPT Options);
	HRESULT(STDMETHODCALLTYPE * SetRuleClientContext) (ISpSREngineSite2 * This, SPRULEHANDLE hRule, void *pvClientContext);
	HRESULT(STDMETHODCALLTYPE * GetStateInfo) (ISpSREngineSite2 * This, SPSTATEHANDLE hState, SPSTATEINFO * pStateInfo);
	HRESULT(STDMETHODCALLTYPE * GetResource) (ISpSREngineSite2 * This, SPRULEHANDLE hRule, LPCWSTR pszResourceName, LPWSTR * ppCoMemResource);
	HRESULT(STDMETHODCALLTYPE * GetTransitionProperty) (ISpSREngineSite2 * This, SPTRANSITIONID ID, SPTRANSITIONPROPERTY ** ppCoMemProperty);
	HRESULT(STDMETHODCALLTYPE * IsAlternate) (ISpSREngineSite2 * This, SPRULEHANDLE hRule, SPRULEHANDLE hAltRule);
	HRESULT(STDMETHODCALLTYPE * GetMaxAlternates) (ISpSREngineSite2 * This, SPRULEHANDLE hRule, ULONG * pulNumAlts);
	HRESULT(STDMETHODCALLTYPE * GetContextMaxAlternates) (ISpSREngineSite2 * This, SPRECOCONTEXTHANDLE hContext, ULONG * pulNumAlts);
	HRESULT(STDMETHODCALLTYPE * UpdateRecoPos) (ISpSREngineSite2 * This, ULONGLONG ullCurrentRecoPos);
	HRESULT(STDMETHODCALLTYPE * AddEventEx) (ISpSREngineSite2 * This, const SPEVENTEX * pEvent, SPRECOCONTEXTHANDLE hSAPIRecoContext);
	HRESULT(STDMETHODCALLTYPE * UpdateRecoPosEx) (ISpSREngineSite2 * This, ULONGLONG ullCurrentRecoPos, ULONGLONG ullCurrentRecoTime);
	HRESULT(STDMETHODCALLTYPE * GetRuleTransition) (ISpSREngineSite2 * This, ULONG ulGrammarID, ULONG RuleIndex, SPTRANSITIONENTRY * pTrans);
	HRESULT(STDMETHODCALLTYPE * RecognitionEx) (ISpSREngineSite2 * This, const SPRECORESULTINFOEX * pResultInfo);
	END_INTERFACE
...
#ifdef COBJMACROS
#define ISpSREngineSite2_QueryInterface(This,riid,ppvObject) ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) )
#define ISpSREngineSite2_AddRef(This) ( (This)->lpVtbl -> AddRef(This) )
#define ISpSREngineSite2_Release(This) ( (This)->lpVtbl -> Release(This) )
#define ISpSREngineSite2_Read(This,pv,cb,pcbRead) ( (This)->lpVtbl -> Read(This,pv,cb,pcbRead) )
#define ISpSREngineSite2_DataAvailable(This,pcb) ( (This)->lpVtbl -> DataAvailable(This,pcb) )
#define ISpSREngineSite2_SetBufferNotifySize(This,cbSize) ( (This)->lpVtbl -> SetBufferNotifySize(This,cbSize) )
#define ISpSREngineSite2_ParseFromTransitions(This,pParseInfo,ppNewPhrase) ( (This)->lpVtbl -> ParseFromTransitions(This,pParseInfo,ppNewPhrase) )
#define ISpSREngineSite2_Recognition(This,pResultInfo) ( (This)->lpVtbl -> Recognition(This,pResultInfo) )
#define ISpSREngineSite2_AddEvent(This,pEvent,hSAPIRecoContext) ( (This)->lpVtbl -> AddEvent(This,pEvent,hSAPIRecoContext) )
#define ISpSREngineSite2_Synchronize(This,ullProcessedThruPos) ( (This)->lpVtbl -> Synchronize(This,ullProcessedThruPos) )
#define ISpSREngineSite2_GetWordInfo(This,pWordEntry,Options) ( (This)->lpVtbl -> GetWordInfo(This,pWordEntry,Options) )
#define ISpSREngineSite2_SetWordClientContext(This,hWord,pvClientContext) ( (This)->lpVtbl -> SetWordClientContext(This,hWord,pvClientContext) )
#define ISpSREngineSite2_GetRuleInfo(This,pRuleEntry,Options) ( (This)->lpVtbl -> GetRuleInfo(This,pRuleEntry,Options) )
#define ISpSREngineSite2_SetRuleClientContext(This,hRule,pvClientContext) ( (This)->lpVtbl -> SetRuleClientContext(This,hRule,pvClientContext) )
#define ISpSREngineSite2_GetStateInfo(This,hState,pStateInfo) ( (This)->lpVtbl -> GetStateInfo(This,hState,pStateInfo) )
#define ISpSREngineSite2_GetResource(This,hRule,pszResourceName,ppCoMemResource) ( (This)->lpVtbl -> GetResource(This,hRule,pszResourceName,ppCoMemResource) )
#define ISpSREngineSite2_GetTransitionProperty(This,ID,ppCoMemProperty) ( (This)->lpVtbl -> GetTransitionProperty(This,ID,ppCoMemProperty) )
#define ISpSREngineSite2_IsAlternate(This,hRule,hAltRule) ( (This)->lpVtbl -> IsAlternate(This,hRule,hAltRule) )
#define ISpSREngineSite2_GetMaxAlternates(This,hRule,pulNumAlts) ( (This)->lpVtbl -> GetMaxAlternates(This,hRule,pulNumAlts) )
#define ISpSREngineSite2_GetContextMaxAlternates(This,hContext,pulNumAlts) ( (This)->lpVtbl -> GetContextMaxAlternates(This,hContext,pulNumAlts) )
#define ISpSREngineSite2_UpdateRecoPos(This,ullCurrentRecoPos) ( (This)->lpVtbl -> UpdateRecoPos(This,ullCurrentRecoPos) )
#define ISpSREngineSite2_AddEventEx(This,pEvent,hSAPIRecoContext) ( (This)->lpVtbl -> AddEventEx(This,pEvent,hSAPIRecoContext) )
#define ISpSREngineSite2_UpdateRecoPosEx(This,ullCurrentRecoPos,ullCurrentRecoTime) ( (This)->lpVtbl -> UpdateRecoPosEx(This,ullCurrentRecoPos,ullCurrentRecoTime) )
#define ISpSREngineSite2_GetRuleTransition(This,ulGrammarID,RuleIndex,pTrans) ( (This)->lpVtbl -> GetRuleTransition(This,ulGrammarID,RuleIndex,pTrans) )
#define ISpSREngineSite2_RecognitionEx(This,pResultInfo) ( (This)->lpVtbl -> RecognitionEx(This,pResultInfo) )
#endif
#endif
...
extern const IID IID_ISpSREngine2;
typedef struct ISpSREngine2Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISpSREngine2 * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISpSREngine2 * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISpSREngine2 * This);
	HRESULT(STDMETHODCALLTYPE * SetSite) (ISpSREngine2 * This, ISpSREngineSite * pSite);
	HRESULT(STDMETHODCALLTYPE * GetInputAudioFormat) (ISpSREngine2 * This, const GUID * pguidSourceFormatId, const WAVEFORMATEX * pSourceWaveFormatEx, GUID * pguidDesiredFormatId, WAVEFORMATEX ** ppCoMemDesiredWaveFormatEx);
	HRESULT(STDMETHODCALLTYPE * RecognizeStream) (ISpSREngine2 * This, REFGUID rguidFmtId, const WAVEFORMATEX * pWaveFormatEx, HANDLE hRequestSync, HANDLE hDataAvailable, HANDLE hExit, BOOL fNewAudioStream, BOOL fRealTimeAudio, ISpObjectToken * pAudioObjectToken);
	HRESULT(STDMETHODCALLTYPE * SetRecoProfile) (ISpSREngine2 * This, ISpObjectToken * pProfile);
	HRESULT(STDMETHODCALLTYPE * OnCreateGrammar) (ISpSREngine2 * This, void *pvEngineRecoContext, SPGRAMMARHANDLE hSAPIGrammar, void **ppvEngineGrammarContext);
	HRESULT(STDMETHODCALLTYPE * OnDeleteGrammar) (ISpSREngine2 * This, void *pvEngineGrammar);
	HRESULT(STDMETHODCALLTYPE * LoadProprietaryGrammar) (ISpSREngine2 * This, void *pvEngineGrammar, REFGUID rguidParam, LPCWSTR pszStringParam, const void *pvDataParam, ULONG ulDataSize, SPLOADOPTIONS Options);
	HRESULT(STDMETHODCALLTYPE * UnloadProprietaryGrammar) (ISpSREngine2 * This, void *pvEngineGrammar);
	HRESULT(STDMETHODCALLTYPE * SetProprietaryRuleState) (ISpSREngine2 * This, void *pvEngineGrammar, LPCWSTR pszName, void *pReserved, SPRULESTATE NewState, ULONG * pcRulesChanged);
	HRESULT(STDMETHODCALLTYPE * SetProprietaryRuleIdState) (ISpSREngine2 * This, void *pvEngineGrammar, DWORD dwRuleId, SPRULESTATE NewState);
	HRESULT(STDMETHODCALLTYPE * LoadSLM) (ISpSREngine2 * This, void *pvEngineGrammar, LPCWSTR pszTopicName);
	HRESULT(STDMETHODCALLTYPE * UnloadSLM) (ISpSREngine2 * This, void *pvEngineGrammar);
	HRESULT(STDMETHODCALLTYPE * SetSLMState) (ISpSREngine2 * This, void *pvEngineGrammar, SPRULESTATE NewState);
	HRESULT(STDMETHODCALLTYPE * SetWordSequenceData) (ISpSREngine2 * This, void *pvEngineGrammar, const WCHAR * pText, ULONG cchText, const SPTEXTSELECTIONINFO * pInfo);
	HRESULT(STDMETHODCALLTYPE * SetTextSelection) (ISpSREngine2 * This, void *pvEngineGrammar, const SPTEXTSELECTIONINFO * pInfo);
	HRESULT(STDMETHODCALLTYPE * IsPronounceable) (ISpSREngine2 * This, void *pvEngineGrammar, LPCWSTR pszWord, SPWORDPRONOUNCEABLE * pWordPronounceable);
	HRESULT(STDMETHODCALLTYPE * OnCreateRecoContext) (ISpSREngine2 * This, SPRECOCONTEXTHANDLE hSAPIRecoContext, void **ppvEngineContext);
	HRESULT(STDMETHODCALLTYPE * OnDeleteRecoContext) (ISpSREngine2 * This, void *pvEngineContext);
	HRESULT(STDMETHODCALLTYPE * PrivateCall) (ISpSREngine2 * This, void *pvEngineContext, PVOID pCallFrame, ULONG ulCallFrameSize);
	HRESULT(STDMETHODCALLTYPE * SetAdaptationData) (ISpSREngine2 * This, void *pvEngineContext, const WCHAR * pAdaptationData, const ULONG cch);
	HRESULT(STDMETHODCALLTYPE * SetPropertyNum) (ISpSREngine2 * This, SPPROPSRC eSrc, void *pvSrcObj, const WCHAR * pName, LONG lValue);
	HRESULT(STDMETHODCALLTYPE * GetPropertyNum) (ISpSREngine2 * This, SPPROPSRC eSrc, void *pvSrcObj, const WCHAR * pName, LONG * lValue);
	HRESULT(STDMETHODCALLTYPE * SetPropertyString) (ISpSREngine2 * This, SPPROPSRC eSrc, void *pvSrcObj, LPCWSTR pName, LPCWSTR pValue);
	HRESULT(STDMETHODCALLTYPE * GetPropertyString) (ISpSREngine2 * This, SPPROPSRC eSrc, void *pvSrcObj, LPCWSTR pName, LPWSTR * ppCoMemValue);
	HRESULT(STDMETHODCALLTYPE * SetGrammarState) (ISpSREngine2 * This, void *pvEngineGrammar, SPGRAMMARSTATE eGrammarState);
	HRESULT(STDMETHODCALLTYPE * WordNotify) (ISpSREngine2 * This, SPCFGNOTIFY Action, ULONG cWords, const SPWORDENTRY * pWords);
	HRESULT(STDMETHODCALLTYPE * RuleNotify) (ISpSREngine2 * This, SPCFGNOTIFY Action, ULONG cRules, const SPRULEENTRY * pRules);
	HRESULT(STDMETHODCALLTYPE * PrivateCallEx) (ISpSREngine2 * This, void *pvEngineContext, const void *pInCallFrame, ULONG ulInCallFrameSize, void **ppvCoMemResponse, ULONG * pulResponseSize);
	HRESULT(STDMETHODCALLTYPE * SetContextState) (ISpSREngine2 * This, void *pvEngineContext, SPCONTEXTSTATE eContextState);
	HRESULT(STDMETHODCALLTYPE * PrivateCallImmediate) (ISpSREngine2 * This, void *pvEngineContext, const void *pInCallFrame, ULONG ulInCallFrameSize, void **ppvCoMemResponse, ULONG * pulResponseSize);
	HRESULT(STDMETHODCALLTYPE * SetAdaptationData2) (ISpSREngine2 * This, void *pvEngineContext, const WCHAR * pAdaptationData, const ULONG cch, LPCWSTR pTopicName, SPADAPTATIONSETTINGS eSettings, SPADAPTATIONRELEVANCE eRelevance);
	HRESULT(STDMETHODCALLTYPE * SetGrammarPrefix) (ISpSREngine2 * This, void *pvEngineGrammar, LPCWSTR pszPrefix, BOOL fIsPrefixRequired);
	HRESULT(STDMETHODCALLTYPE * SetRulePriority) (ISpSREngine2 * This, SPRULEHANDLE hRule, void *pvClientRuleContext, int nRulePriority);
	HRESULT(STDMETHODCALLTYPE * EmulateRecognition) (ISpSREngine2 * This, ISpPhrase * pPhrase, DWORD dwCompareFlags);
	HRESULT(STDMETHODCALLTYPE * SetSLMWeight) (ISpSREngine2 * This, void *pvEngineGrammar, float flWeight);
	HRESULT(STDMETHODCALLTYPE * SetRuleWeight) (ISpSREngine2 * This, SPRULEHANDLE hRule, void *pvClientRuleContext, float flWeight);
	HRESULT(STDMETHODCALLTYPE * SetTrainingState) (ISpSREngine2 * This, BOOL fDoingTraining, BOOL fAdaptFromTrainingData);
	HRESULT(STDMETHODCALLTYPE * ResetAcousticModelAdaptation) (ISpSREngine2 * This);
	HRESULT(STDMETHODCALLTYPE * OnLoadCFG) (ISpSREngine2 * This, void *pvEngineGrammar, const SPBINARYGRAMMAR * pGrammarData, ULONG ulGrammarID);
	HRESULT(STDMETHODCALLTYPE * OnUnloadCFG) (ISpSREngine2 * This, void *pvEngineGrammar, ULONG ulGrammarID);
	END_INTERFACE
}  ISpSREngine2Vtbl;
...
#ifdef COBJMACROS
#define ISpSREngine2_QueryInterface(This,riid,ppvObject) ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) )
#define ISpSREngine2_AddRef(This) ( (This)->lpVtbl -> AddRef(This) )
#define ISpSREngine2_Release(This) ( (This)->lpVtbl -> Release(This) )
#define ISpSREngine2_SetSite(This,pSite) ( (This)->lpVtbl -> SetSite(This,pSite) )
#define ISpSREngine2_GetInputAudioFormat(This,pguidSourceFormatId,pSourceWaveFormatEx,pguidDesiredFormatId,ppCoMemDesiredWaveFormatEx) ( (This)->lpVtbl -> GetInputAudioFormat(This,pguidSourceFormatId,pSourceWaveFormatEx,pguidDesiredFormatId,ppCoMemDesiredWaveFormatEx) )
#define ISpSREngine2_RecognizeStream(This,rguidFmtId,pWaveFormatEx,hRequestSync,hDataAvailable,hExit,fNewAudioStream,fRealTimeAudio,pAudioObjectToken) ( (This)->lpVtbl -> RecognizeStream(This,rguidFmtId,pWaveFormatEx,hRequestSync,hDataAvailable,hExit,fNewAudioStream,fRealTimeAudio,pAudioObjectToken) )
#define ISpSREngine2_SetRecoProfile(This,pProfile) ( (This)->lpVtbl -> SetRecoProfile(This,pProfile) )
#define ISpSREngine2_OnCreateGrammar(This,pvEngineRecoContext,hSAPIGrammar,ppvEngineGrammarContext) ( (This)->lpVtbl -> OnCreateGrammar(This,pvEngineRecoContext,hSAPIGrammar,ppvEngineGrammarContext) )
#define ISpSREngine2_OnDeleteGrammar(This,pvEngineGrammar) ( (This)->lpVtbl -> OnDeleteGrammar(This,pvEngineGrammar) )
#define ISpSREngine2_LoadProprietaryGrammar(This,pvEngineGrammar,rguidParam,pszStringParam,pvDataParam,ulDataSize,Options) ( (This)->lpVtbl -> LoadProprietaryGrammar(This,pvEngineGrammar,rguidParam,pszStringParam,pvDataParam,ulDataSize,Options) )
#define ISpSREngine2_UnloadProprietaryGrammar(This,pvEngineGrammar) ( (This)->lpVtbl -> UnloadProprietaryGrammar(This,pvEngineGrammar) )
#define ISpSREngine2_SetProprietaryRuleState(This,pvEngineGrammar,pszName,pReserved,NewState,pcRulesChanged) ( (This)->lpVtbl -> SetProprietaryRuleState(This,pvEngineGrammar,pszName,pReserved,NewState,pcRulesChanged) )
#define ISpSREngine2_SetProprietaryRuleIdState(This,pvEngineGrammar,dwRuleId,NewState) ( (This)->lpVtbl -> SetProprietaryRuleIdState(This,pvEngineGrammar,dwRuleId,NewState) )
#define ISpSREngine2_LoadSLM(This,pvEngineGrammar,pszTopicName) ( (This)->lpVtbl -> LoadSLM(This,pvEngineGrammar,pszTopicName) )
#define ISpSREngine2_UnloadSLM(This,pvEngineGrammar) ( (This)->lpVtbl -> UnloadSLM(This,pvEngineGrammar) )
#define ISpSREngine2_SetSLMState(This,pvEngineGrammar,NewState) ( (This)->lpVtbl -> SetSLMState(This,pvEngineGrammar,NewState) )
#define ISpSREngine2_SetWordSequenceData(This,pvEngineGrammar,pText,cchText,pInfo) ( (This)->lpVtbl -> SetWordSequenceData(This,pvEngineGrammar,pText,cchText,pInfo) )
#define ISpSREngine2_SetTextSelection(This,pvEngineGrammar,pInfo) ( (This)->lpVtbl -> SetTextSelection(This,pvEngineGrammar,pInfo) )
#define ISpSREngine2_IsPronounceable(This,pvEngineGrammar,pszWord,pWordPronounceable) ( (This)->lpVtbl -> IsPronounceable(This,pvEngineGrammar,pszWord,pWordPronounceable) )
#define ISpSREngine2_OnCreateRecoContext(This,hSAPIRecoContext,ppvEngineContext) ( (This)->lpVtbl -> OnCreateRecoContext(This,hSAPIRecoContext,ppvEngineContext) )
#define ISpSREngine2_OnDeleteRecoContext(This,pvEngineContext) ( (This)->lpVtbl -> OnDeleteRecoContext(This,pvEngineContext) )
#define ISpSREngine2_PrivateCall(This,pvEngineContext,pCallFrame,ulCallFrameSize) ( (This)->lpVtbl -> PrivateCall(This,pvEngineContext,pCallFrame,ulCallFrameSize) )
#define ISpSREngine2_SetAdaptationData(This,pvEngineContext,pAdaptationData,cch) ( (This)->lpVtbl -> SetAdaptationData(This,pvEngineContext,pAdaptationData,cch) )
#define ISpSREngine2_SetPropertyNum(This,eSrc,pvSrcObj,pName,lValue) ( (This)->lpVtbl -> SetPropertyNum(This,eSrc,pvSrcObj,pName,lValue) )
#define ISpSREngine2_GetPropertyNum(This,eSrc,pvSrcObj,pName,lValue) ( (This)->lpVtbl -> GetPropertyNum(This,eSrc,pvSrcObj,pName,lValue) )
#define ISpSREngine2_SetPropertyString(This,eSrc,pvSrcObj,pName,pValue) ( (This)->lpVtbl -> SetPropertyString(This,eSrc,pvSrcObj,pName,pValue) )
#define ISpSREngine2_GetPropertyString(This,eSrc,pvSrcObj,pName,ppCoMemValue) ( (This)->lpVtbl -> GetPropertyString(This,eSrc,pvSrcObj,pName,ppCoMemValue) )
#define ISpSREngine2_SetGrammarState(This,pvEngineGrammar,eGrammarState) ( (This)->lpVtbl -> SetGrammarState(This,pvEngineGrammar,eGrammarState) )
#define ISpSREngine2_WordNotify(This,Action,cWords,pWords) ( (This)->lpVtbl -> WordNotify(This,Action,cWords,pWords) )
#define ISpSREngine2_RuleNotify(This,Action,cRules,pRules) ( (This)->lpVtbl -> RuleNotify(This,Action,cRules,pRules) )
#define ISpSREngine2_PrivateCallEx(This,pvEngineContext,pInCallFrame,ulInCallFrameSize,ppvCoMemResponse,pulResponseSize) ( (This)->lpVtbl -> PrivateCallEx(This,pvEngineContext,pInCallFrame,ulInCallFrameSize,ppvCoMemResponse,pulResponseSize) )
#define ISpSREngine2_SetContextState(This,pvEngineContext,eContextState) ( (This)->lpVtbl -> SetContextState(This,pvEngineContext,eContextState) )
#define ISpSREngine2_PrivateCallImmediate(This,pvEngineContext,pInCallFrame,ulInCallFrameSize,ppvCoMemResponse,pulResponseSize) ( (This)->lpVtbl -> PrivateCallImmediate(This,pvEngineContext,pInCallFrame,ulInCallFrameSize,ppvCoMemResponse,pulResponseSize) )
#define ISpSREngine2_SetAdaptationData2(This,pvEngineContext,pAdaptationData,cch,pTopicName,eSettings,eRelevance) ( (This)->lpVtbl -> SetAdaptationData2(This,pvEngineContext,pAdaptationData,cch,pTopicName,eSettings,eRelevance) )
#define ISpSREngine2_SetGrammarPrefix(This,pvEngineGrammar,pszPrefix,fIsPrefixRequired) ( (This)->lpVtbl -> SetGrammarPrefix(This,pvEngineGrammar,pszPrefix,fIsPrefixRequired) )
#define ISpSREngine2_SetRulePriority(This,hRule,pvClientRuleContext,nRulePriority) ( (This)->lpVtbl -> SetRulePriority(This,hRule,pvClientRuleContext,nRulePriority) )
#define ISpSREngine2_EmulateRecognition(This,pPhrase,dwCompareFlags) ( (This)->lpVtbl -> EmulateRecognition(This,pPhrase,dwCompareFlags) )
#define ISpSREngine2_SetSLMWeight(This,pvEngineGrammar,flWeight) ( (This)->lpVtbl -> SetSLMWeight(This,pvEngineGrammar,flWeight) )
#define ISpSREngine2_SetRuleWeight(This,hRule,pvClientRuleContext,flWeight) ( (This)->lpVtbl -> SetRuleWeight(This,hRule,pvClientRuleContext,flWeight) )
#define ISpSREngine2_SetTrainingState(This,fDoingTraining,fAdaptFromTrainingData) ( (This)->lpVtbl -> SetTrainingState(This,fDoingTraining,fAdaptFromTrainingData) )
#define ISpSREngine2_ResetAcousticModelAdaptation(This) ( (This)->lpVtbl -> ResetAcousticModelAdaptation(This) )
#define ISpSREngine2_OnLoadCFG(This,pvEngineGrammar,pGrammarData,ulGrammarID) ( (This)->lpVtbl -> OnLoadCFG(This,pvEngineGrammar,pGrammarData,ulGrammarID) )
#define ISpSREngine2_OnUnloadCFG(This,pvEngineGrammar,ulGrammarID) ( (This)->lpVtbl -> OnUnloadCFG(This,pvEngineGrammar,ulGrammarID) )
#endif
#endif
...
extern const IID IID_ISpSRAlternates;
typedef struct ISpSRAlternatesVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISpSRAlternates * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISpSRAlternates * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISpSRAlternates * This);
	HRESULT(STDMETHODCALLTYPE * GetAlternates) (ISpSRAlternates * This, SPPHRASEALTREQUEST * pAltRequest, SPPHRASEALT ** ppAlts, ULONG * pcAlts);
	HRESULT(STDMETHODCALLTYPE * Commit) (ISpSRAlternates * This, SPPHRASEALTREQUEST * pAltRequest, SPPHRASEALT * pAlt, void **ppvResultExtra, ULONG * pcbResultExtra);
	END_INTERFACE
}  ISpSRAlternatesVtbl;
...
#ifdef COBJMACROS
#define ISpSRAlternates_QueryInterface(This,riid,ppvObject) ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) )
#define ISpSRAlternates_AddRef(This) ( (This)->lpVtbl -> AddRef(This) )
#define ISpSRAlternates_Release(This) ( (This)->lpVtbl -> Release(This) )
#define ISpSRAlternates_GetAlternates(This,pAltRequest,ppAlts,pcAlts) ( (This)->lpVtbl -> GetAlternates(This,pAltRequest,ppAlts,pcAlts) )
#define ISpSRAlternates_Commit(This,pAltRequest,pAlt,ppvResultExtra,pcbResultExtra) ( (This)->lpVtbl -> Commit(This,pAltRequest,pAlt,ppvResultExtra,pcbResultExtra) )
#endif
#endif
#ifndef __ISpSRAlternates2_INTERFACE_DEFINED__
#define __ISpSRAlternates2_INTERFACE_DEFINED__
extern const IID IID_ISpSRAlternates2;
typedef struct ISpSRAlternates2Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISpSRAlternates2 * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISpSRAlternates2 * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISpSRAlternates2 * This);
	HRESULT(STDMETHODCALLTYPE * GetAlternates) (ISpSRAlternates2 * This, SPPHRASEALTREQUEST * pAltRequest, SPPHRASEALT ** ppAlts, ULONG * pcAlts);
	HRESULT(STDMETHODCALLTYPE * Commit) (ISpSRAlternates2 * This, SPPHRASEALTREQUEST * pAltRequest, SPPHRASEALT * pAlt, void **ppvResultExtra, ULONG * pcbResultExtra);
	HRESULT(STDMETHODCALLTYPE * CommitText) (ISpSRAlternates2 * This, SPPHRASEALTREQUEST * pAltRequest, LPCWSTR pcszNewText, SPCOMMITFLAGS commitFlags);
	END_INTERFACE
...
#ifdef COBJMACROS
#define ISpSRAlternates2_QueryInterface(This,riid,ppvObject) ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) )
#define ISpSRAlternates2_AddRef(This) ( (This)->lpVtbl -> AddRef(This) )
#define ISpSRAlternates2_Release(This) ( (This)->lpVtbl -> Release(This) )
#define ISpSRAlternates2_GetAlternates(This,pAltRequest,ppAlts,pcAlts) ( (This)->lpVtbl -> GetAlternates(This,pAltRequest,ppAlts,pcAlts) )
#define ISpSRAlternates2_Commit(This,pAltRequest,pAlt,ppvResultExtra,pcbResultExtra) ( (This)->lpVtbl -> Commit(This,pAltRequest,pAlt,ppvResultExtra,pcbResultExtra) )
#define ISpSRAlternates2_CommitText(This,pAltRequest,pcszNewText,commitFlags) ( (This)->lpVtbl -> CommitText(This,pAltRequest,pcszNewText,commitFlags) )
#endif
#endif
...
extern const IID IID_ISpPrivateEngineCallEx;
typedef struct ISpPrivateEngineCallExVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISpPrivateEngineCallEx * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISpPrivateEngineCallEx * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISpPrivateEngineCallEx * This);
	HRESULT(STDMETHODCALLTYPE * CallEngineSynchronize) (ISpPrivateEngineCallEx * This, const void *pInFrame, ULONG ulInFrameSize, void **ppCoMemOutFrame, ULONG * pulOutFrameSize);
	HRESULT(STDMETHODCALLTYPE * CallEngineImmediate) (ISpPrivateEngineCallEx * This, const void *pInFrame, ULONG ulInFrameSize, void **ppCoMemOutFrame, ULONG * pulOutFrameSize);
	END_INTERFACE
...
#ifdef COBJMACROS
#define ISpPrivateEngineCallEx_QueryInterface(This,riid,ppvObject) ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) )
#define ISpPrivateEngineCallEx_AddRef(This) ( (This)->lpVtbl -> AddRef(This) )
#define ISpPrivateEngineCallEx_Release(This) ( (This)->lpVtbl -> Release(This) )
#define ISpPrivateEngineCallEx_CallEngineSynchronize(This,pInFrame,ulInFrameSize,ppCoMemOutFrame,pulOutFrameSize) ( (This)->lpVtbl -> CallEngineSynchronize(This,pInFrame,ulInFrameSize,ppCoMemOutFrame,pulOutFrameSize) )
#define ISpPrivateEngineCallEx_CallEngineImmediate(This,pInFrame,ulInFrameSize,ppCoMemOutFrame,pulOutFrameSize) ( (This)->lpVtbl -> CallEngineImmediate(This,pInFrame,ulInFrameSize,ppCoMemOutFrame,pulOutFrameSize) )
#endif
#endif
...
extern const CLSID CLSID_SpW3CGrammarCompiler;
