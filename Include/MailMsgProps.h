/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Mon Jul 18 15:04:50 2016
 \date		Modified on Mon Jul 18 15:04:50 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
extern const struct tagIMMPID_GUIDLIST_ITEM
{
	const GUID * pguid;
	DWORD dwStart;
	DWORD dwLast;
...
IMMPID_GUIDS[] =
{
	IMMPID_DECLARE_ENTRY(MP), IMMPID_DECLARE_ENTRY(RP), IMMPID_DECLARE_ENTRY(MPV), IMMPID_DECLARE_ENTRY(RPV),
	{ &GUID_NULL, 0, 0}
};
#endif
