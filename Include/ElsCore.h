/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Jul  9 20:03:11 2016
 \date		Modified on Sat Jul  9 20:03:11 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
HRESULT WINAPI MappingGetServices(PMAPPING_ENUM_OPTIONS pOptions, PMAPPING_SERVICE_INFO *prgServices, DWORD *pdwServicesCount);
HRESULT WINAPI MappingFreeServices(PMAPPING_SERVICE_INFO pServiceInfo);
HRESULT WINAPI MappingRecognizeText(PMAPPING_SERVICE_INFO pServiceInfo, LPCWSTR pszText, DWORD dwLength, DWORD dwIndex, PMAPPING_OPTIONS pOptions, PMAPPING_PROPERTY_BAG pbag);
HRESULT WINAPI MappingDoAction(PMAPPING_PROPERTY_BAG pBag, DWORD dwRangeIndex, LPCWSTR pszActionId);
HRESULT WINAPI MappingFreePropertyBag(PMAPPING_PROPERTY_BAG pBag);
#endif
