/*+@@file@@----------------------------------------------------------------*//*!
 \file		FunctionDiscoveryServiceIDs.h
 \par Description 
            Extension and update of headers for PellesC compiler suite.
 \par Project: 
            PellesC Headers extension
 \date		Created  on Sun Jul 10 19:33:57 2016
 \date		Modified on Sun Jul 10 19:33:57 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/

#ifndef __FunctionDiscoveryServiceIDs_h__
#define __FunctionDiscoveryServiceIDs_h__
#if __POCC__ >= 500
#pragma once
#endif
