/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Mon Jun 27 15:22:35 2016
 \date		Modified on Mon Jun 27 15:22:35 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#define     SetWindowRedraw(hwnd, fRedraw) ((void)SNDMSG(hwnd, WM_SETREDRAW, (WPARAM)(BOOL)(fRedraw), 0L))
...
#define FORWARD_WM_NCCREATE(hwnd, lpCreateStruct, fn)    (BOOL)(DWORD)(fn)((hwnd), WM_NCCREATE, 0L, (LPARAM)(LPCREATESTRUCT)(lpCreateStruct))
...
#define FORWARD_WM_DEVICECHANGE(hwnd, uEvent, dwEventData, fn)    (BOOL)(DWORD)(fn)((hwnd), WM_DEVICECHANGE, (WPARAM)(UINT)(uEvent), (LPARAM)(DWORD)(dwEventData))
...
#define FORWARD_WM_COPYDATA(hwnd, hwndFrom, pcds, fn)    (BOOL)(UINT)(DWORD)(fn)((hwnd), WM_COPYDATA, (WPARAM)(hwndFrom), (LPARAM)(pcds))
