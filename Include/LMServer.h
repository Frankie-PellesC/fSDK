/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 17 22:47:00 2016
 \date		Modified on Sun Jul 17 22:47:00 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#include <winsvc.h>
#include <lmcons.h>
NET_API_STATUS NET_API_FUNCTION NetServerEnum(LMCSTR servername, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, DWORD servertype, LMCSTR domain, LPDWORD resume_handle);
NET_API_STATUS NET_API_FUNCTION NetServerEnumEx(LMCSTR ServerName, DWORD Level, LPBYTE *Bufptr, DWORD PrefMaxlen, LPDWORD EntriesRead, LPDWORD totalentries, DWORD servertype, LMCSTR domain, LMCSTR FirstNameToReturn);
NET_API_STATUS NET_API_FUNCTION NetServerGetInfo(LMSTR servername, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetServerSetInfo(LMSTR servername, DWORD level, LPBYTE buf, LPDWORD ParmError);
NET_API_STATUS NetServerSetInfoCommandLine(WORD argc, LMSTR argv[]);
NET_API_STATUS NET_API_FUNCTION NetServerDiskEnum(LMSTR servername, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, LPDWORD resume_handle);
NET_API_STATUS NET_API_FUNCTION NetServerComputerNameAdd(LMSTR ServerName, LMSTR EmulatedDomainName, LMSTR EmulatedServerName);
NET_API_STATUS NET_API_FUNCTION NetServerComputerNameDel(LMSTR ServerName, LMSTR EmulatedServerName);
NET_API_STATUS NET_API_FUNCTION NetServerTransportAdd(LMSTR servername, DWORD level, LPBYTE bufptr);
NET_API_STATUS NET_API_FUNCTION NetServerTransportAddEx(LMSTR servername, DWORD level, LPBYTE bufptr);
NET_API_STATUS NET_API_FUNCTION NetServerTransportDel(LMSTR servername, DWORD level, LPBYTE bufptr);
NET_API_STATUS NET_API_FUNCTION NetServerTransportEnum(LMSTR servername, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, LPDWORD resumehandle);
BOOL NET_API_FUNCTION SetServiceBits(SERVICE_STATUS_HANDLE hServiceStatus, DWORD dwServiceBits, BOOL bSetBitsOn, BOOL bUpdateImmediately);
...
#define SV_ENABLEAUTHENTICATEUSERSHARING_INFOLEVEL   (PARMNUM_BASE_INFOLEVEL + SV_ENABLEAUTHENTICATEUSERSHARING_PARMNUM)
