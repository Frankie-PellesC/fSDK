/*+@@file@@----------------------------------------------------------------*//*!
 \file		PortableDevice.h
 \par Description 
            Extension and update of headers for PellesC compiler suite.
 \par Project: 
            PellesC Headers extension
 \date		Created  on Sat Sep  3 20:02:42 2016
 \date		Modified on Sat Sep  3 20:02:42 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/

#ifndef __PortableDevice_h__
#define __PortableDevice_h__
#if __POCC__ >= 500
#pragma once
#endif
