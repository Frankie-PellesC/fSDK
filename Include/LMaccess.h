/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 17 22:21:28 2016
 \date		Modified on Sun Jul 17 22:21:28 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
NET_API_STATUS NET_API_FUNCTION NetUserEnum(LPCWSTR servername, DWORD level, DWORD filter, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, LPDWORD resume_handle);
NET_API_STATUS NET_API_FUNCTION NetUserGetInfo(LPCWSTR servername, LPCWSTR username, DWORD level, LPBYTE *bufptr);
...
NET_API_STATUS NET_API_FUNCTION NetUserDel(LPCWSTR servername, LPCWSTR username);
NET_API_STATUS NET_API_FUNCTION NetUserGetGroups(LPCWSTR servername, LPCWSTR username, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries);
NET_API_STATUS NET_API_FUNCTION NetUserSetGroups(LPCWSTR servername, LPCWSTR username, DWORD level, LPBYTE buf, DWORD num_entries);
NET_API_STATUS NET_API_FUNCTION NetUserGetLocalGroups(LPCWSTR servername, LPCWSTR username, DWORD level, DWORD flags, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries);
NET_API_STATUS NET_API_FUNCTION NetUserModalsGet(LPCWSTR servername, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetUserModalsSet(LPCWSTR servername, DWORD level, LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetUserChangePassword(LPCWSTR domainname, LPCWSTR username, LPCWSTR oldpassword, LPCWSTR newpassword);
...
#ifndef _LMGROUP_
#define _LMGROUP_
NET_API_STATUS NET_API_FUNCTION NetGroupAdd(LPCWSTR servername, DWORD level, LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetGroupAddUser(LPCWSTR servername, LPCWSTR GroupName, LPCWSTR username);
NET_API_STATUS NET_API_FUNCTION NetGroupEnum(LPCWSTR servername, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, PDWORD_PTR resume_handle);
NET_API_STATUS NET_API_FUNCTION NetGroupGetInfo(LPCWSTR servername, LPCWSTR groupname, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetGroupSetInfo(LPCWSTR servername, LPCWSTR groupname, DWORD level, LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetGroupDel(LPCWSTR servername, LPCWSTR groupname);
NET_API_STATUS NET_API_FUNCTION NetGroupDelUser(LPCWSTR servername, LPCWSTR GroupName, LPCWSTR Username);
NET_API_STATUS NET_API_FUNCTION NetGroupGetUsers(LPCWSTR servername, LPCWSTR groupname, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, PDWORD_PTR ResumeHandle);
NET_API_STATUS NET_API_FUNCTION NetGroupSetUsers(LPCWSTR servername, LPCWSTR groupname, DWORD level, LPBYTE buf, DWORD totalentries);
...
NET_API_STATUS NET_API_FUNCTION NetLocalGroupAdd(LPCWSTR servername, DWORD level, LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetLocalGroupAddMember(LPCWSTR servername, LPCWSTR groupname, PSID membersid);
NET_API_STATUS NET_API_FUNCTION NetLocalGroupEnum(LPCWSTR servername, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, PDWORD_PTR resumehandle);
NET_API_STATUS NET_API_FUNCTION NetLocalGroupGetInfo(LPCWSTR servername, LPCWSTR groupname, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetLocalGroupSetInfo(LPCWSTR servername, LPCWSTR groupname, DWORD level, LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetLocalGroupDel(LPCWSTR servername, LPCWSTR groupname);
NET_API_STATUS NET_API_FUNCTION NetLocalGroupDelMember(LPCWSTR servername, LPCWSTR groupname, PSID membersid);
...
NET_API_STATUS NET_API_FUNCTION NetLocalGroupSetMembers(LPCWSTR servername, LPCWSTR groupname, DWORD level, LPBYTE buf, DWORD totalentries);
...
NET_API_STATUS NET_API_FUNCTION NetLocalGroupDelMembers(LPCWSTR servername, LPCWSTR groupname, DWORD level, LPBYTE buf, DWORD totalentries);
...
NET_API_STATUS NET_API_FUNCTION NetQueryDisplayInformation(LPCWSTR ServerName, DWORD Level, DWORD Index, DWORD EntriesRequested, DWORD PreferredMaximumLength, LPDWORD ReturnedEntryCount, PVOID *SortedBuffer);
NET_API_STATUS NET_API_FUNCTION NetGetDisplayInformationIndex(LPCWSTR ServerName, DWORD Level, LPCWSTR Prefix, LPDWORD Index);
...
#ifndef _LMACCESS_
#define _LMACCESS_
NET_API_STATUS NET_API_FUNCTION NetAccessAdd(LPCWSTR servername, DWORD level, LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetAccessEnum(LPCWSTR servername, LPCWSTR BasePath, DWORD Recursive, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, LPDWORD resume_handle);
NET_API_STATUS NET_API_FUNCTION NetAccessGetInfo(LPCWSTR servername, LPCWSTR resource, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetAccessSetInfo(LPCWSTR servername, LPCWSTR resource, DWORD level, LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS NET_API_FUNCTION NetAccessDel(LPCWSTR servername, LPCWSTR resource);
NET_API_STATUS NET_API_FUNCTION NetAccessGetUserPerms(LPCWSTR servername, LPCWSTR UGname, LPCWSTR resource, LPDWORD Perms);
...
NET_API_STATUS NET_API_FUNCTION NetValidatePasswordPolicy(LPCWSTR ServerName, LPVOID Qualifier, NET_VALIDATE_PASSWORD_TYPE ValidationType, LPVOID InputArg, LPVOID *OutputArg);
NET_API_STATUS NET_API_FUNCTION NetValidatePasswordPolicyFree(LPVOID *OutputArg);
#endif
#ifndef _LMDOMAIN_
#define _LMDOMAIN_
NET_API_STATUS NET_API_FUNCTION NetGetDCName(LPCWSTR servername, LPCWSTR domainname, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetGetAnyDCName(LPCWSTR servername, LPCWSTR domainname, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION I_NetLogonControl(LPCWSTR ServerName, DWORD FunctionCode, DWORD QueryLevel, LPBYTE *Buffer);
NET_API_STATUS NET_API_FUNCTION I_NetLogonControl2(LPCWSTR ServerName, DWORD FunctionCode, DWORD QueryLevel, LPBYTE Data, LPBYTE *Buffer);
#ifndef _NTDEF_
typedef LONG NTSTATUS, *PNTSTATUS;
#endif
NTSTATUS NET_API_FUNCTION NetEnumerateTrustedDomains(LPWSTR ServerName, LPWSTR *DomainNames);
...
NTSTATUS NetQueryServiceAccount(LPWSTR ServerName, LPWSTR AccountName, DWORD InfoLevel, PBYTE *Buffer);
