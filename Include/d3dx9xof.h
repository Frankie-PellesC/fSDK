...
DECLARE_INTERFACE_(ID3DXFile, IUnknown)
{
	...
	STDMETHOD(CreateEnumObject) (THIS_ LPCVOID, D3DXF_FILELOADOPTIONS, ID3DXFileEnumObject **);
	STDMETHOD(CreateSaveObject) (THIS_ LPCVOID, D3DXF_FILESAVEOPTIONS, D3DXF_FILEFORMAT, ID3DXFileSaveObject **);
	STDMETHOD(RegisterTemplates) (THIS_ LPCVOID, SIZE_T);
...
DECLARE_INTERFACE_(ID3DXFileSaveObject, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(GetFile) (THIS_ ID3DXFile **);
	STDMETHOD(AddDataObject) (THIS_ REFGUID, LPCSTR, CONST GUID *, SIZE_T, LPCVOID, ID3DXFileSaveData **);
	STDMETHOD(Save) (THIS);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(ID3DXFileSaveData, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(GetSave) (THIS_ ID3DXFileSaveObject **);
	STDMETHOD(GetName) (THIS_ LPSTR, SIZE_T *);
	STDMETHOD(GetId) (THIS_ LPGUID);
	STDMETHOD(GetType) (THIS_ GUID *);
	STDMETHOD(AddDataObject) (THIS_ REFGUID, LPCSTR, CONST GUID *, SIZE_T, LPCVOID, ID3DXFileSaveData **);
	STDMETHOD(AddDataReference) (THIS_ LPCSTR, CONST GUID *);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(ID3DXFileEnumObject, IUnknown)
{
	...
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(GetFile) (THIS_ ID3DXFile **);
	STDMETHOD(GetChildren) (THIS_ SIZE_T *);
	STDMETHOD(GetChild) (THIS_ SIZE_T, ID3DXFileData **);
	STDMETHOD(GetDataObjectById) (THIS_ REFGUID, ID3DXFileData **);
	STDMETHOD(GetDataObjectByName) (THIS_ LPCSTR, ID3DXFileData **);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(ID3DXFileData, IUnknown)
{
	...
	STDMETHOD(GetName) (THIS_ LPSTR, SIZE_T *);
	STDMETHOD(GetId) (THIS_ LPGUID);
	STDMETHOD(Lock) (THIS_ SIZE_T *, LPCVOID *);
	STDMETHOD(Unlock) (THIS);
	STDMETHOD(GetType) (THIS_ GUID *);
	STDMETHOD_(BOOL, IsReference) (THIS);
	STDMETHOD(GetChildren) (THIS_ SIZE_T *);
	STDMETHOD(GetChild) (THIS_ SIZE_T, ID3DXFileData **);
};
