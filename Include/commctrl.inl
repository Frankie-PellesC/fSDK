...
HIMAGELIST IsolationAwarePrivatenCv IsolationAwareImageList_Read(struct IStream*pstm);
BOOL IsolationAwarePrivatenCv IsolationAwareImageList_Write(HIMAGELIST himl,struct IStream*pstm);
#if (_WIN32_WINNT >= 0x0501)
HRESULT IsolationAwarePrivatenCv IsolationAwareImageList_ReadEx(DWORD dwFlags,struct IStream*pstm,REFIID riid,PVOID*ppv);
HRESULT IsolationAwarePrivatenCv IsolationAwareImageList_WriteEx(HIMAGELIST himl,DWORD dwFlags,struct IStream*pstm);
#endif
...
HBITMAP IsolationAwarePrivatenCv IsolationAwareCreateMappedBitmap(HINSTANCE hInstance,INT_PTR idBitmap,UINT wFlags,LPCOLORMAP lpColorMap,int iNumMaps);
...
void IsolationAwarePrivatenCv IsolationAwareMenuHelp(UINT uMsg,WPARAM wParam,LPARAM lParam,HMENU hMainMenu,HINSTANCE hInst,HWND hwndStatus,UINT*lpwIDs);
BOOL IsolationAwarePrivatenCv IsolationAwareShowHideMenuCtl(HWND hWnd,UINT_PTR uFlags,LPINT lpInfo);
void IsolationAwarePrivatenCv IsolationAwareGetEffectiveClientRect(HWND hWnd,LPRECT lprc,const int*lpInfo);
...
HRESULT IsolationAwarePrivatenCv IsolationAwareTaskDialogIndirect(const TASKDIALOGCONFIG*pTaskConfig,int*pnButton,int*pnRadioButton,BOOL*pfVerificationFlagChecked);
HRESULT IsolationAwarePrivatenCv IsolationAwareTaskDialog(HWND hwndParent,HINSTANCE hInstance,PCWSTR pszWindowTitle,PCWSTR pszMainInstruction,PCWSTR pszContent,TASKDIALOG_COMMON_BUTTON_FLAGS dwCommonButtons,PCWSTR pszIcon,int*pnButton);
#endif
...
BOOL IsolationAwarePrivatenCv IsolationAwareDSA_Destroy(HDSA hdsa);
void IsolationAwarePrivatenCv IsolationAwareDSA_DestroyCallback(HDSA hdsa,PFNDAENUMCALLBACK pfnCB,void*pData);
BOOL IsolationAwarePrivatenCv IsolationAwareDSA_DeleteItem(HDSA hdsa,int i);
BOOL IsolationAwarePrivatenCv IsolationAwareDSA_DeleteAllItems(HDSA hdsa);
void IsolationAwarePrivatenCv IsolationAwareDSA_EnumCallback(HDSA hdsa,PFNDAENUMCALLBACK pfnCB,void*pData);
int IsolationAwarePrivatenCv IsolationAwareDSA_InsertItem(HDSA hdsa,int i,const void*pitem);
PVOID IsolationAwarePrivatenCv IsolationAwareDSA_GetItemPtr(HDSA hdsa,int i);
BOOL IsolationAwarePrivatenCv IsolationAwareDSA_GetItem(HDSA hdsa,int i,void*pitem);
BOOL IsolationAwarePrivatenCv IsolationAwareDSA_SetItem(HDSA hdsa,int i,const void*pitem);
HDSA IsolationAwarePrivatenCv IsolationAwareDSA_Clone(HDSA hdsa);
ULONGLONG IsolationAwarePrivatenCv IsolationAwareDSA_GetSize(HDSA hdsa);
BOOL IsolationAwarePrivatenCv IsolationAwareDSA_Sort(HDSA pdsa,PFNDACOMPARE pfnCompare,LPARAM lParam);
HDPA IsolationAwarePrivatenCv IsolationAwareDPA_Create(int cItemGrow);
HDPA IsolationAwarePrivatenCv IsolationAwareDPA_CreateEx(int cpGrow,HANDLE hheap);
HDPA IsolationAwarePrivatenCv IsolationAwareDPA_Clone(const HDPA hdpa,HDPA hdpaNew);
BOOL IsolationAwarePrivatenCv IsolationAwareDPA_Destroy(HDPA hdpa);
void IsolationAwarePrivatenCv IsolationAwareDPA_DestroyCallback(HDPA hdpa,PFNDAENUMCALLBACK pfnCB,void*pData);
PVOID IsolationAwarePrivatenCv IsolationAwareDPA_DeletePtr(HDPA hdpa,int i);
BOOL IsolationAwarePrivatenCv IsolationAwareDPA_DeleteAllPtrs(HDPA hdpa);
void IsolationAwarePrivatenCv IsolationAwareDPA_EnumCallback(HDPA hdpa,PFNDAENUMCALLBACK pfnCB,void*pData);
BOOL IsolationAwarePrivatenCv IsolationAwareDPA_Grow(HDPA pdpa,int cp);
int IsolationAwarePrivatenCv IsolationAwareDPA_InsertPtr(HDPA hdpa,int i,void*p);
BOOL IsolationAwarePrivatenCv IsolationAwareDPA_SetPtr(HDPA hdpa,int i,void*p);
PVOID IsolationAwarePrivatenCv IsolationAwareDPA_GetPtr(HDPA hdpa,INT_PTR i);
int IsolationAwarePrivatenCv IsolationAwareDPA_GetPtrIndex(HDPA hdpa,const void*p);
ULONGLONG IsolationAwarePrivatenCv IsolationAwareDPA_GetSize(HDPA hdpa);
BOOL IsolationAwarePrivatenCv IsolationAwareDPA_Sort(HDPA hdpa,PFNDACOMPARE pfnCompare,LPARAM lParam);
HRESULT IsolationAwarePrivatenCv IsolationAwareDPA_LoadStream(HDPA*phdpa,PFNDPASTREAM pfn,struct IStream*pstream,void*pvInstData);
HRESULT IsolationAwarePrivatenCv IsolationAwareDPA_SaveStream(HDPA hdpa,PFNDPASTREAM pfn,struct IStream*pstream,void*pvInstData);
BOOL IsolationAwarePrivatenCv IsolationAwareDPA_Merge(HDPA hdpaDest,HDPA hdpaSrc,DWORD dwFlags,PFNDACOMPARE pfnCompare,PFNDPAMERGE pfnMerge,LPARAM lParam);
int IsolationAwarePrivatenCv IsolationAwareDPA_Search(HDPA hdpa,void*pFind,int iStart,PFNDACOMPARE pfnCompare,LPARAM lParam,UINT options);
BOOL IsolationAwarePrivatenCv IsolationAwareStr_SetPtrW(LPWSTR*ppsz,LPCWSTR psz);
#if !defined(NOTRACKMOUSEEVENT)
BOOL IsolationAwarePrivatenCv IsolationAware_TrackMouseEvent(LPTRACKMOUSEEVENT lpEventTrack);
#endif
...
HRESULT IsolationAwarePrivatenCv IsolationAwareLoadIconMetric(HINSTANCE hinst,PCWSTR pszName,int lims,HICON*phico);
HRESULT IsolationAwarePrivatenCv IsolationAwareLoadIconWithScaleDown(HINSTANCE hinst,PCWSTR pszName,int cx,int cy,HICON*phico);
int IsolationAwarePrivatenCv IsolationAwareDrawShadowText(HDC hdc,LPCWSTR pszText,UINT cch,RECT*prc,DWORD dwFlags,COLORREF crText,COLORREF crShadow,int ixOffset,int iyOffset);
...
ISOLATION_AWARE_INLINE HIMAGELIST IsolationAwarePrivatenCv IsolationAwareImageList_Read(struct IStream*pstm)
{
    HIMAGELIST imagelistResult = NULL;
    typedef HIMAGELIST (WINAPI* PFN)(struct IStream*pstm);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareImageList_Write(HIMAGELIST himl,struct IStream*pstm)
{
    BOOL fResult = FALSE;
    typedef BOOL (WINAPI* PFN)(HIMAGELIST himl,struct IStream*pstm);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
#if (_WIN32_WINNT >= 0x0501)
ISOLATION_AWARE_INLINE HRESULT IsolationAwarePrivatenCv IsolationAwareImageList_ReadEx(DWORD dwFlags,struct IStream*pstm,REFIID riid,PVOID*ppv)
{
    HRESULT result = S_OK;
    typedef HRESULT (WINAPI* PFN)(DWORD dwFlags,struct IStream*pstm,REFIID riid,PVOID*ppv);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE HRESULT IsolationAwarePrivatenCv IsolationAwareImageList_WriteEx(HIMAGELIST himl,DWORD dwFlags,struct IStream*pstm)
{
    HRESULT result = S_OK;
    typedef HRESULT (WINAPI* PFN)(HIMAGELIST himl,DWORD dwFlags,struct IStream*pstm);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE HBITMAP IsolationAwarePrivatenCv IsolationAwareCreateMappedBitmap(HINSTANCE hInstance,INT_PTR idBitmap,UINT wFlags,LPCOLORMAP lpColorMap,int iNumMaps)
{
...
ISOLATION_AWARE_INLINE void IsolationAwarePrivatenCv IsolationAwareMenuHelp(UINT uMsg,WPARAM wParam,LPARAM lParam,HMENU hMainMenu,HINSTANCE hInst,HWND hwndStatus,UINT*lpwIDs)
{
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareShowHideMenuCtl(HWND hWnd,UINT_PTR uFlags,LPINT lpInfo)
{
    BOOL fResult = FALSE;
...
ISOLATION_AWARE_INLINE void IsolationAwarePrivatenCv IsolationAwareGetEffectiveClientRect(HWND hWnd,LPRECT lprc,const int*lpInfo)
{
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
ISOLATION_AWARE_INLINE HRESULT IsolationAwarePrivatenCv IsolationAwareTaskDialogIndirect(const TASKDIALOGCONFIG*pTaskConfig,int*pnButton,int*pnRadioButton,BOOL*pfVerificationFlagChecked)
{
    HRESULT result = S_OK;
    typedef HRESULT (WINAPI* PFN)(const TASKDIALOGCONFIG*pTaskConfig,int*pnButton,int*pnRadioButton,BOOL*pfVerificationFlagChecked);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE HRESULT IsolationAwarePrivatenCv IsolationAwareTaskDialog(HWND hwndParent,HINSTANCE hInstance,PCWSTR pszWindowTitle,PCWSTR pszMainInstruction,PCWSTR pszContent,TASKDIALOG_COMMON_BUTTON_FLAGS dwCommonButtons,PCWSTR pszIcon,int*pnButton)
{
    HRESULT result = S_OK;
    typedef HRESULT (WINAPI* PFN)(HWND hwndParent,HINSTANCE hInstance,PCWSTR pszWindowTitle,PCWSTR pszMainInstruction,PCWSTR pszContent,TASKDIALOG_COMMON_BUTTON_FLAGS dwCommonButtons,PCWSTR pszIcon,int*pnButton);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDSA_Destroy(HDSA hdsa)
{
    BOOL fResult = FALSE;
...
ISOLATION_AWARE_INLINE void IsolationAwarePrivatenCv IsolationAwareDSA_DestroyCallback(HDSA hdsa,PFNDAENUMCALLBACK pfnCB,void*pData)
{
    typedef void (WINAPI* PFN)(HDSA hdsa,PFNDAENUMCALLBACK pfnCB,void*pData);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDSA_DeleteItem(HDSA hdsa,int i)
{
    BOOL fResult = FALSE;
    typedef BOOL (WINAPI* PFN)(HDSA hdsa,int i);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDSA_DeleteAllItems(HDSA hdsa)
{
    BOOL fResult = FALSE;
    typedef BOOL (WINAPI* PFN)(HDSA hdsa);
    static PFN s_pfn;
...
ISOLATION_AWARE_INLINE void IsolationAwarePrivatenCv IsolationAwareDSA_EnumCallback(HDSA hdsa,PFNDAENUMCALLBACK pfnCB,void*pData)
{
    typedef void (WINAPI* PFN)(HDSA hdsa,PFNDAENUMCALLBACK pfnCB,void*pData);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
...
ISOLATION_AWARE_INLINE int IsolationAwarePrivatenCv IsolationAwareDSA_InsertItem(HDSA hdsa,int i,const void*pitem)
{
    int nResult = -1;
...
ISOLATION_AWARE_INLINE PVOID IsolationAwarePrivatenCv IsolationAwareDSA_GetItemPtr(HDSA hdsa,int i)
{
    PVOID vResult = NULL;
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDSA_GetItem(HDSA hdsa,int i,void*pitem)
{
    BOOL fResult = FALSE;
    typedef BOOL (WINAPI* PFN)(HDSA hdsa,int i,void*pitem);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDSA_SetItem(HDSA hdsa,int i,const void*pitem)
{
    BOOL fResult = FALSE;
    typedef BOOL (WINAPI* PFN)(HDSA hdsa,int i,const void*pitem);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE HDSA IsolationAwarePrivatenCv IsolationAwareDSA_Clone(HDSA hdsa)
{
    HDSA result = NULL;
    typedef HDSA (WINAPI* PFN)(HDSA hdsa);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE ULONGLONG IsolationAwarePrivatenCv IsolationAwareDSA_GetSize(HDSA hdsa)
{
    ULONGLONG result = 0 ;
    typedef ULONGLONG (WINAPI* PFN)(HDSA hdsa);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDSA_Sort(HDSA pdsa,PFNDACOMPARE pfnCompare,LPARAM lParam)
{
    BOOL fResult = FALSE;
    typedef BOOL (WINAPI* PFN)(HDSA pdsa,PFNDACOMPARE pfnCompare,LPARAM lParam);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE HDPA IsolationAwarePrivatenCv IsolationAwareDPA_CreateEx(int cpGrow,HANDLE hheap)
{
    HDPA result = NULL;
    typedef HDPA (WINAPI* PFN)(int cpGrow,HANDLE hheap);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE HDPA IsolationAwarePrivatenCv IsolationAwareDPA_Clone(const HDPA hdpa,HDPA hdpaNew)
{
    HDPA result = NULL;
    typedef HDPA (WINAPI* PFN)(const HDPA hdpa,HDPA hdpaNew);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDPA_Destroy(HDPA hdpa)
{
    BOOL fResult = FALSE;
...
ISOLATION_AWARE_INLINE void IsolationAwarePrivatenCv IsolationAwareDPA_DestroyCallback(HDPA hdpa,PFNDAENUMCALLBACK pfnCB,void*pData)
{
    typedef void (WINAPI* PFN)(HDPA hdpa,PFNDAENUMCALLBACK pfnCB,void*pData);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE PVOID IsolationAwarePrivatenCv IsolationAwareDPA_DeletePtr(HDPA hdpa,int i)
{
    PVOID vResult = NULL;
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDPA_DeleteAllPtrs(HDPA hdpa)
{
    BOOL fResult = FALSE;
    typedef BOOL (WINAPI* PFN)(HDPA hdpa);
    static PFN s_pfn;
...
ISOLATION_AWARE_INLINE void IsolationAwarePrivatenCv IsolationAwareDPA_EnumCallback(HDPA hdpa,PFNDAENUMCALLBACK pfnCB,void*pData)
{
    typedef void (WINAPI* PFN)(HDPA hdpa,PFNDAENUMCALLBACK pfnCB,void*pData);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDPA_Grow(HDPA pdpa,int cp)
{
    BOOL fResult = FALSE;
    typedef BOOL (WINAPI* PFN)(HDPA pdpa,int cp);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE int IsolationAwarePrivatenCv IsolationAwareDPA_InsertPtr(HDPA hdpa,int i,void*p)
{
    int nResult = -1;
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDPA_SetPtr(HDPA hdpa,int i,void*p)
{
    BOOL fResult = FALSE;
...
ISOLATION_AWARE_INLINE PVOID IsolationAwarePrivatenCv IsolationAwareDPA_GetPtr(HDPA hdpa,INT_PTR i)
{
    PVOID vResult = NULL;
...
ISOLATION_AWARE_INLINE int IsolationAwarePrivatenCv IsolationAwareDPA_GetPtrIndex(HDPA hdpa,const void*p)
{
    int nResult = -1;
    typedef int (WINAPI* PFN)(HDPA hdpa,const void*p);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE ULONGLONG IsolationAwarePrivatenCv IsolationAwareDPA_GetSize(HDPA hdpa)
{
    ULONGLONG result = 0 ;
    typedef ULONGLONG (WINAPI* PFN)(HDPA hdpa);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDPA_Sort(HDPA hdpa,PFNDACOMPARE pfnCompare,LPARAM lParam)
{
    BOOL fResult = FALSE;
    typedef BOOL (WINAPI* PFN)(HDPA hdpa,PFNDACOMPARE pfnCompare,LPARAM lParam);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE HRESULT IsolationAwarePrivatenCv IsolationAwareDPA_LoadStream(HDPA*phdpa,PFNDPASTREAM pfn,struct IStream*pstream,void*pvInstData)
{
    HRESULT result = S_OK;
    typedef HRESULT (WINAPI* PFN)(HDPA*phdpa,PFNDPASTREAM pfn,struct IStream*pstream,void*pvInstData);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE HRESULT IsolationAwarePrivatenCv IsolationAwareDPA_SaveStream(HDPA hdpa,PFNDPASTREAM pfn,struct IStream*pstream,void*pvInstData)
{
    HRESULT result = S_OK;
    typedef HRESULT (WINAPI* PFN)(HDPA hdpa,PFNDPASTREAM pfn,struct IStream*pstream,void*pvInstData);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareDPA_Merge(HDPA hdpaDest,HDPA hdpaSrc,DWORD dwFlags,PFNDACOMPARE pfnCompare,PFNDPAMERGE pfnMerge,LPARAM lParam)
{
    BOOL fResult = FALSE;
    typedef BOOL (WINAPI* PFN)(HDPA hdpaDest,HDPA hdpaSrc,DWORD dwFlags,PFNDACOMPARE pfnCompare,PFNDPAMERGE pfnMerge,LPARAM lParam);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE int IsolationAwarePrivatenCv IsolationAwareDPA_Search(HDPA hdpa,void*pFind,int iStart,PFNDACOMPARE pfnCompare,LPARAM lParam,UINT options)
{
    int nResult = -1;
    typedef int (WINAPI* PFN)(HDPA hdpa,void*pFind,int iStart,PFNDACOMPARE pfnCompare,LPARAM lParam,UINT options);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    if (__IsolationAware_pfn == NULL)
    {
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareStr_SetPtrW(LPWSTR*ppsz,LPCWSTR psz)
{
    BOOL fResult = FALSE;
...
#if !defined(NOTRACKMOUSEEVENT)
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAware_TrackMouseEvent(LPTRACKMOUSEEVENT lpEventTrack)
{
    BOOL fResult = FALSE;
...
ISOLATION_AWARE_INLINE HRESULT IsolationAwarePrivatenCv IsolationAwareLoadIconMetric(HINSTANCE hinst,PCWSTR pszName,int lims,HICON*phico)
{
    HRESULT result = S_OK;
    typedef HRESULT (WINAPI* PFN)(HINSTANCE hinst,PCWSTR pszName,int lims,HICON*phico);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE HRESULT IsolationAwarePrivatenCv IsolationAwareLoadIconWithScaleDown(HINSTANCE hinst,PCWSTR pszName,int cx,int cy,HICON*phico)
{
    HRESULT result = S_OK;
    typedef HRESULT (WINAPI* PFN)(HINSTANCE hinst,PCWSTR pszName,int cx,int cy,HICON*phico);
    static PFN s_pfn;
    PFN __IsolationAware_pfn = s_pfn;
    ULONG_PTR ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE int IsolationAwarePrivatenCv IsolationAwareDrawShadowText(HDC hdc,LPCWSTR pszText,UINT cch,RECT*prc,DWORD dwFlags,COLORREF crText,COLORREF crShadow,int ixOffset,int iyOffset)
{
    int nResult = -1;
