/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Mon Jun 27 14:47:49 2016
 \date		Modified on Mon Jun 27 14:47:49 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#else
#define WINOLEAUTAPI        extern DECLSPEC_IMPORT HRESULT STDAPICALLTYPE
#define WINOLEAUTAPI_(type) extern DECLSPEC_IMPORT type STDAPICALLTYPE
#endif
...
WINOLEAUTAPI VarI8FromStr(LPCOLESTR strIn, LCID lcid, unsigned long dwFlags, LONG64 FAR* pi64Out);
...
WINOLEAUTAPI VarI8FromDec(const DECIMAL *pdecIn, LONG64 FAR* pi64Out);
...
WINOLEAUTAPI VarI1FromDec(const DECIMAL *pdecIn, CHAR *pcOut);
...
WINOLEAUTAPI VarUI8FromStr(LPCOLESTR strIn, LCID lcid, unsigned long dwFlags, ULONG64 FAR* pi64Out);
...
WINOLEAUTAPI VarUI8FromDec(const DECIMAL *pdecIn, ULONG64 FAR* pi64Out);
...
WINOLEAUTAPI UnRegisterTypeLibForUser(REFGUID libID, WORD wMajorVerNum, WORD wMinorVerNum, LCID lcid, SYSKIND syskind);
