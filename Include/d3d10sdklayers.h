...
extern const IID IID_ID3D10Debug;
typedef struct ID3D10DebugVtbl
{
	BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE * QueryInterface) (ID3D10Debug * This, REFIID riid, void **ppvObject);
	...
	HRESULT(STDMETHODCALLTYPE * SetPresentPerRenderOpDelay) (ID3D10Debug * This, UINT Milliseconds);
	UINT(STDMETHODCALLTYPE * GetPresentPerRenderOpDelay) (ID3D10Debug * This);
	HRESULT(STDMETHODCALLTYPE * SetSwapChain) (ID3D10Debug * This, IDXGISwapChain * pSwapChain);
	HRESULT(STDMETHODCALLTYPE * GetSwapChain) (ID3D10Debug * This, IDXGISwapChain ** ppSwapChain);
...
extern const IID IID_ID3D10SwitchToRef;

typedef struct ID3D10SwitchToRefVtbl
{
	BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE * QueryInterface) (ID3D10SwitchToRef * This, REFIID riid, void **ppvObject);
...
extern const IID IID_ID3D10InfoQueue;
typedef struct ID3D10InfoQueueVtbl
{
	BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE * QueryInterface) (ID3D10InfoQueue * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ID3D10InfoQueue * This);
	ULONG(STDMETHODCALLTYPE * Release) (ID3D10InfoQueue * This);
	HRESULT(STDMETHODCALLTYPE * SetMessageCountLimit) (ID3D10InfoQueue * This, UINT64 MessageCountLimit);
	void (STDMETHODCALLTYPE * ClearStoredMessages) (ID3D10InfoQueue * This);
	HRESULT(STDMETHODCALLTYPE * GetMessage) (ID3D10InfoQueue * This, UINT64 MessageIndex, D3D10_MESSAGE * pMessage, SIZE_T * pMessageByteLength);
	UINT64(STDMETHODCALLTYPE * GetNumMessagesAllowedByStorageFilter) (ID3D10InfoQueue * This);
	UINT64(STDMETHODCALLTYPE * GetNumMessagesDeniedByStorageFilter) (ID3D10InfoQueue * This);
	UINT64(STDMETHODCALLTYPE * GetNumStoredMessages) (ID3D10InfoQueue * This);
	UINT64(STDMETHODCALLTYPE * GetNumStoredMessagesAllowedByRetrievalFilter) (ID3D10InfoQueue * This);
	UINT64(STDMETHODCALLTYPE * GetNumMessagesDiscardedByMessageCountLimit) (ID3D10InfoQueue * This);
	UINT64(STDMETHODCALLTYPE * GetMessageCountLimit) (ID3D10InfoQueue * This);
	HRESULT(STDMETHODCALLTYPE * AddStorageFilterEntries) (ID3D10InfoQueue * This, D3D10_INFO_QUEUE_FILTER * pFilter);
	HRESULT(STDMETHODCALLTYPE * GetStorageFilter) (ID3D10InfoQueue * This, D3D10_INFO_QUEUE_FILTER * pFilter, SIZE_T * pFilterByteLength);
	...
	HRESULT(STDMETHODCALLTYPE * PushStorageFilter) (ID3D10InfoQueue * This, D3D10_INFO_QUEUE_FILTER * pFilter);
	...
	HRESULT(STDMETHODCALLTYPE * AddRetrievalFilterEntries) (ID3D10InfoQueue * This, D3D10_INFO_QUEUE_FILTER * pFilter);
	HRESULT(STDMETHODCALLTYPE * GetRetrievalFilter) (ID3D10InfoQueue * This, D3D10_INFO_QUEUE_FILTER * pFilter, SIZE_T * pFilterByteLength);
	...
	HRESULT(STDMETHODCALLTYPE * PushRetrievalFilter) (ID3D10InfoQueue * This, D3D10_INFO_QUEUE_FILTER * pFilter);
	...
	HRESULT(STDMETHODCALLTYPE * AddMessage) (ID3D10InfoQueue * This, D3D10_MESSAGE_CATEGORY Category, D3D10_MESSAGE_SEVERITY Severity, D3D10_MESSAGE_ID ID, LPCSTR pDescription);
	HRESULT(STDMETHODCALLTYPE * AddApplicationMessage) (ID3D10InfoQueue * This, D3D10_MESSAGE_SEVERITY Severity, LPCSTR pDescription);
	HRESULT(STDMETHODCALLTYPE * SetBreakOnCategory) (ID3D10InfoQueue * This, D3D10_MESSAGE_CATEGORY Category, BOOL bEnable);
	HRESULT(STDMETHODCALLTYPE * SetBreakOnSeverity) (ID3D10InfoQueue * This, D3D10_MESSAGE_SEVERITY Severity, BOOL bEnable);
	HRESULT(STDMETHODCALLTYPE * SetBreakOnID) (ID3D10InfoQueue * This, D3D10_MESSAGE_ID ID, BOOL bEnable);
	BOOL(STDMETHODCALLTYPE * GetBreakOnCategory) (ID3D10InfoQueue * This, D3D10_MESSAGE_CATEGORY Category);
	BOOL(STDMETHODCALLTYPE * GetBreakOnSeverity) (ID3D10InfoQueue * This, D3D10_MESSAGE_SEVERITY Severity);
	BOOL(STDMETHODCALLTYPE * GetBreakOnID) (ID3D10InfoQueue * This, D3D10_MESSAGE_ID ID);
	void (STDMETHODCALLTYPE * SetMuteDebugOutput) (ID3D10InfoQueue * This, BOOL bMute);
