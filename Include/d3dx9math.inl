/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Fri Nov 11 16:34:49 2016
 \date		Modified on Fri Nov 11 16:34:49 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
D3DXINLINE D3DXPLANE *D3DXPlaneScale(D3DXPLANE *pOut, CONST D3DXPLANE *pP, FLOAT s)
{
#ifdef D3DX_DEBUG
	if (!pOut || !pP)
		return NULL;
