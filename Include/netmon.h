/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Jul  2 20:37:41 2016
 \date		Modified on Sat Jul  2 20:37:41 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef union __MIDL___MIDL_itf_netmon_0000_0000_0001
{
	BYTE NextHeader;
	BYTE IPPort;
...
#pragma pack(push, 8)
typedef enum __MIDL___MIDL_itf_netmon_0000_0000_0005
{
...
typedef struct __MIDL___MIDL_itf_netmon_0000_0000_0007
{
	DWORD dwNumBlobs;
	HBLOB hBlobs[1];
} BLOB_TABLE;
typedef BLOB_TABLE *PBLOB_TABLE;
typedef struct __MIDL___MIDL_itf_netmon_0000_0000_0008
{
	DWORD size;
	BYTE *pBytes;
} MBLOB;
typedef struct __MIDL___MIDL_itf_netmon_0000_0000_0009
{
	DWORD dwNumBlobs;
	MBLOB mBlobs[1];
} MBLOB_TABLE;
...
typedef DWORD(__cdecl FAR *BLOBSPROC) (PBLOB_TABLE *ppBlobTable);
DWORD __cdecl GetConfigBlob(HBLOB *phBlob);
typedef DWORD(__cdecl FAR *GETCFGBLOB) (HBLOB, HBLOB *);
typedef DWORD(__cdecl FAR *CFGPROC) (HWND hwnd, HBLOB SpecialBlob, PBLOB_TABLE *ppBlobTable);
BOOL __cdecl FilterNPPBlob(HBLOB hBlob, HBLOB FilterBlob);
BOOL __cdecl RaiseNMEvent(HINSTANCE hInstance, WORD EventType, DWORD EventID, WORD nStrings, const char **aInsertStrs, LPVOID lpvData, DWORD dwDataSize);
...
DWORD WINAPI FilterFindFrame(HFILTER hFilter, HCAPTURE hCapture, DWORD nFrame, STATUSPROC StatusProc, LPVOID UIInstance, DWORD TimeDelta, BOOL FilterDirection);
HFRAME FilterFindPropertyInstance(HFRAME hFrame, HFILTER hMasterFilter, HCAPTURE hCapture, HFILTER hInstanceFilter, LPPROPERTYINST *lpPropRestartKey, STATUSPROC StatusProc, LPVOID UIInstance, DWORD TimeDelta, BOOL FilterForward);
...
LPBYTE WINAPI StringToAddress(LPBYTE lpAddress, LPSTR string);
LPDWORD WINAPI VarLenSmallIntToDword(LPBYTE pValue, WORD ValueLen, BOOL fIsByteswapped, LPDWORD lpDword);
...
BOOL __cdecl BERGetInteger(ULPBYTE pCurrentPointer, ULPBYTE *ppValuePointer, LPDWORD pHeaderLength, LPDWORD pDataLength, ULPBYTE *ppNext);
BOOL __cdecl BERGetString(ULPBYTE pCurrentPointer, ULPBYTE *ppValuePointer, LPDWORD pHeaderLength, LPDWORD pDataLength, ULPBYTE *ppNext);
BOOL __cdecl BERGetHeader(ULPBYTE pCurrentPointer, ULPBYTE pTag, LPDWORD pHeaderLength, LPDWORD pDataLength, ULPBYTE *ppNext);
...
#endif
typedef enum __MIDL___MIDL_itf_netmon_0000_0000_0015
{
...
LPSTR __cdecl BuildINIPath(LPSTR FullPath, LPSTR IniFileName);
...
typedef
	enum __MIDL___MIDL_itf_netmon_0000_0000_0016 { EXPERTSTATUS_INACTIVE = 0,
...
typedef struct __MIDL___MIDL_itf_netmon_0000_0000_0017
{
...
BOOL WINAPI AttachPropertyInstance(HFRAME hFrame, HPROPERTY hProperty, DWORD Length, ULPVOID lpData, DWORD HelpID, DWORD Level, DWORD IFlags);
BOOL WINAPI AttachPropertyInstanceEx(HFRAME hFrame, HPROPERTY hProperty, DWORD Length, ULPVOID lpData, DWORD ExLength, ULPVOID lpExData, DWORD HelpID, DWORD Level, DWORD IFlags);
LPPROPERTYINST WINAPI FindPropertyInstance(HFRAME hFrame, HPROPERTY hProperty);
LPPROPERTYINST WINAPI FindPropertyInstanceRestart(HFRAME hFrame, HPROPERTY hProperty, LPPROPERTYINST *lpRestartKey, BOOL DirForward);
...
DWORD WINAPI GetCaptureCommentFromFilename(LPSTR lpFilename, LPSTR lpComment, DWORD CommentSize);
...
DWORD __cdecl SetBoolInBlob(HBLOB hBlob, const char *pOwnerName, const char *pCategoryName, const char *pTagName, BOOL Bool);
DWORD __cdecl GetBoolFromBlob(HBLOB hBlob, const char *pOwnerName, const char *pCategoryName, const char *pTagName, BOOL *pBool);
...
BOOL __cdecl IsRemoteNPP(HBLOB hBLOB);
...
BOOL __cdecl SubkeyExists(const char *pszPath, const char *szSubkey);
BOOL __cdecl setKeyAndValue(const char *szKey, const char *szSubkey, const char *szValue, const char *szName);
#pragma pack(push, 1)
typedef struct _IP
{
	union
...
typedef struct __MIDL___MIDL_itf_netmon_0000_0000_0018
{
	UCHAR ha_address[6];
} HOST_ADDRESS;
...
typedef struct __MIDL___MIDL_itf_netmon_0000_0000_0019
{
	USHORT ipx_checksum;
	USHORT ipx_length;
...
extern const IID IID_IDelaydC;
typedef struct IDelaydCVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (IDelaydC *This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE *AddRef) (IDelaydC *This);
	ULONG(STDMETHODCALLTYPE *Release) (IDelaydC *This);
	HRESULT(STDMETHODCALLTYPE *Connect) (IDelaydC *This, HBLOB hInputBlob, LPVOID StatusCallbackProc, LPVOID UserContext, HBLOB hErrorBlob);
	HRESULT(STDMETHODCALLTYPE *Disconnect) (IDelaydC *This);
	HRESULT(STDMETHODCALLTYPE *QueryStatus) (IDelaydC *This, NETWORKSTATUS *pNetworkStatus);
	HRESULT(STDMETHODCALLTYPE *Configure) (IDelaydC *This, HBLOB hConfigurationBlob, HBLOB hErrorBlob);
	HRESULT(STDMETHODCALLTYPE *Start) (IDelaydC *This, char *pFileName);
	HRESULT(STDMETHODCALLTYPE *Pause) (IDelaydC *This);
	HRESULT(STDMETHODCALLTYPE *Resume) (IDelaydC *This);
	HRESULT(STDMETHODCALLTYPE *Stop) (IDelaydC *This, LPSTATISTICS lpStats);
	HRESULT(STDMETHODCALLTYPE *GetControlState) (IDelaydC *This, BOOL *IsRunnning, BOOL *IsPaused);
	HRESULT(STDMETHODCALLTYPE *GetTotalStatistics) (IDelaydC *This, LPSTATISTICS lpStats, BOOL fClearAfterReading);
	HRESULT(STDMETHODCALLTYPE *GetConversationStatistics) (IDelaydC *This, DWORD *nSessions, LPSESSIONSTATS lpSessionStats, DWORD *nStations, LPSTATIONSTATS lpStationStats, BOOL fClearAfterReading);
	HRESULT(STDMETHODCALLTYPE *InsertSpecialFrame) (IDelaydC *This, DWORD FrameType, DWORD Flags, BYTE *pUserData, DWORD UserDataLength);
	HRESULT(STDMETHODCALLTYPE *QueryStations) (IDelaydC *This, QUERYTABLE *lpQueryTable);
	END_INTERFACE
}  IDelaydCVtbl;
interface IDelaydC
{
...
extern const IID IID_IRTC;
typedef struct IRTCVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (IRTC *This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE *AddRef) (IRTC *This);
	ULONG(STDMETHODCALLTYPE *Release) (IRTC *This);
	HRESULT(STDMETHODCALLTYPE *Connect) (IRTC *This, HBLOB hInputBlob, LPVOID StatusCallbackProc, LPVOID FramesCallbackProc, LPVOID UserContext, HBLOB hErrorBlob);
	HRESULT(STDMETHODCALLTYPE *Disconnect) (IRTC *This);
	HRESULT(STDMETHODCALLTYPE *QueryStatus) (IRTC *This, NETWORKSTATUS *pNetworkStatus);
	HRESULT(STDMETHODCALLTYPE *Configure) (IRTC *This, HBLOB hConfigurationBlob, HBLOB hErrorBlob);
	HRESULT(STDMETHODCALLTYPE *Start) (IRTC *This);
	HRESULT(STDMETHODCALLTYPE *Pause) (IRTC *This);
	HRESULT(STDMETHODCALLTYPE *Resume) (IRTC *This);
	HRESULT(STDMETHODCALLTYPE *Stop) (IRTC *This);
	HRESULT(STDMETHODCALLTYPE *GetControlState) (IRTC *This, BOOL *IsRunnning, BOOL *IsPaused);
	HRESULT(STDMETHODCALLTYPE *GetTotalStatistics) (IRTC *This, LPSTATISTICS lpStats, BOOL fClearAfterReading);
	HRESULT(STDMETHODCALLTYPE *GetConversationStatistics) (IRTC *This, DWORD *nSessions, LPSESSIONSTATS lpSessionStats, DWORD *nStations, LPSTATIONSTATS lpStationStats, BOOL fClearAfterReading);
	HRESULT(STDMETHODCALLTYPE *InsertSpecialFrame) (IRTC *This, DWORD FrameType, DWORD Flags, BYTE *pUserData, DWORD UserDataLength);
	HRESULT(STDMETHODCALLTYPE *QueryStations) (IRTC *This, QUERYTABLE *lpQueryTable);
	END_INTERFACE
}  IRTCVtbl;
interface IRTC
{
...
extern const IID IID_IStats;
typedef struct IStatsVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (IStats *This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE *AddRef) (IStats *This);
	ULONG(STDMETHODCALLTYPE *Release) (IStats *This);
	HRESULT(STDMETHODCALLTYPE *Connect) (IStats *This, HBLOB hInputBlob, LPVOID StatusCallbackProc, LPVOID UserContext, HBLOB hErrorBlob);
	HRESULT(STDMETHODCALLTYPE *Disconnect) (IStats *This);
	HRESULT(STDMETHODCALLTYPE *QueryStatus) (IStats *This, NETWORKSTATUS *pNetworkStatus);
	HRESULT(STDMETHODCALLTYPE *Configure) (IStats *This, HBLOB hConfigurationBlob, HBLOB hErrorBlob);
	HRESULT(STDMETHODCALLTYPE *Start) (IStats *This);
	HRESULT(STDMETHODCALLTYPE *Pause) (IStats *This);
	HRESULT(STDMETHODCALLTYPE *Resume) (IStats *This);
	HRESULT(STDMETHODCALLTYPE *Stop) (IStats *This);
	HRESULT(STDMETHODCALLTYPE *GetControlState) (IStats *This, BOOL *IsRunnning, BOOL *IsPaused);
	HRESULT(STDMETHODCALLTYPE *GetTotalStatistics) (IStats *This, LPSTATISTICS lpStats, BOOL fClearAfterReading);
	HRESULT(STDMETHODCALLTYPE *GetConversationStatistics) (IStats *This, DWORD *nSessions, LPSESSIONSTATS lpSessionStats, DWORD *nStations, LPSTATIONSTATS lpStationStats, BOOL fClearAfterReading);
	HRESULT(STDMETHODCALLTYPE *InsertSpecialFrame) (IStats *This, DWORD FrameType, DWORD Flags, BYTE *pUserData, DWORD UserDataLength);
	HRESULT(STDMETHODCALLTYPE *QueryStations) (IStats *This, QUERYTABLE *lpQueryTable);
	END_INTERFACE
}  IStatsVtbl;
interface IStats
{
