/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Tue Jun 28 17:14:57 2016
 \date		Modified on Tue Jun 28 17:14:57 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef BOOL        (*PFN_PROVIDER_CERTCHKPOLICY_CALL)( struct _CRYPT_PROVIDER_DATA *pProvData,
                                                        DWORD idxSigner,
                                                        BOOL fCounterSignerChain,
                                                        DWORD idxCounterSigner);
#define WVT_OFFSETOF(t,f)   ((ULONG)((ULONG_PTR)(&((t*)0)->f)))
#define WVT_ISINSTRUCT(structtypedef, structpassedsize, member) ((WVT_OFFSETOF(structtypedef, member) + sizeof(((structtypedef *) 0)->member) <= structpassedsize) ? TRUE : FALSE)
...
typedef BOOL (*PFN_ALLOCANDFILLDEFUSAGE)(const char *pszUsageOID,
                                         struct _CRYPT_PROVIDER_DEFUSAGE *psDefUsage);
typedef BOOL (*PFN_FREEDEFUSAGE)(const char *pszUsageOID,
                                 struct _CRYPT_PROVIDER_DEFUSAGE *psDefUsage);
...
extern BOOL WINAPI  WintrustAddActionID(GUID *pgActionID,
                                        DWORD fdwFlags,
...
extern BOOL WINAPI              WintrustAddDefaultForUsage(const char *pszUsageOID,
