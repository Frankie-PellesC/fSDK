/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Sep  3 17:52:45 2016
 \date		Modified on Sat Sep  3 17:52:45 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#endif
HRESULT NTDSBCLI_API DsIsNTDSOnlineA(LPCSTR szServerName, BOOL *pfNTDSOnline);
HRESULT NTDSBCLI_API DsIsNTDSOnlineW(LPCWSTR szServerName, BOOL *pfNTDSOnline);
