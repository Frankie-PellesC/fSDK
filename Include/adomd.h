/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Jul  2 15:41:23 2016
 \date		Modified on Sat Jul  2 15:41:23 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ICatalog *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ICellset;
typedef struct ICellsetVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ICellset *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Cell;
typedef struct CellVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Cell *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Axis;
typedef struct AxisVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Axis *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Position;
typedef struct PositionVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Position *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Member;
typedef struct MemberVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Member *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Level;
typedef struct LevelVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Level *This, REFIID riid, void **ppvObject);
...
extern const IID IID_CubeDef25;
typedef struct CubeDef25Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (CubeDef25 *This, REFIID riid, void **ppvObject);
...
extern const IID IID_CubeDef;
typedef struct CubeDefVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (CubeDef *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Dimension;
typedef struct DimensionVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Dimension *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Hierarchy;
typedef struct HierarchyVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Hierarchy *This, REFIID riid, void **ppvObject);
...
extern const IID IID_MD_Collection;
typedef struct MD_CollectionVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (MD_Collection *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Members;
typedef struct MembersVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Members *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Levels;
typedef struct LevelsVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Levels *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Axes;
typedef struct AxesVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Axes *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Positions;
typedef struct PositionsVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Positions *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Hierarchies;
typedef struct HierarchiesVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Hierarchies *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Dimensions;
typedef struct DimensionsVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Dimensions *This, REFIID riid, void **ppvObject);
...
extern const IID IID_CubeDefs;
typedef struct CubeDefsVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (CubeDefs *This, REFIID riid, void **ppvObject);
...
extern const CLSID CLSID_Cellset;
#endif
#endif
