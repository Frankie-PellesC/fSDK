/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Sep 17 01:06:24 2016
 \date		Modified on Sat Sep 17 01:06:24 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE __RPC_FAR * QueryInterface) (ISQLServerErrorInfo __RPC_FAR * This, REFIID riid, void __RPC_FAR * __RPC_FAR * ppvObject);
	ULONG(STDMETHODCALLTYPE __RPC_FAR * AddRef) (ISQLServerErrorInfo __RPC_FAR * This);
	ULONG(STDMETHODCALLTYPE __RPC_FAR * Release) (ISQLServerErrorInfo __RPC_FAR * This);
	HRESULT(STDMETHODCALLTYPE __RPC_FAR * GetErrorInfo) (ISQLServerErrorInfo __RPC_FAR * This, SSERRORINFO __RPC_FAR * __RPC_FAR * ppErrorInfo, OLECHAR __RPC_FAR * __RPC_FAR * ppStringsBuffer);
	END_INTERFACE
...
#endif
HRESULT STDMETHODCALLTYPE ISQLServerErrorInfo_GetErrorInfo_Proxy(ISQLServerErrorInfo __RPC_FAR *This, SSERRORINFO __RPC_FAR *__RPC_FAR *ppErrorInfo, OLECHAR __RPC_FAR *__RPC_FAR *ppStringsBuffer);
...
extern const IID IID_IRowsetFastLoad;
typedef struct IRowsetFastLoadVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE __RPC_FAR *QueryInterface) (IRowsetFastLoad __RPC_FAR *This, REFIID riid, void __RPC_FAR *__RPC_FAR *ppvObject);
	ULONG(STDMETHODCALLTYPE __RPC_FAR *AddRef) (IRowsetFastLoad __RPC_FAR *This);
	ULONG(STDMETHODCALLTYPE __RPC_FAR *Release) (IRowsetFastLoad __RPC_FAR *This);
	HRESULT(STDMETHODCALLTYPE __RPC_FAR *InsertRow) (IRowsetFastLoad __RPC_FAR *This, HACCESSOR hAccessor, void __RPC_FAR *pData);
	HRESULT(STDMETHODCALLTYPE __RPC_FAR *Commit) (IRowsetFastLoad __RPC_FAR *This, BOOL fDone);
	END_INTERFACE
}  IRowsetFastLoadVtbl;
...
#endif
HRESULT STDMETHODCALLTYPE IRowsetFastLoad_InsertRow_Proxy(IRowsetFastLoad __RPC_FAR *This, HACCESSOR hAccessor, void __RPC_FAR *pData);
...
HRESULT STDMETHODCALLTYPE IRowsetFastLoad_Commit_Proxy(IRowsetFastLoad __RPC_FAR *This, BOOL fDone);
...
extern const IID IID_ISchemaLock;
typedef struct ISchemaLockVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE __RPC_FAR *QueryInterface) (ISchemaLock __RPC_FAR *This, REFIID riid, void __RPC_FAR *__RPC_FAR *ppvObject);
	ULONG(STDMETHODCALLTYPE __RPC_FAR *AddRef) (ISchemaLock __RPC_FAR *This);
	ULONG(STDMETHODCALLTYPE __RPC_FAR *Release) (ISchemaLock __RPC_FAR *This);
	HRESULT(STDMETHODCALLTYPE __RPC_FAR *GetSchemaLock) (ISchemaLock __RPC_FAR *This, DBID __RPC_FAR *pTableID, LOCKMODE lmMode, HANDLE __RPC_FAR *phLockHandle, ULONGLONG __RPC_FAR *pTableVersion);
	HRESULT(STDMETHODCALLTYPE __RPC_FAR *ReleaseSchemaLock) (ISchemaLock __RPC_FAR *This, HANDLE hLockHandle);
	END_INTERFACE
}  ISchemaLockVtbl;
...
#endif
HRESULT STDMETHODCALLTYPE ISchemaLock_GetSchemaLock_Proxy(ISchemaLock __RPC_FAR *This, DBID __RPC_FAR *pTableID, LOCKMODE lmMode, HANDLE __RPC_FAR *phLockHandle, ULONGLONG __RPC_FAR *pTableVersion);
...
HRESULT STDMETHODCALLTYPE ISchemaLock_ReleaseSchemaLock_Proxy(ISchemaLock __RPC_FAR *This, HANDLE hLockHandle);
