/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Sep  3 20:47:20 2016
 \date		Modified on Sat Sep  3 20:47:20 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
extern const IID IID_ISpRecoCategory;
typedef struct ISpRecoCategoryVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISpRecoCategory * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISpRecoCategory * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISpRecoCategory * This);
	HRESULT(STDMETHODCALLTYPE * GetType) (ISpRecoCategory * This, SPCATEGORYTYPE * peCategoryType);
	END_INTERFACE
}  ISpRecoCategoryVtbl;
...
extern const IID IID_ISpRecognizer3;
typedef struct ISpRecognizer3Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISpRecognizer3 * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISpRecognizer3 * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISpRecognizer3 * This);
	HRESULT(STDMETHODCALLTYPE * GetCategory) (ISpRecognizer3 * This, SPCATEGORYTYPE categoryType, ISpRecoCategory ** ppCategory);
	HRESULT(STDMETHODCALLTYPE * SetActiveCategory) (ISpRecognizer3 * This, ISpRecoCategory * pCategory);
	HRESULT(STDMETHODCALLTYPE * GetActiveCategory) (ISpRecognizer3 * This, ISpRecoCategory ** ppCategory);
	END_INTERFACE
}  ISpRecognizer3Vtbl;
