/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 17 23:30:39 2016
 \date		Modified on Sun Jul 17 23:30:39 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#endif
NET_API_STATUS NET_API_FUNCTION NetAuditClear(LPCWSTR server, LPCWSTR backupfile, LPCWSTR service);
NET_API_STATUS NET_API_FUNCTION NetAuditRead(LPCWSTR server, LPCWSTR service, LPHLOG auditloghandle, DWORD offset, LPDWORD reserved1, DWORD reserved2, DWORD offsetflag, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD bytesread, LPDWORD totalavailable);
NET_API_STATUS NET_API_FUNCTION NetAuditWrite(DWORD type, LPBYTE buf, DWORD numbytes, LPCWSTR service, LPBYTE reserved);
