/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 17 22:30:20 2016
 \date		Modified on Sun Jul 17 22:30:20 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#pragma once
#endif
NET_API_STATUS NET_API_FUNCTION NetAlertRaise(LPCWSTR AlertType, LPVOID Buffer, DWORD BufferSize);
NET_API_STATUS NET_API_FUNCTION NetAlertRaiseEx(LPCWSTR AlertType, LPVOID VariableInfo, DWORD VariableInfoSize, LPCWSTR ServiceName);
