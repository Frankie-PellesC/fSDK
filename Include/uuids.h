/*+@@file@@----------------------------------------------------------------*//*!
 \file		uuids.h
 \par Description 
            Contains the GUIDs for the MediaType type, subtype fields and 
            format types for standard media types, and also class ids for 
            well-known components.
 \par  Status: 
            
 \par Project: 
			PellesC Headers extension
 \date		Created  on Sun Mar 15 04:49:43 2015
 \date		Modified on Sun Mar 15 04:49:43 2015
 \author	Frankie
\*//*-@@file@@----------------------------------------------------------------*/
#ifndef _UUIDS_H_
#define _UUIDS_H_
