/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Sep 11 23:40:24 2016
 \date		Modified on Sun Sep 11 23:40:24 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef struct tagFOLDERINFO_OE6
{
    ...
    DWORD               dwClientHigh;
    DWORD               dwClientLow;
    DWORD               dwStatusMsgDelta;
    DWORD               dwStatusUnreadDelta;
    DWORD               dwNotDownloaded;
    BLOB                Requested;
    BLOB                Read;
    DWORD               dwClientWatchedHigh;
...
typedef struct tagFOLDERUSERDATA_OE6
{
    ...
    DWORD               dwUIDValidity;
    DWORD               idMsgSelected;
    BYTE                rgbColumns[CB_COLUMNS_OE6];
    DWORD               dwReserved1;
    DWORD               dwReserved2;
    DWORD               fExpandAll;
    DWORD               dwReserved3;
    BYTE                fViewCounts;
    BYTE                fNewThreadModel;
    BYTE                fWatchedCounts;
    BYTE                fTotalWatched;
    BYTE                fShowDeleted;
    BYTE                fShowReplies;
...
typedef struct tagMESSAGEINFO_OE6
{
    ...
    LPSTR               pszFolder;
    DWORD               iFindFolder;
    MESSAGEID           idFindSource;
    MESSAGEID           idParentOld;
    BLOB                ThreadIdOld;
    BYTE                bUnused;
    LPSTR               pszMSOESRec;
