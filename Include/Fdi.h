/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 10 17:38:23 2016
 \date		Modified on Sun Jul 10 17:38:23 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef void (FAR DIAMONDAPI *PFNFREE)(void HUGE *pv);
#define FNFREE(fn) void FAR DIAMONDAPI fn(void HUGE *pv)
typedef INT_PTR (FAR DIAMONDAPI *PFNOPEN) (LPSTR pszFile, int oflag, int pmode);
...
#define FNOPEN(fn) INT_PTR FAR DIAMONDAPI fn(LPSTR pszFile, int oflag, int pmode)
...
typedef INT_PTR(FAR DIAMONDAPI *PFNFDINOTIFY) (FDINOTIFICATIONTYPE fdint, PFDINOTIFICATION pfdin);
...
#define     cpu80286           (0)
#define     cpu80386           (1)
HFDI FAR DIAMONDAPI FDICreate(PFNALLOC pfnalloc, PFNFREE pfnfree, PFNOPEN pfnopen, PFNREAD pfnread, PFNWRITE pfnwrite, PFNCLOSE pfnclose, PFNSEEK pfnseek, int cpuType, PERF perf);
BOOL FAR DIAMONDAPI FDIIsCabinet(HFDI hfdi, INT_PTR hf, PFDICABINETINFO pfdici);
BOOL FAR DIAMONDAPI FDICopy(HFDI hfdi, LPSTR pszCabinet, LPSTR pszCabPath, int flags, PFNFDINOTIFY pfnfdin, PFNFDIDECRYPT pfnfdid, void FAR *pvUser);
BOOL FAR DIAMONDAPI FDIDestroy(HFDI hfdi);
BOOL FAR DIAMONDAPI FDITruncateCabinet(HFDI hfdi, LPSTR pszCabinetName, USHORT iFolderToDelete);
#ifndef _WIN64
#include <poppack.h>
#endif
#endif
