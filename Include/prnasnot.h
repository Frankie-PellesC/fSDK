/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Sep  3 20:22:51 2016
 \date		Modified on Sat Sep  3 20:22:51 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
DECLARE_INTERFACE_(IPrintAsyncNotifyDataObject, IUnknown)
{
	...
	STDMETHOD(AcquireData) (THIS_ BYTE ** ppNotificationData, ULONG * pSize, PrintAsyncNotificationType ** ppSchema);
	STDMETHOD(ReleaseData) (THIS);
};
...
DECLARE_INTERFACE_(IPrintAsyncNotifyChannel, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SendNotification) (THIS_ IPrintAsyncNotifyDataObject * pData);
	STDMETHOD(CloseChannel) (THIS_ IPrintAsyncNotifyDataObject * pData);
};
#undef  INTERFACE
...
DECLARE_INTERFACE_(IPrintAsyncNotifyCallback, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(OnEventNotify) (THIS_ IPrintAsyncNotifyChannel * pChannel, IPrintAsyncNotifyDataObject * pData);
	STDMETHOD(ChannelClosed) (THIS_ IPrintAsyncNotifyChannel * pChannel, IPrintAsyncNotifyDataObject * pData);
};
#undef INTERFACE
HRESULT WINAPI RegisterForPrintAsyncNotifications(PCWSTR pszName, PrintAsyncNotificationType *pNotificationType, PrintAsyncNotifyUserFilter eUserFilter, PrintAsyncNotifyConversationStyle eConversationStyle, IPrintAsyncNotifyCallback *pCallback, HANDLE *phNotify);
HRESULT WINAPI UnRegisterForPrintAsyncNotifications(HANDLE);
HRESULT WINAPI CreatePrintAsyncNotifyChannel(PCWSTR pszName, PrintAsyncNotificationType *pNotificationType, PrintAsyncNotifyUserFilter eUserFilter, PrintAsyncNotifyConversationStyle eConversationStyle, IPrintAsyncNotifyCallback *pCallback, IPrintAsyncNotifyChannel **ppIAsynchNotification);
typedef enum
{
