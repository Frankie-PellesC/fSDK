/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jun 19 16:37:04 2016
 \date		Modified on Sun Jun 19 16:37:04 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
DECLARE_INTERFACE_(IDirectInputJoyConfig, IUnknown)
{
    ...
    STDMETHOD(SendNotify)(THIS) ;
    STDMETHOD(EnumTypes)(THIS_ LPDIJOYTYPECALLBACK,LPVOID) ;
    STDMETHOD(GetTypeInfo)(THIS_ LPCWSTR,LPDIJOYTYPEINFO,DWORD) ;
    STDMETHOD(SetTypeInfo)(THIS_ LPCWSTR,LPCDIJOYTYPEINFO,DWORD) ;
    STDMETHOD(DeleteType)(THIS_ LPCWSTR) ;
    STDMETHOD(GetConfig)(THIS_ UINT,LPDIJOYCONFIG,DWORD) ;
    STDMETHOD(SetConfig)(THIS_ UINT,LPCDIJOYCONFIG,DWORD) ;
    STDMETHOD(DeleteConfig)(THIS_ UINT) ;
    STDMETHOD(GetUserValues)(THIS_ LPDIJOYUSERVALUES,DWORD) ;
    STDMETHOD(SetUserValues)(THIS_ LPCDIJOYUSERVALUES,DWORD) ;
    STDMETHOD(AddNewHardware)(THIS_ HWND,REFGUID) ;
    STDMETHOD(OpenTypeKey)(THIS_ LPCWSTR,DWORD,PHKEY) ;
    STDMETHOD(OpenConfigKey)(THIS_ UINT,DWORD,PHKEY) ;
};
...
DECLARE_INTERFACE_(IDirectInputJoyConfig8, IUnknown)
{
    ...
    STDMETHOD(EnumTypes)(THIS_ LPDIJOYTYPECALLBACK,LPVOID) ;
    STDMETHOD(GetTypeInfo)(THIS_ LPCWSTR,LPDIJOYTYPEINFO,DWORD) ;
    STDMETHOD(SetTypeInfo)(THIS_ LPCWSTR,LPCDIJOYTYPEINFO,DWORD,LPWSTR) ;
    STDMETHOD(DeleteType)(THIS_ LPCWSTR) ;
    STDMETHOD(GetConfig)(THIS_ UINT,LPDIJOYCONFIG,DWORD) ;
    STDMETHOD(SetConfig)(THIS_ UINT,LPCDIJOYCONFIG,DWORD) ;
    STDMETHOD(DeleteConfig)(THIS_ UINT) ;
    ...
    STDMETHOD(AddNewHardware)(THIS_ HWND,REFGUID) ;
    STDMETHOD(OpenTypeKey)(THIS_ LPCWSTR,DWORD,PHKEY) ;
    STDMETHOD(OpenAppStatusKey)(THIS_ PHKEY) ;
};
