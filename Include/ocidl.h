/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Tue Jun 28 14:20:35 2016
 \date		Modified on Tue Jun 28 14:20:35 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (IEnumConnections * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (IEnumConnections * This);
	ULONG(STDMETHODCALLTYPE * Release) (IEnumConnections * This);
	HRESULT(STDMETHODCALLTYPE * Next) (IEnumConnections * This, ULONG cConnections, LPCONNECTDATA rgcd, ULONG * pcFetched);
	...
	HRESULT(STDMETHODCALLTYPE * Clone) (IEnumConnections * This, IEnumConnections ** ppEnum);
	END_INTERFACE
...
#endif
HRESULT STDMETHODCALLTYPE IEnumConnections_RemoteNext_Proxy(IEnumConnections *This, ULONG cConnections, LPCONNECTDATA rgcd, ULONG *pcFetched);
...
#endif
HRESULT STDMETHODCALLTYPE IEnumConnectionPoints_RemoteNext_Proxy(IEnumConnectionPoints *This, ULONG cConnections, LPCONNECTIONPOINT *ppCP, ULONG *pcFetched);
...
extern const IID IID_IClassFactory2;
...
#endif
HRESULT STDMETHODCALLTYPE IClassFactory2_RemoteCreateInstanceLic_Proxy(IClassFactory2 *This, REFIID riid, BSTR bstrKey, IUnknown **ppvObj);
...
extern const IID IID_IProvideClassInfo2;
...
typedef
enum tagCTRLINFO { CTRLINFO_EATS_RETURN = 1,
CTRLINFO_EATS_ESCAPE = 2
} CTRLINFO;
extern const IID IID_IOleControl;
...
typedef
enum tagXFORMCOORDS { XFORMCOORDS_POSITION = 0x1,
XFORMCOORDS_SIZE = 0x2,
XFORMCOORDS_HIMETRICTOCONTAINER = 0x4,
XFORMCOORDS_CONTAINERTOHIMETRIC = 0x8,
XFORMCOORDS_EVENTCOMPAT = 0x10
} XFORMCOORDS;
extern const IID IID_IOleControlSite;
...
extern const IID IID_IPropertyPage;
...
extern const IID IID_IPropertyPage2;
...
typedef
enum tagPROPPAGESTATUS { PROPPAGESTATUS_DIRTY = 0x1,
PROPPAGESTATUS_VALIDATE = 0x2,
PROPPAGESTATUS_CLEAN = 0x4
} PROPPAGESTATUS;
extern const IID IID_IPropertyPageSite;
...
extern const IID IID_IPropertyNotifySink;
...
extern const IID IID_ISpecifyPropertyPages;
...
extern const IID IID_IPersistMemory;
...
#endif
HRESULT STDMETHODCALLTYPE IPersistMemory_RemoteLoad_Proxy(IPersistMemory *This, BYTE *pMem, ULONG cbSize);
...
HRESULT STDMETHODCALLTYPE IPersistMemory_RemoteSave_Proxy(IPersistMemory *This, BYTE *pMem, BOOL fClearDirty, ULONG cbSize);
...
extern const IID IID_IPersistPropertyBag;
...
extern const IID IID_ISimpleFrameSite;
...
typedef
enum tagPictureAttributes { PICTURE_SCALABLE = 0x1,
...
extern const IID IID_IPicture2;
typedef struct IPicture2Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (IPicture2 *This, REFIID riid, void **ppvObject);
	...
	HRESULT(STDMETHODCALLTYPE *get_Width) (IPicture2 *This, OLE_XSIZE_HIMETRIC *pWidth);
	HRESULT(STDMETHODCALLTYPE *get_Height) (IPicture2 *This, OLE_YSIZE_HIMETRIC *pHeight);
	HRESULT(STDMETHODCALLTYPE *Render) (IPicture2 *This, HDC hDC, LONG x, LONG y, LONG cx, LONG cy, OLE_XPOS_HIMETRIC xSrc, OLE_YPOS_HIMETRIC ySrc, OLE_XSIZE_HIMETRIC cxSrc, OLE_YSIZE_HIMETRIC cySrc, LPCRECT pRcWBounds);
	...
	HRESULT(STDMETHODCALLTYPE *SelectPicture) (IPicture2 *This, HDC hDCIn, HDC *phDCOut, HHANDLE *phBmpOut);
	HRESULT(STDMETHODCALLTYPE *get_KeepOriginalFormat) (IPicture2 *This, BOOL *pKeep);
	HRESULT(STDMETHODCALLTYPE *put_KeepOriginalFormat) (IPicture2 *This, BOOL keep);
	HRESULT(STDMETHODCALLTYPE *PictureChanged) (IPicture2 *This);
	HRESULT(STDMETHODCALLTYPE *SaveAsFile) (IPicture2 *This, LPSTREAM pStream, BOOL fSaveMemCopy, LONG *pCbSize);
...
extern const IID IID_IFontEventsDisp;
...
extern const IID IID_IFontDisp;
...
extern const IID IID_IPictureDisp;
...
extern const IID IID_IOleInPlaceObjectWindowless;
...
extern const IID IID_IOleInPlaceSiteEx;
...
extern const IID IID_IViewObjectEx;
...
extern const IID IID_IOleUndoUnit;
...
extern const IID IID_IOleParentUndoUnit;
...
extern const IID IID_IEnumOleUndoUnits;
...
#endif
HRESULT STDMETHODCALLTYPE IEnumOleUndoUnits_RemoteNext_Proxy(IEnumOleUndoUnits *This, ULONG cElt, IOleUndoUnit **rgElt, ULONG *pcEltFetched);
...
extern const IID IID_IOleUndoManager;
...
extern const IID IID_IPointerInactive;
...
extern const IID IID_IPerPropertyBrowsing;
...
extern const IID IID_IPropertyBag2;
...
extern const IID IID_IPersistPropertyBag2;
...
extern const IID IID_IAdviseSinkEx;
...
#endif
HRESULT STDMETHODCALLTYPE IAdviseSinkEx_RemoteOnViewStatusChange_Proxy(IAdviseSinkEx *This, DWORD dwViewStatus);
...
typedef DECLSPEC_UUID("66504301-BE0F-101A-8BBB-00AA00300CAB")
DWORD OLE_COLOR;
...
extern const IID IID_IQuickActivate;
...
#endif
HRESULT STDMETHODCALLTYPE IQuickActivate_RemoteQuickActivate_Proxy(IQuickActivate *This, QACONTAINER *pQaContainer, QACONTROL *pQaControl);
...
HRESULT STDMETHODCALLTYPE IEnumConnections_Next_Proxy(IEnumConnections *This, ULONG cConnections, LPCONNECTDATA rgcd, ULONG *pcFetched);
HRESULT STDMETHODCALLTYPE IEnumConnections_Next_Stub(IEnumConnections *This, ULONG cConnections, LPCONNECTDATA rgcd, ULONG *pcFetched);
HRESULT STDMETHODCALLTYPE IEnumConnectionPoints_Next_Proxy(IEnumConnectionPoints *This, ULONG cConnections, LPCONNECTIONPOINT *ppCP, ULONG *pcFetched);
HRESULT STDMETHODCALLTYPE IEnumConnectionPoints_Next_Stub(IEnumConnectionPoints *This, ULONG cConnections, LPCONNECTIONPOINT *ppCP, ULONG *pcFetched);
HRESULT STDMETHODCALLTYPE IClassFactory2_CreateInstanceLic_Proxy(IClassFactory2 *This, IUnknown *pUnkOuter, IUnknown *pUnkReserved, REFIID riid, BSTR bstrKey, PVOID *ppvObj);
HRESULT STDMETHODCALLTYPE IClassFactory2_CreateInstanceLic_Stub(IClassFactory2 *This, REFIID riid, BSTR bstrKey, IUnknown **ppvObj);
HRESULT STDMETHODCALLTYPE IPersistMemory_Load_Proxy(IPersistMemory *This, LPVOID pMem, ULONG cbSize);
HRESULT STDMETHODCALLTYPE IPersistMemory_Load_Stub(IPersistMemory *This, BYTE *pMem, ULONG cbSize);
HRESULT STDMETHODCALLTYPE IPersistMemory_Save_Proxy(IPersistMemory *This, LPVOID pMem, BOOL fClearDirty, ULONG cbSize);
HRESULT STDMETHODCALLTYPE IPersistMemory_Save_Stub(IPersistMemory *This, BYTE *pMem, BOOL fClearDirty, ULONG cbSize);
HRESULT STDMETHODCALLTYPE IEnumOleUndoUnits_Next_Proxy(IEnumOleUndoUnits *This, ULONG cElt, IOleUndoUnit **rgElt, ULONG *pcEltFetched);
HRESULT STDMETHODCALLTYPE IEnumOleUndoUnits_Next_Stub(IEnumOleUndoUnits *This, ULONG cElt, IOleUndoUnit **rgElt, ULONG *pcEltFetched);
void STDMETHODCALLTYPE IAdviseSinkEx_OnViewStatusChange_Proxy(IAdviseSinkEx *This, DWORD dwViewStatus);
HRESULT STDMETHODCALLTYPE IAdviseSinkEx_OnViewStatusChange_Stub(IAdviseSinkEx *This, DWORD dwViewStatus);
HRESULT STDMETHODCALLTYPE IQuickActivate_QuickActivate_Proxy(IQuickActivate *This, QACONTAINER *pQaContainer, QACONTROL *pQaControl);
HRESULT STDMETHODCALLTYPE IQuickActivate_QuickActivate_Stub(IQuickActivate *This, QACONTAINER *pQaContainer, QACONTROL *pQaControl);
#endif
