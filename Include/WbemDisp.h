/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 10 21:34:32 2016
 \date		Modified on Sun Jul 10 21:34:32 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
extern const IID LIBID_WbemScripting;
#ifndef __ISWbemServices_INTERFACE_DEFINED__
#define __ISWbemServices_INTERFACE_DEFINED__
extern const IID IID_ISWbemServices;
typedef struct ISWbemServicesVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemServices *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemLocator;
typedef struct ISWbemLocatorVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemLocator *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemObject;
typedef struct ISWbemObjectVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemObject *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemObjectSet;
typedef struct ISWbemObjectSetVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemObjectSet *This, REFIID riid, void **ppvObject);
	...
	HRESULT(STDMETHODCALLTYPE *ItemIndex) (ISWbemObjectSet *This, long lIndex, ISWbemObject **objWbemObject);
	END_INTERFACE
}  ISWbemObjectSetVtbl;
...
extern const IID IID_ISWbemNamedValue;
typedef struct ISWbemNamedValueVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemNamedValue *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemNamedValueSet;
typedef struct ISWbemNamedValueSetVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemNamedValueSet *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemQualifier;
typedef struct ISWbemQualifierVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemQualifier *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemQualifierSet;
typedef struct ISWbemQualifierSetVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemQualifierSet *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemProperty;
typedef struct ISWbemPropertyVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemProperty *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemPropertySet;
typedef struct ISWbemPropertySetVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemPropertySet *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemMethod;
typedef struct ISWbemMethodVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemMethod *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemMethodSet;
typedef struct ISWbemMethodSetVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemMethodSet *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemEventSource;
typedef struct ISWbemEventSourceVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemEventSource *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemObjectPath;
typedef struct ISWbemObjectPathVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemObjectPath *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemLastError;
typedef struct ISWbemLastErrorVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemLastError *This, REFIID riid, void **ppvObject);
...
extern const IID DIID_ISWbemSinkEvents;
typedef struct ISWbemSinkEventsVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemSinkEvents *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemSink;
typedef struct ISWbemSinkVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemSink *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemSecurity;
typedef struct ISWbemSecurityVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemSecurity *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemPrivilege;
typedef struct ISWbemPrivilegeVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemPrivilege *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemPrivilegeSet;
typedef struct ISWbemPrivilegeSetVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemPrivilegeSet *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemServicesEx;
typedef struct ISWbemServicesExVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemServicesEx *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemObjectEx;
typedef struct ISWbemObjectExVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemObjectEx *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemDateTime;
typedef struct ISWbemDateTimeVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemDateTime *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemRefresher;
typedef struct ISWbemRefresherVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemRefresher *This, REFIID riid, void **ppvObject);
...
extern const IID IID_ISWbemRefreshableItem;
typedef struct ISWbemRefreshableItemVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (ISWbemRefreshableItem *This, REFIID riid, void **ppvObject);
...
#endif
#endif
extern const CLSID CLSID_SWbemLocator;
extern const CLSID CLSID_SWbemNamedValueSet;
extern const CLSID CLSID_SWbemObjectPath;
extern const CLSID CLSID_SWbemLastError;
extern const CLSID CLSID_SWbemSink;
extern const CLSID CLSID_SWbemDateTime;
extern const CLSID CLSID_SWbemRefresher;
extern const CLSID CLSID_SWbemServices;
extern const CLSID CLSID_SWbemServicesEx;
extern const CLSID CLSID_SWbemObject;
extern const CLSID CLSID_SWbemObjectEx;
extern const CLSID CLSID_SWbemObjectSet;
extern const CLSID CLSID_SWbemNamedValue;
extern const CLSID CLSID_SWbemQualifier;
extern const CLSID CLSID_SWbemQualifierSet;
extern const CLSID CLSID_SWbemProperty;
extern const CLSID CLSID_SWbemPropertySet;
extern const CLSID CLSID_SWbemMethod;
extern const CLSID CLSID_SWbemMethodSet;
extern const CLSID CLSID_SWbemEventSource;
extern const CLSID CLSID_SWbemSecurity;
extern const CLSID CLSID_SWbemPrivilege;
extern const CLSID CLSID_SWbemPrivilegeSet;
extern const CLSID CLSID_SWbemRefreshableItem;
#endif
