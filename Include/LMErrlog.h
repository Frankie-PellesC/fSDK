/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 17 23:24:44 2016
 \date		Modified on Sun Jul 17 23:24:44 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
#endif
NET_API_STATUS NET_API_FUNCTION NetErrorLogClear(LPCWSTR UncServerName, LPCWSTR BackupFile, LPBYTE Reserved);
NET_API_STATUS NET_API_FUNCTION NetErrorLogRead(LPCWSTR UncServerName, LPWSTR Reserved1, LPHLOG ErrorLogHandle, DWORD Offset, LPDWORD Reserved2, DWORD Reserved3, DWORD OffsetFlag, LPBYTE *BufPtr, DWORD PrefMaxSize, LPDWORD BytesRead, LPDWORD TotalAvailable);
NET_API_STATUS NET_API_FUNCTION NetErrorLogWrite(LPBYTE Reserved1, DWORD Code, LPCWSTR Component, LPBYTE Buffer, DWORD NumBytes, LPBYTE MsgBuf, DWORD StrCount, LPBYTE Reserved2);
