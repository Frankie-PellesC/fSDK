/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Tue Jul  5 17:48:06 2016
 \date		Modified on Tue Jul  5 17:48:06 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/

#ifndef __ddrawgdi_h__
#define __ddrawgdi_h__
#if __POCC__ >= 500
#pragma once
#endif
...
#endif
#endif
BOOL APIENTRY DdCreateDirectDrawObject(LPDDRAWI_DIRECTDRAW_GBL pDirectDrawGlobal, HDC hdc);
...
BOOL APIENTRY DdResetVisrgn(LPDDRAWI_DDRAWSURFACE_LCL pSurfaceLocal, HWND hWnd);
...
BOOL APIENTRY DdAttachSurface(LPDDRAWI_DDRAWSURFACE_LCL pSurfaceFrom, LPDDRAWI_DDRAWSURFACE_LCL pSurfaceTo);
...
#ifdef DX_LONGHORN_PRESERVEDC
DWORD APIENTRY DdChangeSurfacePointer(LPDDRAWI_DDRAWSURFACE_LCL pSurfaceLocal, LPDDRAWI_DIRECTDRAW_GBL pDirectDrawGlobal, LPVOID pSurfacePointer);
#endif
#endif
