...
END_INTERFACE} IMMNotificationClientVtbl;
...
typedef struct IMMDeviceVtbl {
	BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE * QueryInterface) (IMMDevice * This,
		REFIID riid,
		void **ppvObject);
...
extern const IID IID_IMMDeviceCollection;
...
END_INTERFACE} IMMDeviceCollectionVtbl;
...
typedef struct IMMEndpointVtbl {
	BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE * QueryInterface) (IMMEndpoint * This, REFIID riid, void **ppvObject);
...
typedef struct IMMDeviceEnumeratorVtbl {
	BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE * QueryInterface) (IMMDeviceEnumerator * This, REFIID riid, void **ppvObject);
...
END_INTERFACE} IMMDeviceEnumeratorVtbl;
...
extern const IID IID_IMMDeviceActivator;
typedef struct IMMDeviceActivatorVtbl {
BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE * QueryInterface) (IMMDeviceActivator * This, REFIID riid, void **ppvObject);
...
END_INTERFACE} IMMDeviceActivatorVtbl;
...
extern const IID IID_IActivateAudioInterfaceCompletionHandler;
typedef struct IActivateAudioInterfaceCompletionHandlerVtbl {
	BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE * QueryInterface) (IActivateAudioInterfaceCompletionHandler * This, REFIID riid, void **ppvObject);
...
END_INTERFACE} IActivateAudioInterfaceCompletionHandlerVtbl;
...
extern const IID IID_IActivateAudioInterfaceAsyncOperation;
typedef struct IActivateAudioInterfaceAsyncOperationVtbl {
	BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE * QueryInterface) (IActivateAudioInterfaceAsyncOperation * This, REFIID riid, void **ppvObject);
...
END_INTERFACE} IActivateAudioInterfaceAsyncOperationVtbl;
