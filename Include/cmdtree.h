/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul  3 17:54:10 2016
 \date		Modified on Sun Jul  3 17:54:10 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
extern const IID IID_ICommandTree;
typedef struct ICommandTreeVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ICommandTree * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ICommandTree * This);
	ULONG(STDMETHODCALLTYPE * Release) (ICommandTree * This);
	HRESULT(STDMETHODCALLTYPE * FindErrorNodes) (ICommandTree * This, const DBCOMMANDTREE * pRoot, ULONG * pcErrorNodes, DBCOMMANDTREE *** prgErrorNodes);
	HRESULT(STDMETHODCALLTYPE * FreeCommandTree) (ICommandTree * This, DBCOMMANDTREE ** ppRoot);
	HRESULT(STDMETHODCALLTYPE * GetCommandTree) (ICommandTree * This, DBCOMMANDTREE ** ppRoot);
	HRESULT(STDMETHODCALLTYPE * SetCommandTree) (ICommandTree * This, DBCOMMANDTREE ** ppRoot, DBCOMMANDREUSE dwCommandReuse, BOOL fCopy);
	END_INTERFACE
}  ICommandTreeVtbl;
...
extern const IID IID_IQuery;
typedef struct IQueryVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (IQuery * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (IQuery * This);
	ULONG(STDMETHODCALLTYPE * Release) (IQuery * This);
	HRESULT(STDMETHODCALLTYPE * FindErrorNodes) (IQuery * This, const DBCOMMANDTREE * pRoot, ULONG * pcErrorNodes, DBCOMMANDTREE *** prgErrorNodes);
	HRESULT(STDMETHODCALLTYPE * FreeCommandTree) (IQuery * This, DBCOMMANDTREE ** ppRoot);
	HRESULT(STDMETHODCALLTYPE * GetCommandTree) (IQuery * This, DBCOMMANDTREE ** ppRoot);
	HRESULT(STDMETHODCALLTYPE * SetCommandTree) (IQuery * This, DBCOMMANDTREE ** ppRoot, DBCOMMANDREUSE dwCommandReuse, BOOL fCopy);
	HRESULT(STDMETHODCALLTYPE * AddPostProcessing) (IQuery * This, DBCOMMANDTREE ** ppRoot, BOOL fCopy);
	HRESULT(STDMETHODCALLTYPE * GetCardinalityEstimate) (IQuery * This, DBORDINAL * pulCardinality);
	END_INTERFACE
}  IQueryVtbl;
interface IQuery
{
