/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Fri Nov 25 17:22:15 2016
 \date		Modified on Fri Nov 25 17:22:15 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
STDMETHOD(GetName) (THIS_ LPSTR, LPDWORD); \
...
DECLARE_INTERFACE_(IDirectXFile, IUnknown)
{
	...
	STDMETHOD(RegisterTemplates) (THIS_ LPVOID, DWORD);
};
#undef INTERFACE
...
{
	IUNKNOWN_METHODS(PURE);
	STDMETHOD(GetNextDataObject) (THIS_ LPDIRECTXFILEDATA *);
	STDMETHOD(GetDataObjectById) (THIS_ REFGUID, LPDIRECTXFILEDATA *);
	STDMETHOD(GetDataObjectByName) (THIS_ LPCSTR, LPDIRECTXFILEDATA *);
};
#undef INTERFACE
...
{
	IUNKNOWN_METHODS(PURE);
	STDMETHOD(SaveTemplates) (THIS_ DWORD, const GUID **);
	STDMETHOD(CreateDataObject) (THIS_ REFGUID, LPCSTR, const GUID *, DWORD, LPVOID, LPDIRECTXFILEDATA *);
	STDMETHOD(SaveData) (THIS_ LPDIRECTXFILEDATA);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirectXFileData, IDirectXFileObject)
{
	IUNKNOWN_METHODS(PURE);
	IDIRECTXFILEOBJECT_METHODS(PURE);
	STDMETHOD(GetData) (THIS_ LPCSTR, DWORD *, void **);
	STDMETHOD(GetType) (THIS_ const GUID **);
	STDMETHOD(GetNextObject) (THIS_ LPDIRECTXFILEOBJECT *);
	STDMETHOD(AddDataObject) (THIS_ LPDIRECTXFILEDATA);
...
DECLARE_INTERFACE_(IDirectXFileDataReference, IDirectXFileObject)
{
	IUNKNOWN_METHODS(PURE);
	IDIRECTXFILEOBJECT_METHODS(PURE);
	STDMETHOD(Resolve) (THIS_ LPDIRECTXFILEDATA *);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirectXFileBinary, IDirectXFileObject)
{
	IUNKNOWN_METHODS(PURE);
	IDIRECTXFILEOBJECT_METHODS(PURE);
	STDMETHOD(GetSize) (THIS_ DWORD *);
	STDMETHOD(GetMimeType) (THIS_ LPCSTR *);
