/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sat Jul  2 14:58:48 2016
 \date		Modified on Sat Jul  2 14:58:48 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
extern const IID LIBID_JRO;
#ifndef __IReplica_INTERFACE_DEFINED__
#define __IReplica_INTERFACE_DEFINED__
extern const IID IID_IReplica;
typedef struct IReplicaVtbl {
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (IReplica *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Filter;
typedef struct FilterVtbl {
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Filter *This, REFIID riid, void **ppvObject);
...
extern const IID IID_Filters;
typedef struct FiltersVtbl {
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (Filters *This, REFIID riid, void **ppvObject);
...
extern const IID IID_IJetEngine;
typedef struct IJetEngineVtbl {
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE *QueryInterface) (IJetEngine *This, REFIID riid, void **ppvObject);
...
#endif
#endif
extern const CLSID CLSID_Replica;
extern const CLSID CLSID_JetEngine;
#endif
#endif
