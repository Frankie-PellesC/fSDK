/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Sep  4 17:43:21 2016
 \date		Modified on Sun Sep  4 17:43:21 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef int WS_XML_BUFFER_PROPERTY_ID;
typedef enum
{
...
typedef int WS_SECURITY_ALGORITHM_PROPERTY_ID;
typedef enum
{
...
HRESULT WINAPI WsStartReaderCanonicalization(WS_XML_READER *reader, WS_WRITE_CALLBACK writeCallback, void *writeCallbackState, const WS_XML_CANONICALIZATION_PROPERTY *properties, ULONG propertyCount, WS_ERROR *error);
HRESULT WINAPI WsEndReaderCanonicalization(WS_XML_READER *reader, WS_ERROR *error);
HRESULT WINAPI WsStartWriterCanonicalization(WS_XML_WRITER *writer, WS_WRITE_CALLBACK writeCallback, void *writeCallbackState, const WS_XML_CANONICALIZATION_PROPERTY *properties, ULONG propertyCount, WS_ERROR *error);
HRESULT WINAPI WsEndWriterCanonicalization(WS_XML_WRITER *writer, WS_ERROR *error);
HRESULT WINAPI WsCreateXmlBuffer(WS_HEAP *heap, const WS_XML_BUFFER_PROPERTY *properties, ULONG propertyCount, WS_XML_BUFFER **buffer, WS_ERROR *error);
HRESULT WINAPI WsRemoveNode(const WS_XML_NODE_POSITION *nodePosition, WS_ERROR *error);
HRESULT WINAPI WsCreateReader(const WS_XML_READER_PROPERTY *properties, ULONG propertyCount, WS_XML_READER **reader, WS_ERROR *error);
HRESULT WINAPI WsSetInput(WS_XML_READER *reader, const WS_XML_READER_ENCODING *encoding, const WS_XML_READER_INPUT *input, const WS_XML_READER_PROPERTY *properties, ULONG propertyCount, WS_ERROR *error);
HRESULT WINAPI WsSetInputToBuffer(WS_XML_READER *reader, WS_XML_BUFFER *buffer, const WS_XML_READER_PROPERTY *properties, ULONG propertyCount, WS_ERROR *error);
void WINAPI WsFreeReader(WS_XML_READER *reader);
HRESULT WINAPI WsGetReaderProperty(WS_XML_READER *reader, WS_XML_READER_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsGetReaderNode(WS_XML_READER *xmlReader, const WS_XML_NODE **node, WS_ERROR *error);
HRESULT WINAPI WsFillReader(WS_XML_READER *reader, ULONG minSize, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsReadStartElement(WS_XML_READER *reader, WS_ERROR *error);
HRESULT WINAPI WsReadToStartElement(WS_XML_READER *reader, const WS_XML_STRING *localName, const WS_XML_STRING *ns, BOOL *found, WS_ERROR *error);
HRESULT WINAPI WsReadStartAttribute(WS_XML_READER *reader, ULONG attributeIndex, WS_ERROR *error);
HRESULT WINAPI WsReadEndAttribute(WS_XML_READER *reader, WS_ERROR *error);
HRESULT WINAPI WsReadNode(WS_XML_READER *reader, WS_ERROR *error);
HRESULT WINAPI WsSkipNode(WS_XML_READER *reader, WS_ERROR *error);
HRESULT WINAPI WsReadEndElement(WS_XML_READER *reader, WS_ERROR *error);
HRESULT WINAPI WsFindAttribute(WS_XML_READER *reader, const WS_XML_STRING *localName, const WS_XML_STRING *ns, BOOL required, ULONG *attributeIndex, WS_ERROR *error);
HRESULT WINAPI WsReadValue(WS_XML_READER *reader, WS_VALUE_TYPE valueType, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsReadChars(WS_XML_READER *reader, WCHAR *chars, ULONG maxCharCount, ULONG *actualCharCount, WS_ERROR *error);
HRESULT WINAPI WsReadCharsUtf8(WS_XML_READER *reader, BYTE *bytes, ULONG maxByteCount, ULONG *actualByteCount, WS_ERROR *error);
HRESULT WINAPI WsReadBytes(WS_XML_READER *reader, void *bytes, ULONG maxByteCount, ULONG *actualByteCount, WS_ERROR *error);
HRESULT WINAPI WsReadArray(WS_XML_READER *reader, const WS_XML_STRING *localName, const WS_XML_STRING *ns, WS_VALUE_TYPE valueType, void *array, ULONG arraySize, ULONG itemOffset, ULONG itemCount, ULONG *actualItemCount, WS_ERROR *error);
HRESULT WINAPI WsGetReaderPosition(WS_XML_READER *reader, WS_XML_NODE_POSITION *nodePosition, WS_ERROR *error);
HRESULT WINAPI WsSetReaderPosition(WS_XML_READER *reader, const WS_XML_NODE_POSITION *nodePosition, WS_ERROR *error);
HRESULT WINAPI WsMoveReader(WS_XML_READER *reader, WS_MOVE_TO moveTo, BOOL *found, WS_ERROR *error);
HRESULT WINAPI WsCreateWriter(const WS_XML_WRITER_PROPERTY *properties, ULONG propertyCount, WS_XML_WRITER **writer, WS_ERROR *error);
void WINAPI WsFreeWriter(WS_XML_WRITER *writer);
HRESULT WINAPI WsSetOutput(WS_XML_WRITER *writer, const WS_XML_WRITER_ENCODING *encoding, const WS_XML_WRITER_OUTPUT *output, const WS_XML_WRITER_PROPERTY *properties, ULONG propertyCount, WS_ERROR *error);
HRESULT WINAPI WsSetOutputToBuffer(WS_XML_WRITER *writer, WS_XML_BUFFER *buffer, const WS_XML_WRITER_PROPERTY *properties, ULONG propertyCount, WS_ERROR *error);
HRESULT WINAPI WsGetWriterProperty(WS_XML_WRITER *writer, WS_XML_WRITER_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsFlushWriter(WS_XML_WRITER *writer, ULONG minSize, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsWriteStartElement(WS_XML_WRITER *writer, const WS_XML_STRING *prefix, const WS_XML_STRING *localName, const WS_XML_STRING *ns, WS_ERROR *error);
HRESULT WINAPI WsWriteEndStartElement(WS_XML_WRITER *writer, WS_ERROR *error);
HRESULT WINAPI WsWriteXmlnsAttribute(WS_XML_WRITER *writer, const WS_XML_STRING *prefix, const WS_XML_STRING *ns, BOOL singleQuote, WS_ERROR *error);
HRESULT WINAPI WsWriteStartAttribute(WS_XML_WRITER *writer, const WS_XML_STRING *prefix, const WS_XML_STRING *localName, const WS_XML_STRING *ns, BOOL singleQuote, WS_ERROR *error);
HRESULT WINAPI WsWriteEndAttribute(WS_XML_WRITER *writer, WS_ERROR *error);
HRESULT WINAPI WsWriteValue(WS_XML_WRITER *writer, WS_VALUE_TYPE valueType, const void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsWriteXmlBuffer(WS_XML_WRITER *writer, WS_XML_BUFFER *xmlBuffer, WS_ERROR *error);
HRESULT WINAPI WsReadXmlBuffer(WS_XML_READER *reader, WS_HEAP *heap, WS_XML_BUFFER **xmlBuffer, WS_ERROR *error);
HRESULT WINAPI WsWriteXmlBufferToBytes(WS_XML_WRITER *writer, WS_XML_BUFFER *xmlBuffer, const WS_XML_WRITER_ENCODING *encoding, const WS_XML_WRITER_PROPERTY *properties, ULONG propertyCount, WS_HEAP *heap, void **bytes, ULONG *byteCount, WS_ERROR *error);
HRESULT WINAPI WsReadXmlBufferFromBytes(WS_XML_READER *reader, const WS_XML_READER_ENCODING *encoding, const WS_XML_READER_PROPERTY *properties, ULONG propertyCount, const void *bytes, ULONG byteCount, WS_HEAP *heap, WS_XML_BUFFER **xmlBuffer, WS_ERROR *error);
HRESULT WINAPI WsWriteArray(WS_XML_WRITER *writer, const WS_XML_STRING *localName, const WS_XML_STRING *ns, WS_VALUE_TYPE valueType, const void *array, ULONG arraySize, ULONG itemOffset, ULONG itemCount, WS_ERROR *error);
HRESULT WINAPI WsWriteQualifiedName(WS_XML_WRITER *writer, const WS_XML_STRING *prefix, const WS_XML_STRING *localName, const WS_XML_STRING *ns, WS_ERROR *error);
HRESULT WINAPI WsWriteChars(WS_XML_WRITER *writer, const WCHAR *chars, ULONG charCount, WS_ERROR *error);
HRESULT WINAPI WsWriteCharsUtf8(WS_XML_WRITER *writer, const BYTE *bytes, ULONG byteCount, WS_ERROR *error);
HRESULT WINAPI WsWriteBytes(WS_XML_WRITER *writer, const void *bytes, ULONG byteCount, WS_ERROR *error);
HRESULT WINAPI WsPushBytes(WS_XML_WRITER *writer, WS_PUSH_BYTES_CALLBACK callback, void *callbackState, WS_ERROR *error);
HRESULT WINAPI WsPullBytes(WS_XML_WRITER *writer, WS_PULL_BYTES_CALLBACK callback, void *callbackState, WS_ERROR *error);
HRESULT WINAPI WsWriteEndElement(WS_XML_WRITER *writer, WS_ERROR *error);
HRESULT WINAPI WsWriteText(WS_XML_WRITER *writer, const WS_XML_TEXT *text, WS_ERROR *error);
HRESULT WINAPI WsWriteStartCData(WS_XML_WRITER *writer, WS_ERROR *error);
HRESULT WINAPI WsWriteEndCData(WS_XML_WRITER *writer, WS_ERROR *error);
HRESULT WINAPI WsWriteNode(WS_XML_WRITER *writer, const WS_XML_NODE *node, WS_ERROR *error);
HRESULT WINAPI WsGetPrefixFromNamespace(WS_XML_WRITER *writer, const WS_XML_STRING *ns, BOOL required, const WS_XML_STRING **prefix, WS_ERROR *error);
HRESULT WINAPI WsGetWriterPosition(WS_XML_WRITER *writer, WS_XML_NODE_POSITION *nodePosition, WS_ERROR *error);
HRESULT WINAPI WsSetWriterPosition(WS_XML_WRITER *writer, const WS_XML_NODE_POSITION *nodePosition, WS_ERROR *error);
HRESULT WINAPI WsMoveWriter(WS_XML_WRITER *writer, WS_MOVE_TO moveTo, BOOL *found, WS_ERROR *error);
HRESULT WINAPI WsTrimXmlWhitespace(WCHAR *chars, ULONG charCount, WCHAR **trimmedChars, ULONG *trimmedCount, WS_ERROR *error);
HRESULT WINAPI WsVerifyXmlNCName(const WCHAR *ncNameChars, ULONG ncNameCharCount, WS_ERROR *error);
HRESULT WINAPI WsXmlStringEquals(const WS_XML_STRING *string1, const WS_XML_STRING *string2, WS_ERROR *error);
HRESULT WINAPI WsGetNamespaceFromPrefix(WS_XML_READER *reader, const WS_XML_STRING *prefix, BOOL required, const WS_XML_STRING **ns, WS_ERROR *error);
HRESULT WINAPI WsReadQualifiedName(WS_XML_READER *reader, WS_HEAP *heap, WS_XML_STRING *prefix, WS_XML_STRING *localName, WS_XML_STRING *ns, WS_ERROR *error);
HRESULT WINAPI WsGetXmlAttribute(WS_XML_READER *reader, const WS_XML_STRING *localName, WS_HEAP *heap, WCHAR **valueChars, ULONG *valueCharCount, WS_ERROR *error);
HRESULT WINAPI WsCopyNode(WS_XML_WRITER *writer, WS_XML_READER *reader, WS_ERROR *error);
HRESULT WINAPI WsAsyncExecute(WS_ASYNC_STATE *asyncState, WS_ASYNC_FUNCTION operation, WS_CALLBACK_MODEL callbackModel, void *callbackState, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsCreateChannel(WS_CHANNEL_TYPE channelType, WS_CHANNEL_BINDING channelBinding, const WS_CHANNEL_PROPERTY *properties, ULONG propertyCount, const WS_SECURITY_DESCRIPTION *securityDescription, WS_CHANNEL **channel, WS_ERROR *error);
HRESULT WINAPI WsOpenChannel(WS_CHANNEL *channel, const WS_ENDPOINT_ADDRESS *endpointAddress, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsSendMessage(WS_CHANNEL *channel, WS_MESSAGE *message, const WS_MESSAGE_DESCRIPTION *messageDescription, WS_WRITE_OPTION writeOption, const void *bodyValue, ULONG bodyValueSize, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsReceiveMessage(WS_CHANNEL *channel, WS_MESSAGE *message, const WS_MESSAGE_DESCRIPTION **messageDescriptions, ULONG messageDescriptionCount, WS_RECEIVE_OPTION receiveOption, WS_READ_OPTION readBodyOption, WS_HEAP *heap, void *value, ULONG valueSize, ULONG *index, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsRequestReply(WS_CHANNEL *channel, WS_MESSAGE *requestMessage, const WS_MESSAGE_DESCRIPTION *requestMessageDescription, WS_WRITE_OPTION writeOption, const void *requestBodyValue, ULONG requestBodyValueSize, WS_MESSAGE *replyMessage, const WS_MESSAGE_DESCRIPTION *replyMessageDescription, WS_READ_OPTION readOption, WS_HEAP *heap, void *value, ULONG valueSize, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsSendReplyMessage(WS_CHANNEL *channel, WS_MESSAGE *replyMessage, const WS_MESSAGE_DESCRIPTION *replyMessageDescription, WS_WRITE_OPTION writeOption, const void *replyBodyValue, ULONG replyBodyValueSize, WS_MESSAGE *requestMessage, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsSendFaultMessageForError(WS_CHANNEL *channel, WS_MESSAGE *replyMessage, WS_ERROR *faultError, HRESULT faultErrorCode, WS_FAULT_DISCLOSURE faultDisclosure, WS_MESSAGE *requestMessage, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsGetChannelProperty(WS_CHANNEL *channel, WS_CHANNEL_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsSetChannelProperty(WS_CHANNEL *channel, WS_CHANNEL_PROPERTY_ID id, const void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsWriteMessageStart(WS_CHANNEL *channel, WS_MESSAGE *message, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsWriteMessageEnd(WS_CHANNEL *channel, WS_MESSAGE *message, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsReadMessageStart(WS_CHANNEL *channel, WS_MESSAGE *message, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsReadMessageEnd(WS_CHANNEL *channel, WS_MESSAGE *message, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsCloseChannel(WS_CHANNEL *channel, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsAbortChannel(WS_CHANNEL *channel, WS_ERROR *error);
void WINAPI WsFreeChannel(WS_CHANNEL *channel);
HRESULT WINAPI WsResetChannel(WS_CHANNEL *channel, WS_ERROR *error);
HRESULT WINAPI WsAbandonMessage(WS_CHANNEL *channel, WS_MESSAGE *message, WS_ERROR *error);
HRESULT WINAPI WsShutdownSessionChannel(WS_CHANNEL *channel, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsGetOperationContextProperty(const WS_OPERATION_CONTEXT *context, const WS_OPERATION_CONTEXT_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsGetDictionary(WS_ENCODING encoding, WS_XML_DICTIONARY **dictionary, WS_ERROR *error);
HRESULT WINAPI WsReadEndpointAddressExtension(WS_XML_READER *reader, WS_ENDPOINT_ADDRESS *endpointAddress, WS_ENDPOINT_ADDRESS_EXTENSION_TYPE extensionType, WS_READ_OPTION readOption, WS_HEAP *heap, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsCreateError(const WS_ERROR_PROPERTY *properties, ULONG propertyCount, WS_ERROR **error);
HRESULT WINAPI WsAddErrorString(WS_ERROR *error, const WS_STRING *string);
HRESULT WINAPI WsGetErrorString(WS_ERROR *error, ULONG index, WS_STRING *string);
HRESULT WINAPI WsCopyError(WS_ERROR *source, WS_ERROR *destination);
HRESULT WINAPI WsGetErrorProperty(WS_ERROR *error, WS_ERROR_PROPERTY_ID id, void *buffer, ULONG bufferSize);
HRESULT WINAPI WsSetErrorProperty(WS_ERROR *error, WS_ERROR_PROPERTY_ID id, const void *value, ULONG valueSize);
HRESULT WINAPI WsResetError(WS_ERROR *error);
void WINAPI WsFreeError(WS_ERROR *error);
HRESULT WINAPI WsGetFaultErrorProperty(WS_ERROR *error, WS_FAULT_ERROR_PROPERTY_ID id, void *buffer, ULONG bufferSize);
HRESULT WINAPI WsSetFaultErrorProperty(WS_ERROR *error, WS_FAULT_ERROR_PROPERTY_ID id, const void *value, ULONG valueSize);
HRESULT WINAPI WsCreateFaultFromError(WS_ERROR *error, HRESULT faultErrorCode, WS_FAULT_DISCLOSURE faultDisclosure, WS_HEAP *heap, WS_FAULT *fault);
HRESULT WINAPI WsSetFaultErrorDetail(WS_ERROR *error, const WS_FAULT_DETAIL_DESCRIPTION *faultDetailDescription, WS_WRITE_OPTION writeOption, const void *value, ULONG valueSize);
HRESULT WINAPI WsGetFaultErrorDetail(WS_ERROR *error, const WS_FAULT_DETAIL_DESCRIPTION *faultDetailDescription, WS_READ_OPTION readOption, WS_HEAP *heap, void *value, ULONG valueSize);
HRESULT WINAPI WsCreateHeap(SIZE_T maxSize, SIZE_T trimSize, const WS_HEAP_PROPERTY *properties, ULONG propertyCount, WS_HEAP **heap, WS_ERROR *error);
HRESULT WINAPI WsAlloc(WS_HEAP *heap, SIZE_T size, void **ptr, WS_ERROR *error);
HRESULT WINAPI WsGetHeapProperty(WS_HEAP *heap, WS_HEAP_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsResetHeap(WS_HEAP *heap, WS_ERROR *error);
void WINAPI WsFreeHeap(WS_HEAP *heap);
HRESULT WINAPI WsCreateListener(WS_CHANNEL_TYPE channelType, WS_CHANNEL_BINDING channelBinding, const WS_LISTENER_PROPERTY *properties, ULONG propertyCount, const WS_SECURITY_DESCRIPTION *securityDescription, WS_LISTENER **listener, WS_ERROR *error);
HRESULT WINAPI WsOpenListener(WS_LISTENER *listener, const WS_STRING *url, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsAcceptChannel(WS_LISTENER *listener, WS_CHANNEL *channel, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsCloseListener(WS_LISTENER *listener, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsAbortListener(WS_LISTENER *listener, WS_ERROR *error);
HRESULT WINAPI WsResetListener(WS_LISTENER *listener, WS_ERROR *error);
void WINAPI WsFreeListener(WS_LISTENER *listener);
HRESULT WINAPI WsGetListenerProperty(WS_LISTENER *listener, WS_LISTENER_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsSetListenerProperty(WS_LISTENER *listener, WS_LISTENER_PROPERTY_ID id, const void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsCreateChannelForListener(WS_LISTENER *listener, const WS_CHANNEL_PROPERTY *properties, ULONG propertyCount, WS_CHANNEL **channel, WS_ERROR *error);
HRESULT WINAPI WsCreateMessage(WS_ENVELOPE_VERSION envelopeVersion, WS_ADDRESSING_VERSION addressingVersion, const WS_MESSAGE_PROPERTY *properties, ULONG propertyCount, WS_MESSAGE **message, WS_ERROR *error);
HRESULT WINAPI WsCreateMessageForChannel(WS_CHANNEL *channel, const WS_MESSAGE_PROPERTY *properties, ULONG propertyCount, WS_MESSAGE **message, WS_ERROR *error);
HRESULT WINAPI WsInitializeMessage(WS_MESSAGE *message, WS_MESSAGE_INITIALIZATION initialization, WS_MESSAGE *sourceMessage, WS_ERROR *error);
HRESULT WINAPI WsResetMessage(WS_MESSAGE *message, WS_ERROR *error);
void WINAPI WsFreeMessage(WS_MESSAGE *message);
HRESULT WINAPI WsGetHeaderAttributes(WS_MESSAGE *message, WS_XML_READER *reader, ULONG *headerAttributes, WS_ERROR *error);
HRESULT WINAPI WsGetHeader(WS_MESSAGE *message, WS_HEADER_TYPE headerType, WS_TYPE valueType, WS_READ_OPTION readOption, WS_HEAP *heap, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsGetCustomHeader(WS_MESSAGE *message, const WS_ELEMENT_DESCRIPTION *customHeaderDescription, WS_REPEATING_HEADER_OPTION repeatingOption, ULONG headerIndex, WS_READ_OPTION readOption, WS_HEAP *heap, void *value, ULONG valueSize, ULONG *headerAttributes, WS_ERROR *error);
HRESULT WINAPI WsRemoveHeader(WS_MESSAGE *message, WS_HEADER_TYPE headerType, WS_ERROR *error);
HRESULT WINAPI WsSetHeader(WS_MESSAGE *message, WS_HEADER_TYPE headerType, WS_TYPE valueType, WS_WRITE_OPTION writeOption, const void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsRemoveCustomHeader(WS_MESSAGE *message, const WS_XML_STRING *headerName, const WS_XML_STRING *headerNs, WS_ERROR *error);
HRESULT WINAPI WsAddCustomHeader(WS_MESSAGE *message, const WS_ELEMENT_DESCRIPTION *headerDescription, WS_WRITE_OPTION writeOption, const void *value, ULONG valueSize, ULONG headerAttributes, WS_ERROR *error);
HRESULT WINAPI WsAddMappedHeader(WS_MESSAGE *message, const WS_XML_STRING *headerName, WS_TYPE valueType, WS_WRITE_OPTION writeOption, const void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsRemoveMappedHeader(WS_MESSAGE *message, const WS_XML_STRING *headerName, WS_ERROR *error);
HRESULT WINAPI WsGetMappedHeader(WS_MESSAGE *message, const WS_XML_STRING *headerName, WS_REPEATING_HEADER_OPTION repeatingOption, ULONG headerIndex, WS_TYPE valueType, WS_READ_OPTION readOption, WS_HEAP *heap, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsWriteBody(WS_MESSAGE *message, const WS_ELEMENT_DESCRIPTION *bodyDescription, WS_WRITE_OPTION writeOption, const void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsReadBody(WS_MESSAGE *message, const WS_ELEMENT_DESCRIPTION *bodyDescription, WS_READ_OPTION readOption, WS_HEAP *heap, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsWriteEnvelopeStart(WS_MESSAGE *message, WS_XML_WRITER *writer, WS_MESSAGE_DONE_CALLBACK doneCallback, void *doneCallbackState, WS_ERROR *error);
HRESULT WINAPI WsWriteEnvelopeEnd(WS_MESSAGE *message, WS_ERROR *error);
HRESULT WINAPI WsReadEnvelopeStart(WS_MESSAGE *message, WS_XML_READER *reader, WS_MESSAGE_DONE_CALLBACK doneCallback, void *doneCallbackState, WS_ERROR *error);
HRESULT WINAPI WsReadEnvelopeEnd(WS_MESSAGE *message, WS_ERROR *error);
HRESULT WINAPI WsGetMessageProperty(WS_MESSAGE *message, WS_MESSAGE_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsSetMessageProperty(WS_MESSAGE *message, WS_MESSAGE_PROPERTY_ID id, const void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsAddressMessage(WS_MESSAGE *message, const WS_ENDPOINT_ADDRESS *address, WS_ERROR *error);
HRESULT WINAPI WsCheckMustUnderstandHeaders(WS_MESSAGE *message, WS_ERROR *error);
HRESULT WINAPI WsMarkHeaderAsUnderstood(WS_MESSAGE *message, const WS_XML_NODE_POSITION *headerPosition, WS_ERROR *error);
HRESULT WINAPI WsFillBody(WS_MESSAGE *message, ULONG minSize, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsFlushBody(WS_MESSAGE *message, ULONG minSize, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsRequestSecurityToken(WS_CHANNEL *channel, const WS_REQUEST_SECURITY_TOKEN_PROPERTY *properties, ULONG propertyCount, WS_SECURITY_TOKEN **token, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsGetSecurityTokenProperty(WS_SECURITY_TOKEN *securityToken, WS_SECURITY_TOKEN_PROPERTY_ID id, void *value, ULONG valueSize, WS_HEAP *heap, WS_ERROR *error);
HRESULT WINAPI WsCreateXmlSecurityToken(WS_XML_BUFFER *tokenXml, WS_SECURITY_KEY_HANDLE *tokenKey, const WS_XML_SECURITY_TOKEN_PROPERTY *properties, ULONG propertyCount, WS_SECURITY_TOKEN **token, WS_ERROR *error);
void WINAPI WsFreeSecurityToken(WS_SECURITY_TOKEN *token);
HRESULT WINAPI WsRevokeSecurityContext(WS_SECURITY_CONTEXT *securityContext, WS_ERROR *error);
HRESULT WINAPI WsGetSecurityContextProperty(WS_SECURITY_CONTEXT *securityContext, WS_SECURITY_CONTEXT_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsReadElement(WS_XML_READER *reader, const WS_ELEMENT_DESCRIPTION *elementDescription, WS_READ_OPTION readOption, WS_HEAP *heap, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsReadAttribute(WS_XML_READER *reader, const WS_ATTRIBUTE_DESCRIPTION *attributeDescription, WS_READ_OPTION readOption, WS_HEAP *heap, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsReadType(WS_XML_READER *reader, WS_TYPE_MAPPING typeMapping, WS_TYPE type, const void *typeDescription, WS_READ_OPTION readOption, WS_HEAP *heap, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsWriteElement(WS_XML_WRITER *writer, const WS_ELEMENT_DESCRIPTION *elementDescription, WS_WRITE_OPTION writeOption, const void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsWriteAttribute(WS_XML_WRITER *writer, const WS_ATTRIBUTE_DESCRIPTION *attributeDescription, WS_WRITE_OPTION writeOption, const void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsWriteType(WS_XML_WRITER *writer, WS_TYPE_MAPPING typeMapping, WS_TYPE type, const void *typeDescription, WS_WRITE_OPTION writeOption, const void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsRegisterOperationForCancel(const WS_OPERATION_CONTEXT *context, WS_OPERATION_CANCEL_CALLBACK cancelCallback, WS_OPERATION_FREE_STATE_CALLBACK freestateCallback, void *userState, WS_ERROR *error);
HRESULT WINAPI WsGetServiceHostProperty(WS_SERVICE_HOST *serviceHost, const WS_SERVICE_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsCreateServiceHost(const WS_SERVICE_ENDPOINT **endpoints, const USHORT endpointCount, const WS_SERVICE_PROPERTY *serviceProperties, ULONG servicePropertyCount, WS_SERVICE_HOST **serviceHost, WS_ERROR *error);
HRESULT WINAPI WsOpenServiceHost(WS_SERVICE_HOST *serviceHost, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsCloseServiceHost(WS_SERVICE_HOST *serviceHost, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsAbortServiceHost(WS_SERVICE_HOST *serviceHost, WS_ERROR *error);
void WINAPI WsFreeServiceHost(WS_SERVICE_HOST *serviceHost);
HRESULT WINAPI WsResetServiceHost(WS_SERVICE_HOST *serviceHost, WS_ERROR *error);
HRESULT WINAPI WsGetServiceProxyProperty(WS_SERVICE_PROXY *serviceProxy, const WS_PROXY_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsCreateServiceProxy(const WS_CHANNEL_TYPE channelType, const WS_CHANNEL_BINDING channelBinding, const WS_SECURITY_DESCRIPTION *securityDescription, const WS_PROXY_PROPERTY *properties, const ULONG propertyCount, const WS_CHANNEL_PROPERTY *channelProperties, const ULONG channelPropertyCount, WS_SERVICE_PROXY **serviceProxy, WS_ERROR *error);
HRESULT WINAPI WsOpenServiceProxy(WS_SERVICE_PROXY *serviceProxy, const WS_ENDPOINT_ADDRESS *address, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsCloseServiceProxy(WS_SERVICE_PROXY *serviceProxy, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsAbortServiceProxy(WS_SERVICE_PROXY *serviceProxy, WS_ERROR *error);
void WINAPI WsFreeServiceProxy(WS_SERVICE_PROXY *serviceProxy);
HRESULT WINAPI WsResetServiceProxy(WS_SERVICE_PROXY *serviceProxy, WS_ERROR *error);
HRESULT WINAPI WsAbandonCall(WS_SERVICE_PROXY *serviceProxy, ULONG callId, WS_ERROR *error);
HRESULT WINAPI WsCall(WS_SERVICE_PROXY *serviceProxy, const WS_OPERATION_DESCRIPTION *operation, const void **arguments, WS_HEAP *heap, const WS_CALL_PROPERTY *callProperties, const ULONG callPropertyCount, const WS_ASYNC_CONTEXT *asyncContext, WS_ERROR *error);
HRESULT WINAPI WsDecodeUrl(const WS_STRING *url, ULONG flags, WS_HEAP *heap, WS_URL **outUrl, WS_ERROR *error);
HRESULT WINAPI WsEncodeUrl(const WS_URL *url, ULONG flags, WS_HEAP *heap, WS_STRING *outUrl, WS_ERROR *error);
HRESULT WINAPI WsCombineUrl(const WS_STRING *baseUrl, const WS_STRING *referenceUrl, ULONG flags, WS_HEAP *heap, WS_STRING *resultUrl, WS_ERROR *error);
HRESULT WINAPI WsDateTimeToFileTime(const WS_DATETIME *dateTime, FILETIME *fileTime, WS_ERROR *error);
HRESULT WINAPI WsFileTimeToDateTime(const FILETIME *fileTime, WS_DATETIME *dateTime, WS_ERROR *error);
HRESULT WINAPI WsCreateMetadata(const WS_METADATA_PROPERTY *properties, ULONG propertyCount, WS_METADATA **metadata, WS_ERROR *error);
HRESULT WINAPI WsReadMetadata(WS_METADATA *metadata, WS_XML_READER *reader, const WS_STRING *url, WS_ERROR *error);
void WINAPI WsFreeMetadata(WS_METADATA *metadata);
HRESULT WINAPI WsResetMetadata(WS_METADATA *metadata, WS_ERROR *error);
HRESULT WINAPI WsGetMetadataProperty(WS_METADATA *metadata, WS_METADATA_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsGetMissingMetadataDocumentAddress(WS_METADATA *metadata, WS_ENDPOINT_ADDRESS **address, WS_ERROR *error);
HRESULT WINAPI WsGetMetadataEndpoints(WS_METADATA *metadata, WS_METADATA_ENDPOINTS *endpoints, WS_ERROR *error);
HRESULT WINAPI WsMatchPolicyAlternative(WS_POLICY *policy, ULONG alternativeIndex, WS_POLICY_CONSTRAINTS *policyConstraints, BOOL matchRequired, WS_HEAP *heap, WS_ERROR *error);
HRESULT WINAPI WsGetPolicyProperty(WS_POLICY *policy, WS_POLICY_PROPERTY_ID id, void *value, ULONG valueSize, WS_ERROR *error);
HRESULT WINAPI WsGetPolicyAlternativeCount(WS_POLICY *policy, ULONG *count, WS_ERROR *error);
HRESULT WINAPI WsCreateServiceProxyFromTemplate(WS_CHANNEL_TYPE channelType, const WS_PROXY_PROPERTY *properties, const ULONG propertyCount, WS_BINDING_TEMPLATE_TYPE templateType, void *templateValue, ULONG templateSize, const void *templateDescription, ULONG templateDescriptionSize, WS_SERVICE_PROXY **serviceProxy, WS_ERROR *error);
HRESULT WINAPI WsCreateServiceEndpointFromTemplate(WS_CHANNEL_TYPE channelType, const WS_SERVICE_ENDPOINT_PROPERTY *properties, ULONG propertyCount, const WS_STRING *addressUrl, const WS_SERVICE_CONTRACT *contract, WS_SERVICE_SECURITY_CALLBACK authorizationCallback, WS_HEAP *heap, WS_BINDING_TEMPLATE_TYPE templateType, void *templateValue, ULONG templateSize, const void *templateDescription, ULONG templateDescriptionSize, WS_SERVICE_ENDPOINT **serviceEndpoint, WS_ERROR *error);
