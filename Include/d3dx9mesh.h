...
DECLARE_INTERFACE_(ID3DXBaseMesh, IUnknown)
{
	...
	STDMETHOD_(DWORD, GetNumBytesPerVertex) (THIS);
	STDMETHOD_(DWORD, GetOptions) (THIS);
	STDMETHOD(GetDevice) (THIS_ LPDIRECT3DDEVICE9 * ppDevice);
	STDMETHOD(CloneMeshFVF) (THIS_ DWORD Options, DWORD FVF, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXMESH * ppCloneMesh);
	STDMETHOD(CloneMesh) (THIS_ DWORD Options, CONST D3DVERTEXELEMENT9 * pDeclaration, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXMESH * ppCloneMesh);
	STDMETHOD(GetVertexBuffer) (THIS_ LPDIRECT3DVERTEXBUFFER9 * ppVB);
	STDMETHOD(GetIndexBuffer) (THIS_ LPDIRECT3DINDEXBUFFER9 * ppIB);
	...
	STDMETHOD(UpdateSemantics) (THIS_ D3DVERTEXELEMENT9 Declaration[MAX_FVF_DECL_SIZE]);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(ID3DXMesh, ID3DXBaseMesh)
{
	...
	STDMETHOD(SetAttributeTable) (THIS_ CONST D3DXATTRIBUTERANGE * pAttribTable, DWORD cAttribTableSize);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(ID3DXPMesh, ID3DXBaseMesh)
{
	...
	STDMETHOD(GenerateAdjacency) (THIS_ FLOAT Epsilon, DWORD * pAdjacency);
	STDMETHOD(UpdateSemantics) (THIS_ D3DVERTEXELEMENT9 Declaration[MAX_FVF_DECL_SIZE]);
	STDMETHOD(ClonePMeshFVF) (THIS_ DWORD Options, DWORD FVF, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXPMESH * ppCloneMesh);
	STDMETHOD(ClonePMesh) (THIS_ DWORD Options, CONST D3DVERTEXELEMENT9 * pDeclaration, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXPMESH * ppCloneMesh);
	...
	STDMETHOD(Save) (THIS_ IStream * pStream, CONST D3DXMATERIAL * pMaterials, CONST D3DXEFFECTINSTANCE * pEffectInstances, DWORD NumMaterials);
	...
	STDMETHOD(GenerateVertexHistory) (THIS_ DWORD * pVertexHistory);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(ID3DXSPMesh, IUnknown)
{
	...
	STDMETHOD_(DWORD, GetOptions) (THIS);
	STDMETHOD(GetDevice) (THIS_ LPDIRECT3DDEVICE9 * ppDevice);
	STDMETHOD(CloneMeshFVF) (THIS_ DWORD Options, DWORD FVF, LPDIRECT3DDEVICE9 pD3DDevice, DWORD * pAdjacencyOut, DWORD * pVertexRemapOut, LPD3DXMESH * ppCloneMesh);
	STDMETHOD(CloneMesh) (THIS_ DWORD Options, CONST D3DVERTEXELEMENT9 * pDeclaration, LPDIRECT3DDEVICE9 pD3DDevice, DWORD * pAdjacencyOut, DWORD * pVertexRemapOut, LPD3DXMESH * ppCloneMesh);
	STDMETHOD(ClonePMeshFVF) (THIS_ DWORD Options, DWORD FVF, LPDIRECT3DDEVICE9 pD3DDevice, DWORD * pVertexRemapOut, FLOAT * pErrorsByFace, LPD3DXPMESH * ppCloneMesh);
	STDMETHOD(ClonePMesh) (THIS_ DWORD Options, CONST D3DVERTEXELEMENT9 * pDeclaration, LPDIRECT3DDEVICE9 pD3DDevice, DWORD * pVertexRemapOut, FLOAT * pErrorsbyFace, LPD3DXPMESH * ppCloneMesh);
...
DECLARE_INTERFACE_(ID3DXPatchMesh, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD_(DWORD, GetNumPatches) (THIS);
	STDMETHOD_(DWORD, GetNumVertices) (THIS);
	STDMETHOD(GetDeclaration) (THIS_ D3DVERTEXELEMENT9 Declaration[MAX_FVF_DECL_SIZE]);
	STDMETHOD_(DWORD, GetControlVerticesPerPatch) (THIS);
	STDMETHOD_(DWORD, GetOptions) (THIS);
	STDMETHOD(GetDevice) (THIS_ LPDIRECT3DDEVICE9 * ppDevice);
	STDMETHOD(GetPatchInfo) (THIS_ LPD3DXPATCHINFO PatchInfo);
	STDMETHOD(GetVertexBuffer) (THIS_ LPDIRECT3DVERTEXBUFFER9 * ppVB);
	STDMETHOD(GetIndexBuffer) (THIS_ LPDIRECT3DINDEXBUFFER9 * ppIB);
	STDMETHOD(LockVertexBuffer) (THIS_ DWORD flags, LPVOID * ppData);
	STDMETHOD(UnlockVertexBuffer) (THIS);
	...
	STDMETHOD(LockAttributeBuffer) (THIS_ DWORD flags, DWORD ** ppData);
	STDMETHOD(UnlockAttributeBuffer) (THIS);
	STDMETHOD(GetTessSize) (THIS_ FLOAT fTessLevel, DWORD Adaptive, DWORD * NumTriangles, DWORD * NumVertices);
	STDMETHOD(GenerateAdjacency) (THIS_ FLOAT Tolerance);
	STDMETHOD(CloneMesh) (THIS_ DWORD Options, CONST D3DVERTEXELEMENT9 * pDecl, LPD3DXPATCHMESH * pMesh);
	STDMETHOD(Optimize) (THIS_ DWORD flags);
	STDMETHOD(SetDisplaceParam) (THIS_ LPDIRECT3DBASETEXTURE9 Texture, D3DTEXTUREFILTERTYPE MinFilter, D3DTEXTUREFILTERTYPE MagFilter, D3DTEXTUREFILTERTYPE MipFilter, D3DTEXTUREADDRESS Wrap, DWORD dwLODBias);
	STDMETHOD(GetDisplaceParam) (THIS_ LPDIRECT3DBASETEXTURE9 * Texture, D3DTEXTUREFILTERTYPE * MinFilter, D3DTEXTUREFILTERTYPE * MagFilter, D3DTEXTUREFILTERTYPE * MipFilter, D3DTEXTUREADDRESS * Wrap, DWORD * dwLODBias);
	STDMETHOD(Tessellate) (THIS_ FLOAT fTessLevel, LPD3DXMESH pMesh);
	STDMETHOD(TessellateAdaptive) (THIS_ CONST D3DXVECTOR4 * pTrans, DWORD dwMaxTessLevel, DWORD dwMinTessLevel, LPD3DXMESH pMesh);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(ID3DXSkinInfo, IUnknown)
{
	...
	STDMETHOD(SetBoneVertexInfluence) (THIS_ DWORD boneNum, DWORD influenceNum, float weight);
	...
	STDMETHOD(GetBoneVertexInfluence) (THIS_ DWORD boneNum, DWORD influenceNum, float *pWeight, DWORD * pVertexNum);
	STDMETHOD(GetMaxVertexInfluences) (THIS_ DWORD * maxVertexInfluences);
	STDMETHOD_(DWORD, GetNumBones) (THIS);
	STDMETHOD(FindBoneVertexInfluenceIndex) (THIS_ DWORD boneNum, DWORD vertexNum, DWORD * pInfluenceIndex);
	STDMETHOD(GetMaxFaceInfluences) (THIS_ LPDIRECT3DINDEXBUFFER9 pIB, DWORD NumFaces, DWORD * maxFaceInfluences);
	STDMETHOD(SetMinBoneInfluence) (THIS_ FLOAT MinInfl);
	STDMETHOD_(FLOAT, GetMinBoneInfluence) (THIS);
	STDMETHOD(SetBoneName) (THIS_ DWORD Bone, LPCSTR pName);
	STDMETHOD_(LPCSTR, GetBoneName) (THIS_ DWORD Bone);
	STDMETHOD(SetBoneOffsetMatrix) (THIS_ DWORD Bone, CONST D3DXMATRIX * pBoneTransform);
	STDMETHOD_(LPD3DXMATRIX, GetBoneOffsetMatrix) (THIS_ DWORD Bone);
	STDMETHOD(Clone) (THIS_ LPD3DXSKININFO * ppSkinInfo);
	STDMETHOD(Remap) (THIS_ DWORD NumVertices, DWORD * pVertexRemap);
	STDMETHOD(SetFVF) (THIS_ DWORD FVF);
	STDMETHOD(SetDeclaration) (THIS_ CONST D3DVERTEXELEMENT9 * pDeclaration);
	STDMETHOD_(DWORD, GetFVF) (THIS);
	STDMETHOD(GetDeclaration) (THIS_ D3DVERTEXELEMENT9 Declaration[MAX_FVF_DECL_SIZE]);
	STDMETHOD(UpdateSkinnedMesh) (THIS_ CONST D3DXMATRIX * pBoneTransforms, CONST D3DXMATRIX * pBoneInvTransposeTransforms, LPCVOID pVerticesSrc, PVOID pVerticesDst);
	STDMETHOD(ConvertToBlendedMesh) (THIS_ LPD3DXMESH pMesh, DWORD Options, CONST DWORD * pAdjacencyIn, LPDWORD pAdjacencyOut, DWORD * pFaceRemap, LPD3DXBUFFER * ppVertexRemap, DWORD * pMaxFaceInfl, DWORD * pNumBoneCombinations, LPD3DXBUFFER * ppBoneCombinationTable, LPD3DXMESH * ppMesh);
	STDMETHOD(ConvertToIndexedBlendedMesh) (THIS_ LPD3DXMESH pMesh, DWORD Options, DWORD paletteSize, CONST DWORD * pAdjacencyIn, LPDWORD pAdjacencyOut, DWORD * pFaceRemap, LPD3DXBUFFER * ppVertexRemap, DWORD * pMaxVertexInfl, DWORD * pNumBoneCombinations, LPD3DXBUFFER * ppBoneCombinationTable, LPD3DXMESH * ppMesh);
};
...
DECLARE_INTERFACE_(ID3DXPRTBuffer, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD_(UINT, GetNumSamples) (THIS);
	STDMETHOD_(UINT, GetNumCoeffs) (THIS);
	STDMETHOD_(UINT, GetNumChannels) (THIS);
	STDMETHOD_(BOOL, IsTexture) (THIS);
	STDMETHOD_(UINT, GetWidth) (THIS);
	STDMETHOD_(UINT, GetHeight) (THIS);
	STDMETHOD(Resize) (THIS_ UINT NewSize);
	STDMETHOD(LockBuffer) (THIS_ UINT Start, UINT NumSamples, FLOAT ** ppData);
	STDMETHOD(UnlockBuffer) (THIS);
	STDMETHOD(ScaleBuffer) (THIS_ FLOAT Scale);
	STDMETHOD(AddBuffer) (THIS_ LPD3DXPRTBUFFER pBuffer);
	STDMETHOD(AttachGH) (THIS_ LPD3DXTEXTUREGUTTERHELPER);
	STDMETHOD(ReleaseGH) (THIS);
	STDMETHOD(EvalGH) (THIS);
	STDMETHOD(ExtractTexture) (THIS_ UINT Channel, UINT StartCoefficient, UINT NumCoefficients, LPDIRECT3DTEXTURE9 pTexture);
	STDMETHOD(ExtractToMesh) (THIS_ UINT NumCoefficients, D3DDECLUSAGE Usage, UINT UsageIndexStart, LPD3DXMESH pScene);
};
...
DECLARE_INTERFACE_(ID3DXPRTCompBuffer, IUnknown)
{
	...
	STDMETHOD_(UINT, GetWidth) (THIS);
	STDMETHOD_(UINT, GetHeight) (THIS);
	STDMETHOD_(UINT, GetNumClusters) (THIS);
	STDMETHOD_(UINT, GetNumPCA) (THIS);
	STDMETHOD(NormalizeData) (THIS);
	STDMETHOD(ExtractBasis) (THIS_ UINT Cluster, FLOAT * pClusterBasis);
	STDMETHOD(ExtractClusterIDs) (THIS_ UINT * pClusterIDs);
	STDMETHOD(ExtractPCA) (THIS_ UINT StartPCA, UINT NumExtract, FLOAT * pPCACoefficients);
	STDMETHOD(ExtractTexture) (THIS_ UINT StartPCA, UINT NumpPCA, LPDIRECT3DTEXTURE9 pTexture);
	STDMETHOD(ExtractToMesh) (THIS_ UINT NumPCA, D3DDECLUSAGE Usage, UINT UsageIndexStart, LPD3DXMESH pScene);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(ID3DXTextureGutterHelper, IUnknown)
{
	...
	STDMETHOD(GetFaceMap) (THIS_ UINT * pFaceData);
	STDMETHOD(GetBaryMap) (THIS_ D3DXVECTOR2 * pBaryData);
	STDMETHOD(GetTexelMap) (THIS_ D3DXVECTOR2 * pTexelData);
	STDMETHOD(GetGutterMap) (THIS_ BYTE * pGutterData);
	STDMETHOD(SetFaceMap) (THIS_ UINT * pFaceData);
	STDMETHOD(SetBaryMap) (THIS_ D3DXVECTOR2 * pBaryData);
	STDMETHOD(SetTexelMap) (THIS_ D3DXVECTOR2 * pTexelData);
	STDMETHOD(SetGutterMap) (THIS_ BYTE * pGutterData);
};
...
DECLARE_INTERFACE_(ID3DXPRTEngine, IUnknown)
{
	...
	STDMETHOD_(ULONG, AddRef) (THIS);
	STDMETHOD_(ULONG, Release) (THIS);
	STDMETHOD(SetMeshMaterials) (THIS_ CONST D3DXSHMATERIAL ** ppMaterials, UINT NumMeshes, UINT NumChannels, BOOL bSetAlbedo, FLOAT fLengthScale);
	STDMETHOD(SetPerVertexAlbedo) (THIS_ CONST VOID * pDataIn, UINT NumChannels, UINT Stride);
	STDMETHOD(SetPerTexelAlbedo) (THIS_ LPDIRECT3DTEXTURE9 pAlbedoTexture, UINT NumChannels, LPD3DXTEXTUREGUTTERHELPER pGH);
	...
	STDMETHOD(ExtractPerVertexAlbedo) (THIS_ LPD3DXMESH pMesh, D3DDECLUSAGE Usage, UINT NumChannels);
	STDMETHOD(ResampleBuffer) (THIS_ LPD3DXPRTBUFFER pBufferIn, LPD3DXPRTBUFFER pBufferOut);
	STDMETHOD(GetAdaptedMesh) (THIS_ LPDIRECT3DDEVICE9 pD3DDevice, UINT * pFaceRemap, UINT * pVertRemap, FLOAT * pfVertWeights, LPD3DXMESH * ppMesh);
	STDMETHOD_(UINT, GetNumVerts) (THIS);
	STDMETHOD_(UINT, GetNumFaces) (THIS);
	STDMETHOD(SetMinMaxIntersection) (THIS_ FLOAT fMin, FLOAT fMax);
	STDMETHOD(RobustMeshRefine) (THIS_ FLOAT MinEdgeLength, UINT MaxSubdiv);
	STDMETHOD(SetSamplingInfo) (THIS_ UINT NumRays, BOOL UseSphere, BOOL UseCosine, BOOL Adaptive, FLOAT AdaptiveThresh);
	STDMETHOD(ComputeDirectLightingSH) (THIS_ UINT SHOrder, LPD3DXPRTBUFFER pDataOut);
	STDMETHOD(ComputeDirectLightingSHAdaptive) (THIS_ UINT SHOrder, FLOAT AdaptiveThresh, FLOAT MinEdgeLength, UINT MaxSubdiv, LPD3DXPRTBUFFER pDataOut);
	STDMETHOD(ComputeDirectLightingSHGPU) (THIS_ LPDIRECT3DDEVICE9 pD3DDevice, UINT Flags, UINT SHOrder, FLOAT ZBias, FLOAT ZAngleBias, LPD3DXPRTBUFFER pDataOut);
	STDMETHOD(ComputeSS) (THIS_ LPD3DXPRTBUFFER pDataIn, LPD3DXPRTBUFFER pDataOut, LPD3DXPRTBUFFER pDataTotal);
	STDMETHOD(ComputeSSAdaptive) (THIS_ LPD3DXPRTBUFFER pDataIn, FLOAT AdaptiveThresh, FLOAT MinEdgeLength, UINT MaxSubdiv, LPD3DXPRTBUFFER pDataOut, LPD3DXPRTBUFFER pDataTotal);
	STDMETHOD(ComputeBounce) (THIS_ LPD3DXPRTBUFFER pDataIn, LPD3DXPRTBUFFER pDataOut, LPD3DXPRTBUFFER pDataTotal);
	STDMETHOD(ComputeBounceAdaptive) (THIS_ LPD3DXPRTBUFFER pDataIn, FLOAT AdaptiveThresh, FLOAT MinEdgeLength, UINT MaxSubdiv, LPD3DXPRTBUFFER pDataOut, LPD3DXPRTBUFFER pDataTotal);
	STDMETHOD(ComputeVolumeSamplesDirectSH) (THIS_ UINT SHOrderIn, UINT SHOrderOut, UINT NumVolSamples, CONST D3DXVECTOR3 * pSampleLocs, LPD3DXPRTBUFFER pDataOut);
	STDMETHOD(ComputeVolumeSamples) (THIS_ LPD3DXPRTBUFFER pSurfDataIn, UINT SHOrder, UINT NumVolSamples, CONST D3DXVECTOR3 * pSampleLocs, LPD3DXPRTBUFFER pDataOut);
	STDMETHOD(ComputeSurfSamplesDirectSH) (THIS_ UINT SHOrder, UINT NumSamples, CONST D3DXVECTOR3 * pSampleLocs, CONST D3DXVECTOR3 * pSampleNorms, LPD3DXPRTBUFFER pDataOut);
	STDMETHOD(ComputeSurfSamplesBounce) (THIS_ LPD3DXPRTBUFFER pSurfDataIn, UINT NumSamples, CONST D3DXVECTOR3 * pSampleLocs, CONST D3DXVECTOR3 * pSampleNorms, LPD3DXPRTBUFFER pDataOut, LPD3DXPRTBUFFER pDataTotal);
	STDMETHOD(FreeSSData) (THIS);
	STDMETHOD(FreeBounceData) (THIS);
	STDMETHOD(ComputeLDPRTCoeffs) (THIS_ LPD3DXPRTBUFFER pDataIn, UINT SHOrder, D3DXVECTOR3 * pNormOut, LPD3DXPRTBUFFER pDataOut);
	STDMETHOD(ScaleMeshChunk) (THIS_ UINT uMeshChunk, FLOAT fScale, LPD3DXPRTBUFFER pDataOut);
	STDMETHOD(MultiplyAlbedo) (THIS_ LPD3DXPRTBUFFER pDataOut);
	STDMETHOD(SetCallBack) (THIS_ LPD3DXSHPRTSIMCB pCB, FLOAT Frequency, LPVOID lpUserContext);
	STDMETHOD_(BOOL, ShadowRayIntersects) (THIS_ CONST D3DXVECTOR3 * pRayPos, CONST D3DXVECTOR3 * pRayDir);
	STDMETHOD_(BOOL, ClosestRayIntersects) (THIS_ CONST D3DXVECTOR3 * pRayPos, CONST D3DXVECTOR3 * pRayDir, DWORD * pFaceIndex, FLOAT * pU, FLOAT * pV, FLOAT * pDist);
};
