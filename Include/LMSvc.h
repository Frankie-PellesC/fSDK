/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Jul 17 23:09:01 2016
 \date		Modified on Sun Jul 17 23:09:01 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
NET_API_STATUS NET_API_FUNCTION NetServiceControl(LPCWSTR servername, LPCWSTR service, DWORD opcode, DWORD arg, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetServiceEnum(LPCWSTR servername, DWORD level, LPBYTE *bufptr, DWORD prefmaxlen, LPDWORD entriesread, LPDWORD totalentries, LPDWORD resume_handle);
NET_API_STATUS NET_API_FUNCTION NetServiceGetInfo(LPCWSTR servername, LPCWSTR service, DWORD level, LPBYTE *bufptr);
NET_API_STATUS NET_API_FUNCTION NetServiceInstall(LPCWSTR servername, LPCWSTR service, DWORD argc, LPCWSTR argv[], LPBYTE *bufptr);
