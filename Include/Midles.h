/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Sun Aug  7 21:37:13 2016
 \date		Modified on Sun Aug  7 21:37:13 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef void (__RPC_USER * MIDL_ES_ALLOC) (void *state, char **pbuffer, unsigned int *psize);
typedef void (__RPC_USER * MIDL_ES_WRITE) (void *state, char *buffer, unsigned int size);
typedef void (__RPC_USER * MIDL_ES_READ) (void *state, char **pbuffer, unsigned int *psize);
