/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Fri Sep 16 22:48:40 2016
 \date		Modified on Fri Sep 16 22:48:40 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef enum _TEMPLATESPROPERTIES
{
...
extern const IID LIBID_SDOIASLib;
#ifndef __ISdoMachine_INTERFACE_DEFINED__
#define __ISdoMachine_INTERFACE_DEFINED__
extern const IID IID_ISdoMachine;
typedef struct ISdoMachineVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISdoMachine * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISdoMachine * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISdoMachine * This);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfoCount) (ISdoMachine * This, UINT * pctinfo);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfo) (ISdoMachine * This, UINT iTInfo, LCID lcid, ITypeInfo ** ppTInfo);
	HRESULT(STDMETHODCALLTYPE * GetIDsOfNames) (ISdoMachine * This, REFIID riid, LPOLESTR * rgszNames, UINT cNames, LCID lcid, DISPID * rgDispId);
	HRESULT(STDMETHODCALLTYPE * Invoke) (ISdoMachine * This, DISPID dispIdMember, REFIID riid, LCID lcid, WORD wFlags, DISPPARAMS * pDispParams, VARIANT * pVarResult, EXCEPINFO * pExcepInfo, UINT * puArgErr);
	HRESULT(STDMETHODCALLTYPE * Attach) (ISdoMachine * This, BSTR bstrComputerName);
	HRESULT(STDMETHODCALLTYPE * GetDictionarySDO) (ISdoMachine * This, IUnknown ** ppDictionarySDO);
	HRESULT(STDMETHODCALLTYPE * GetServiceSDO) (ISdoMachine * This, IASDATASTORE eDataStore, BSTR bstrServiceName, IUnknown ** ppServiceSDO);
	HRESULT(STDMETHODCALLTYPE * GetUserSDO) (ISdoMachine * This, IASDATASTORE eDataStore, BSTR bstrUserName, IUnknown ** ppUserSDO);
	HRESULT(STDMETHODCALLTYPE * GetOSType) (ISdoMachine * This, IASOSTYPE * eOSType);
	HRESULT(STDMETHODCALLTYPE * GetDomainType) (ISdoMachine * This, IASDOMAINTYPE * eDomainType);
	HRESULT(STDMETHODCALLTYPE * IsDirectoryAvailable) (ISdoMachine * This, VARIANT_BOOL * boolDirectoryAvailable);
	HRESULT(STDMETHODCALLTYPE * GetAttachedComputer) (ISdoMachine * This, BSTR * bstrComputerName);
	HRESULT(STDMETHODCALLTYPE * GetSDOSchema) (ISdoMachine * This, IUnknown ** ppSDOSchema);
	END_INTERFACE
}  ISdoMachineVtbl;
...
extern const IID IID_ISdoMachine2;
typedef struct ISdoMachine2Vtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISdoMachine2 * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISdoMachine2 * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISdoMachine2 * This);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfoCount) (ISdoMachine2 * This, UINT * pctinfo);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfo) (ISdoMachine2 * This, UINT iTInfo, LCID lcid, ITypeInfo ** ppTInfo);
	HRESULT(STDMETHODCALLTYPE * GetIDsOfNames) (ISdoMachine2 * This, REFIID riid, LPOLESTR * rgszNames, UINT cNames, LCID lcid, DISPID * rgDispId);
	HRESULT(STDMETHODCALLTYPE * Invoke) (ISdoMachine2 * This, DISPID dispIdMember, REFIID riid, LCID lcid, WORD wFlags, DISPPARAMS * pDispParams, VARIANT * pVarResult, EXCEPINFO * pExcepInfo, UINT * puArgErr);
	HRESULT(STDMETHODCALLTYPE * Attach) (ISdoMachine2 * This, BSTR bstrComputerName);
	HRESULT(STDMETHODCALLTYPE * GetDictionarySDO) (ISdoMachine2 * This, IUnknown ** ppDictionarySDO);
	HRESULT(STDMETHODCALLTYPE * GetServiceSDO) (ISdoMachine2 * This, IASDATASTORE eDataStore, BSTR bstrServiceName, IUnknown ** ppServiceSDO);
	HRESULT(STDMETHODCALLTYPE * GetUserSDO) (ISdoMachine2 * This, IASDATASTORE eDataStore, BSTR bstrUserName, IUnknown ** ppUserSDO);
	HRESULT(STDMETHODCALLTYPE * GetOSType) (ISdoMachine2 * This, IASOSTYPE * eOSType);
	HRESULT(STDMETHODCALLTYPE * GetDomainType) (ISdoMachine2 * This, IASDOMAINTYPE * eDomainType);
	HRESULT(STDMETHODCALLTYPE * IsDirectoryAvailable) (ISdoMachine2 * This, VARIANT_BOOL * boolDirectoryAvailable);
	HRESULT(STDMETHODCALLTYPE * GetAttachedComputer) (ISdoMachine2 * This, BSTR * bstrComputerName);
	HRESULT(STDMETHODCALLTYPE * GetSDOSchema) (ISdoMachine2 * This, IUnknown ** ppSDOSchema);
	HRESULT(STDMETHODCALLTYPE * GetTemplatesSDO) (ISdoMachine2 * This, BSTR bstrServiceName, IUnknown ** ppTemplatesSDO);
	HRESULT(STDMETHODCALLTYPE * EnableTemplates) (ISdoMachine2 * This);
	HRESULT(STDMETHODCALLTYPE * SyncConfigAgainstTemplates) (ISdoMachine2 * This, BSTR bstrServiceName, IUnknown ** ppConfigRoot, IUnknown ** ppTemplatesRoot, VARIANT_BOOL bForcedSync);
	HRESULT(STDMETHODCALLTYPE * ImportRemoteTemplates) (ISdoMachine2 * This, IUnknown * pLocalTemplatesRoot, BSTR bstrRemoteMachineName);
	HRESULT(STDMETHODCALLTYPE * Reload) (ISdoMachine2 * This);
	END_INTERFACE
}  ISdoMachine2Vtbl;
...
#ifdef COBJMACROS
#define ISdoMachine2_QueryInterface(This,riid,ppvObject)     ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) )
#define ISdoMachine2_AddRef(This)     ( (This)->lpVtbl -> AddRef(This) )
#define ISdoMachine2_Release(This)     ( (This)->lpVtbl -> Release(This) )
#define ISdoMachine2_GetTypeInfoCount(This,pctinfo)     ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) )
#define ISdoMachine2_GetTypeInfo(This,iTInfo,lcid,ppTInfo)     ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) )
#define ISdoMachine2_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)     ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) )
#define ISdoMachine2_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)     ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) )
#define ISdoMachine2_Attach(This,bstrComputerName)     ( (This)->lpVtbl -> Attach(This,bstrComputerName) )
#define ISdoMachine2_GetDictionarySDO(This,ppDictionarySDO)     ( (This)->lpVtbl -> GetDictionarySDO(This,ppDictionarySDO) )
#define ISdoMachine2_GetServiceSDO(This,eDataStore,bstrServiceName,ppServiceSDO)     ( (This)->lpVtbl -> GetServiceSDO(This,eDataStore,bstrServiceName,ppServiceSDO) )
#define ISdoMachine2_GetUserSDO(This,eDataStore,bstrUserName,ppUserSDO)     ( (This)->lpVtbl -> GetUserSDO(This,eDataStore,bstrUserName,ppUserSDO) )
#define ISdoMachine2_GetOSType(This,eOSType)     ( (This)->lpVtbl -> GetOSType(This,eOSType) )
#define ISdoMachine2_GetDomainType(This,eDomainType)     ( (This)->lpVtbl -> GetDomainType(This,eDomainType) )
#define ISdoMachine2_IsDirectoryAvailable(This,boolDirectoryAvailable)     ( (This)->lpVtbl -> IsDirectoryAvailable(This,boolDirectoryAvailable) )
#define ISdoMachine2_GetAttachedComputer(This,bstrComputerName)     ( (This)->lpVtbl -> GetAttachedComputer(This,bstrComputerName) )
#define ISdoMachine2_GetSDOSchema(This,ppSDOSchema)     ( (This)->lpVtbl -> GetSDOSchema(This,ppSDOSchema) )
#define ISdoMachine2_GetTemplatesSDO(This,bstrServiceName,ppTemplatesSDO)     ( (This)->lpVtbl -> GetTemplatesSDO(This,bstrServiceName,ppTemplatesSDO) )
#define ISdoMachine2_EnableTemplates(This)     ( (This)->lpVtbl -> EnableTemplates(This) )
#define ISdoMachine2_SyncConfigAgainstTemplates(This,bstrServiceName,ppConfigRoot,ppTemplatesRoot,bForcedSync)     ( (This)->lpVtbl -> SyncConfigAgainstTemplates(This,bstrServiceName,ppConfigRoot,ppTemplatesRoot,bForcedSync) )
#define ISdoMachine2_ImportRemoteTemplates(This,pLocalTemplatesRoot,bstrRemoteMachineName)     ( (This)->lpVtbl -> ImportRemoteTemplates(This,pLocalTemplatesRoot,bstrRemoteMachineName) )
#define ISdoMachine2_Reload(This)     ( (This)->lpVtbl -> Reload(This) )
#endif
#endif
#ifndef __ISdoServiceControl_INTERFACE_DEFINED__
#define __ISdoServiceControl_INTERFACE_DEFINED__
extern const IID IID_ISdoServiceControl;
typedef struct ISdoServiceControlVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISdoServiceControl * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISdoServiceControl * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISdoServiceControl * This);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfoCount) (ISdoServiceControl * This, UINT * pctinfo);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfo) (ISdoServiceControl * This, UINT iTInfo, LCID lcid, ITypeInfo ** ppTInfo);
	HRESULT(STDMETHODCALLTYPE * GetIDsOfNames) (ISdoServiceControl * This, REFIID riid, LPOLESTR * rgszNames, UINT cNames, LCID lcid, DISPID * rgDispId);
	HRESULT(STDMETHODCALLTYPE * Invoke) (ISdoServiceControl * This, DISPID dispIdMember, REFIID riid, LCID lcid, WORD wFlags, DISPPARAMS * pDispParams, VARIANT * pVarResult, EXCEPINFO * pExcepInfo, UINT * puArgErr);
	HRESULT(STDMETHODCALLTYPE * StartService) (ISdoServiceControl * This);
	HRESULT(STDMETHODCALLTYPE * StopService) (ISdoServiceControl * This);
	HRESULT(STDMETHODCALLTYPE * GetServiceStatus) (ISdoServiceControl * This, LONG * status);
	HRESULT(STDMETHODCALLTYPE * ResetService) (ISdoServiceControl * This);
	END_INTERFACE
...
extern const IID IID_ISdo;
typedef struct ISdoVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISdo * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISdo * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISdo * This);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfoCount) (ISdo * This, UINT * pctinfo);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfo) (ISdo * This, UINT iTInfo, LCID lcid, ITypeInfo ** ppTInfo);
	HRESULT(STDMETHODCALLTYPE * GetIDsOfNames) (ISdo * This, REFIID riid, LPOLESTR * rgszNames, UINT cNames, LCID lcid, DISPID * rgDispId);
	HRESULT(STDMETHODCALLTYPE * Invoke) (ISdo * This, DISPID dispIdMember, REFIID riid, LCID lcid, WORD wFlags, DISPPARAMS * pDispParams, VARIANT * pVarResult, EXCEPINFO * pExcepInfo, UINT * puArgErr);
	HRESULT(STDMETHODCALLTYPE * GetPropertyInfo) (ISdo * This, LONG Id, IUnknown ** ppPropertyInfo);
	HRESULT(STDMETHODCALLTYPE * GetProperty) (ISdo * This, LONG Id, VARIANT * pValue);
	HRESULT(STDMETHODCALLTYPE * PutProperty) (ISdo * This, LONG Id, VARIANT * pValue);
	HRESULT(STDMETHODCALLTYPE * ResetProperty) (ISdo * This, LONG Id);
	HRESULT(STDMETHODCALLTYPE * Apply) (ISdo * This);
	HRESULT(STDMETHODCALLTYPE * Restore) (ISdo * This);
	HRESULT(STDMETHODCALLTYPE * get__NewEnum) (ISdo * This, IUnknown ** ppEnumVARIANT);
	END_INTERFACE
}  ISdoVtbl;
interface ISdo
{
...
extern const IID IID_ISdoCollection;
typedef struct ISdoCollectionVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISdoCollection * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISdoCollection * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISdoCollection * This);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfoCount) (ISdoCollection * This, UINT * pctinfo);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfo) (ISdoCollection * This, UINT iTInfo, LCID lcid, ITypeInfo ** ppTInfo);
	HRESULT(STDMETHODCALLTYPE * GetIDsOfNames) (ISdoCollection * This, REFIID riid, LPOLESTR * rgszNames, UINT cNames, LCID lcid, DISPID * rgDispId);
	HRESULT(STDMETHODCALLTYPE * Invoke) (ISdoCollection * This, DISPID dispIdMember, REFIID riid, LCID lcid, WORD wFlags, DISPPARAMS * pDispParams, VARIANT * pVarResult, EXCEPINFO * pExcepInfo, UINT * puArgErr);
	HRESULT(STDMETHODCALLTYPE * get_Count) (ISdoCollection * This, long *pCount);
	HRESULT(STDMETHODCALLTYPE * Add) (ISdoCollection * This, BSTR bstrName, IDispatch ** ppItem);
	HRESULT(STDMETHODCALLTYPE * Remove) (ISdoCollection * This, IDispatch * pItem);
	HRESULT(STDMETHODCALLTYPE * RemoveAll) (ISdoCollection * This);
	HRESULT(STDMETHODCALLTYPE * Reload) (ISdoCollection * This);
	HRESULT(STDMETHODCALLTYPE * IsNameUnique) (ISdoCollection * This, BSTR bstrName, VARIANT_BOOL * pBool);
	HRESULT(STDMETHODCALLTYPE * Item) (ISdoCollection * This, VARIANT * Name, IDispatch ** pItem);
	HRESULT(STDMETHODCALLTYPE * get__NewEnum) (ISdoCollection * This, IUnknown ** ppEnumVARIANT);
	END_INTERFACE
}  ISdoCollectionVtbl;
...
extern const IID IID_ITemplateSdo;
typedef struct ITemplateSdoVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ITemplateSdo * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ITemplateSdo * This);
	ULONG(STDMETHODCALLTYPE * Release) (ITemplateSdo * This);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfoCount) (ITemplateSdo * This, UINT * pctinfo);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfo) (ITemplateSdo * This, UINT iTInfo, LCID lcid, ITypeInfo ** ppTInfo);
	HRESULT(STDMETHODCALLTYPE * GetIDsOfNames) (ITemplateSdo * This, REFIID riid, LPOLESTR * rgszNames, UINT cNames, LCID lcid, DISPID * rgDispId);
	HRESULT(STDMETHODCALLTYPE * Invoke) (ITemplateSdo * This, DISPID dispIdMember, REFIID riid, LCID lcid, WORD wFlags, DISPPARAMS * pDispParams, VARIANT * pVarResult, EXCEPINFO * pExcepInfo, UINT * puArgErr);
	HRESULT(STDMETHODCALLTYPE * GetPropertyInfo) (ITemplateSdo * This, LONG Id, IUnknown ** ppPropertyInfo);
	HRESULT(STDMETHODCALLTYPE * GetProperty) (ITemplateSdo * This, LONG Id, VARIANT * pValue);
	HRESULT(STDMETHODCALLTYPE * PutProperty) (ITemplateSdo * This, LONG Id, VARIANT * pValue);
	HRESULT(STDMETHODCALLTYPE * ResetProperty) (ITemplateSdo * This, LONG Id);
	HRESULT(STDMETHODCALLTYPE * Apply) (ITemplateSdo * This);
	HRESULT(STDMETHODCALLTYPE * Restore) (ITemplateSdo * This);
	HRESULT(STDMETHODCALLTYPE * get__NewEnum) (ITemplateSdo * This, IUnknown ** ppEnumVARIANT);
	HRESULT(STDMETHODCALLTYPE * AddToCollection) (ITemplateSdo * This, BSTR bstrName, IDispatch * pCollection, IDispatch ** ppItem);
	HRESULT(STDMETHODCALLTYPE * AddToSdo) (ITemplateSdo * This, BSTR bstrName, IDispatch * pSdoTarget, IDispatch ** ppItem);
	HRESULT(STDMETHODCALLTYPE * AddToSdoAsProperty) (ITemplateSdo * This, IDispatch * pSdoTarget, LONG id);
	END_INTERFACE
}  ITemplateSdoVtbl;
...
#ifdef COBJMACROS
#define ITemplateSdo_QueryInterface(This,riid,ppvObject)     ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) )
#define ITemplateSdo_AddRef(This)     ( (This)->lpVtbl -> AddRef(This) )
#define ITemplateSdo_Release(This)     ( (This)->lpVtbl -> Release(This) )
#define ITemplateSdo_GetTypeInfoCount(This,pctinfo)     ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) )
#define ITemplateSdo_GetTypeInfo(This,iTInfo,lcid,ppTInfo)     ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) )
#define ITemplateSdo_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)     ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) )
#define ITemplateSdo_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)     ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) )
#define ITemplateSdo_GetPropertyInfo(This,Id,ppPropertyInfo)     ( (This)->lpVtbl -> GetPropertyInfo(This,Id,ppPropertyInfo) )
#define ITemplateSdo_GetProperty(This,Id,pValue)     ( (This)->lpVtbl -> GetProperty(This,Id,pValue) )
#define ITemplateSdo_PutProperty(This,Id,pValue)     ( (This)->lpVtbl -> PutProperty(This,Id,pValue) )
#define ITemplateSdo_ResetProperty(This,Id)     ( (This)->lpVtbl -> ResetProperty(This,Id) )
#define ITemplateSdo_Apply(This)     ( (This)->lpVtbl -> Apply(This) )
#define ITemplateSdo_Restore(This)     ( (This)->lpVtbl -> Restore(This) )
#define ITemplateSdo_get__NewEnum(This,ppEnumVARIANT)     ( (This)->lpVtbl -> get__NewEnum(This,ppEnumVARIANT) )
#define ITemplateSdo_AddToCollection(This,bstrName,pCollection,ppItem)     ( (This)->lpVtbl -> AddToCollection(This,bstrName,pCollection,ppItem) )
#define ITemplateSdo_AddToSdo(This,bstrName,pSdoTarget,ppItem)     ( (This)->lpVtbl -> AddToSdo(This,bstrName,pSdoTarget,ppItem) )
#define ITemplateSdo_AddToSdoAsProperty(This,pSdoTarget,id)     ( (This)->lpVtbl -> AddToSdoAsProperty(This,pSdoTarget,id) )
#endif
#endif
#ifndef __ISdoDictionaryOld_INTERFACE_DEFINED__
#define __ISdoDictionaryOld_INTERFACE_DEFINED__
extern const IID IID_ISdoDictionaryOld;
typedef struct ISdoDictionaryOldVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ISdoDictionaryOld * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ISdoDictionaryOld * This);
	ULONG(STDMETHODCALLTYPE * Release) (ISdoDictionaryOld * This);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfoCount) (ISdoDictionaryOld * This, UINT * pctinfo);
	HRESULT(STDMETHODCALLTYPE * GetTypeInfo) (ISdoDictionaryOld * This, UINT iTInfo, LCID lcid, ITypeInfo ** ppTInfo);
	HRESULT(STDMETHODCALLTYPE * GetIDsOfNames) (ISdoDictionaryOld * This, REFIID riid, LPOLESTR * rgszNames, UINT cNames, LCID lcid, DISPID * rgDispId);
	HRESULT(STDMETHODCALLTYPE * Invoke) (ISdoDictionaryOld * This, DISPID dispIdMember, REFIID riid, LCID lcid, WORD wFlags, DISPPARAMS * pDispParams, VARIANT * pVarResult, EXCEPINFO * pExcepInfo, UINT * puArgErr);
	HRESULT(STDMETHODCALLTYPE * EnumAttributes) (ISdoDictionaryOld * This, VARIANT * Id, VARIANT * pValues);
	HRESULT(STDMETHODCALLTYPE * GetAttributeInfo) (ISdoDictionaryOld * This, ATTRIBUTEID Id, VARIANT * pInfoIDs, VARIANT * pInfoValues);
	HRESULT(STDMETHODCALLTYPE * EnumAttributeValues) (ISdoDictionaryOld * This, ATTRIBUTEID Id, VARIANT * pValueIds, VARIANT * pValuesDesc);
	HRESULT(STDMETHODCALLTYPE * CreateAttribute) (ISdoDictionaryOld * This, ATTRIBUTEID Id, IDispatch ** ppAttributeObject);
	HRESULT(STDMETHODCALLTYPE * GetAttributeID) (ISdoDictionaryOld * This, BSTR bstrAttributeName, ATTRIBUTEID * pId);
	END_INTERFACE
...
#endif
#endif
extern const CLSID CLSID_SdoMachine;
#endif
#endif
