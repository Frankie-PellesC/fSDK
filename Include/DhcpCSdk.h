/*+@@file@@----------------------------------------------------------------*//*!
 ...
 \date		Created  on Tue Jul  5 18:07:46 2016
 \date		Modified on Tue Jul  5 18:07:46 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
DWORD APIENTRY DhcpRequestParams(DWORD Flags, LPVOID Reserved, LPWSTR AdapterName, LPDHCPCAPI_CLASSID ClassId, DHCPCAPI_PARAMS_ARRAY SendParams, DHCPCAPI_PARAMS_ARRAY RecdParams, LPBYTE Buffer, LPDWORD pSize, LPWSTR RequestIdStr);
DWORD APIENTRY DhcpUndoRequestParams(DWORD Flags, LPVOID Reserved, LPWSTR AdapterName, LPWSTR RequestIdStr);
#define DHCPCAPI_REGISTER_HANDLE_EVENT        0x01
DWORD APIENTRY DhcpRegisterParamChange(DWORD Flags, LPVOID Reserved, LPWSTR AdapterName, LPDHCPCAPI_CLASSID ClassId, DHCPCAPI_PARAMS_ARRAY Params, LPVOID Handle);
#define DHCPCAPI_DEREGISTER_HANDLE_EVENT      0x01
DWORD APIENTRY DhcpDeRegisterParamChange(DWORD Flags, LPVOID Reserved, LPVOID Event);
