/*+@@file@@----------------------------------------------------------------*//*!
 \file		SessdirPublicTypes.h
 \par Description 
            Extension and update of headers for PellesC compiler suite.
 \par Project: 
            PellesC Headers extension
 \date		Created  on Fri Sep 16 22:15:25 2016
 \date		Modified on Fri Sep 16 22:15:25 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
typedef enum __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0001
{
	TSSD_ADDR_UNDEFINED = 0,
	TSSD_ADDR_IPv4 = 4,
	TSSD_ADDR_IPv6 = 6
} TSSD_AddrV46Type;
typedef enum __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0002
{
...
typedef enum __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0003
{
	TARGET_UNKNOWN = 0x1,
...
typedef enum __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0004
{
...
typedef enum __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0005
{
	UNKNOWN = 0,
	FARM = 1,
	NONFARM = 2
} TARGET_TYPE;
typedef enum __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0006
{
...
typedef enum __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0007
{
...
typedef enum __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0008
{
	UNKNOWN_PLUGIN = 0,
	POLICY_PLUGIN = 0x1,
	RESOURCE_PLUGIN = 0x2,
...
typedef enum __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0009
{
	STATE_INVALID = -1,
...
typedef enum __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0010
{
	OWNER_UNKNOWN = 0,
	OWNER_MS_TS_PLUGIN = 0x1,
	OWNER_MS_VM_PLUGIN = 0x2
} TARGET_OWNER;
typedef struct __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0011
{
...
typedef struct __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0012
{
