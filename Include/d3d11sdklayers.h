/*+@@file@@----------------------------------------------------------------*//*!
 \file		d3d11sdklayers.h
 \par Description 
            Extension and update of headers for PellesC compiler suite.
 \par Project: 
            PellesC Headers extension
 \date		Created  on Tue Jul  5 09:39:59 2016
 \date		Modified on Tue Jul  5 09:39:59 2016
 \author	frankie
\*//*-@@file@@----------------------------------------------------------------*/
...
extern const IID IID_ID3D11Debug;
typedef struct ID3D11DebugVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ID3D11Debug * This, REFIID riid, void **ppvObject);
	...
	HRESULT(STDMETHODCALLTYPE * SetSwapChain) (ID3D11Debug * This, IDXGISwapChain * pSwapChain);
	HRESULT(STDMETHODCALLTYPE * GetSwapChain) (ID3D11Debug * This, IDXGISwapChain ** ppSwapChain);
	HRESULT(STDMETHODCALLTYPE * ValidateContext) (ID3D11Debug * This, ID3D11DeviceContext * pContext);
	HRESULT(STDMETHODCALLTYPE * ReportLiveDeviceObjects) (ID3D11Debug * This, D3D11_RLDO_FLAGS Flags);
	HRESULT(STDMETHODCALLTYPE * ValidateContextForDispatch) (ID3D11Debug * This, ID3D11DeviceContext * pContext);
	END_INTERFACE
}  ID3D11DebugVtbl;
...
extern const IID IID_ID3D11SwitchToRef;
typedef struct ID3D11SwitchToRefVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ID3D11SwitchToRef * This, REFIID riid, void **ppvObject);
...
extern const IID IID_ID3D11InfoQueue;
typedef struct ID3D11InfoQueueVtbl
{
	BEGIN_INTERFACE
	HRESULT(STDMETHODCALLTYPE * QueryInterface) (ID3D11InfoQueue * This, REFIID riid, void **ppvObject);
	ULONG(STDMETHODCALLTYPE * AddRef) (ID3D11InfoQueue * This);
	ULONG(STDMETHODCALLTYPE * Release) (ID3D11InfoQueue * This);
	HRESULT(STDMETHODCALLTYPE * SetMessageCountLimit) (ID3D11InfoQueue * This, UINT64 MessageCountLimit);
	void (STDMETHODCALLTYPE * ClearStoredMessages) (ID3D11InfoQueue * This);
	HRESULT(STDMETHODCALLTYPE * GetMessage) (ID3D11InfoQueue * This, UINT64 MessageIndex, D3D11_MESSAGE * pMessage, SIZE_T * pMessageByteLength);
	...
	HRESULT(STDMETHODCALLTYPE * AddStorageFilterEntries) (ID3D11InfoQueue * This, D3D11_INFO_QUEUE_FILTER * pFilter);
	HRESULT(STDMETHODCALLTYPE * GetStorageFilter) (ID3D11InfoQueue * This, D3D11_INFO_QUEUE_FILTER * pFilter, SIZE_T * pFilterByteLength);
	...
	HRESULT(STDMETHODCALLTYPE * PushStorageFilter) (ID3D11InfoQueue * This, D3D11_INFO_QUEUE_FILTER * pFilter);
	...
	HRESULT(STDMETHODCALLTYPE * AddRetrievalFilterEntries) (ID3D11InfoQueue * This, D3D11_INFO_QUEUE_FILTER * pFilter);
	HRESULT(STDMETHODCALLTYPE * GetRetrievalFilter) (ID3D11InfoQueue * This, D3D11_INFO_QUEUE_FILTER * pFilter, SIZE_T * pFilterByteLength);
	...
	HRESULT(STDMETHODCALLTYPE * PushRetrievalFilter) (ID3D11InfoQueue * This, D3D11_INFO_QUEUE_FILTER * pFilter);
	...
	HRESULT(STDMETHODCALLTYPE * AddMessage) (ID3D11InfoQueue * This, D3D11_MESSAGE_CATEGORY Category, D3D11_MESSAGE_SEVERITY Severity, D3D11_MESSAGE_ID ID, LPCSTR pDescription);
	HRESULT(STDMETHODCALLTYPE * AddApplicationMessage) (ID3D11InfoQueue * This, D3D11_MESSAGE_SEVERITY Severity, LPCSTR pDescription);
	HRESULT(STDMETHODCALLTYPE * SetBreakOnCategory) (ID3D11InfoQueue * This, D3D11_MESSAGE_CATEGORY Category, BOOL bEnable);
	HRESULT(STDMETHODCALLTYPE * SetBreakOnSeverity) (ID3D11InfoQueue * This, D3D11_MESSAGE_SEVERITY Severity, BOOL bEnable);
	HRESULT(STDMETHODCALLTYPE * SetBreakOnID) (ID3D11InfoQueue * This, D3D11_MESSAGE_ID ID, BOOL bEnable);
	BOOL(STDMETHODCALLTYPE * GetBreakOnCategory) (ID3D11InfoQueue * This, D3D11_MESSAGE_CATEGORY Category);
	BOOL(STDMETHODCALLTYPE * GetBreakOnSeverity) (ID3D11InfoQueue * This, D3D11_MESSAGE_SEVERITY Severity);
	BOOL(STDMETHODCALLTYPE * GetBreakOnID) (ID3D11InfoQueue * This, D3D11_MESSAGE_ID ID);
	void (STDMETHODCALLTYPE * SetMuteDebugOutput) (ID3D11InfoQueue * This, BOOL bMute);
